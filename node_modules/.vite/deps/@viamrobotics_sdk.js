...
var hy = 34028234663852886e22;
var fy = -34028234663852886e22;
var vy = 4294967295;
var Ry = 2147483647;
var _y = -2147483648;
function An(a) {
...
var E = class {
   ...
   */
  fromBinary(e, n) {
    const t = this.getType(), s = t.runtime.bin, i = s.makeReadOptions(n);
   ...
   */
  fromJson(e, n) {
    const t = this.getType(), s = t.runtime.json, i = s.makeReadOptions(n);
    return s.readMessage(t, e, i, this), this;
  }
  /**
   ...
   */
  toBinary(e) {
    const n = this.getType(), t = n.runtime.bin, s = t.makeWriteOptions(e), i = s.writerFactory();
    return t.writeMessage(this, i, s), i.finish();
  }
  /**
   ...
   */
  toJson(e) {
    const n = this.getType(), t = n.runtime.json, s = t.makeWriteOptions(e);
...
function by(a, e, n, t) {
  var s;
  const i = (s = t == null ? void 0 : t.localName) !== null && s !== void 0 ? s : e.substring(e.lastIndexOf(".") + 1), r = {
    [i]: function(c) {
...
function Ia(a, e, n) {
  ...
  const t = a >>> 28 & 15 | (e & 7) << 4, s = !!(e >> 3);
  if (n.push((s ? t | 128 : t) & 255), !!s) {
...
function xo(a) {
  ...
  function i(r, c) {
    ...
    s *= n, t = t * n + d, t >= qn && (s = s + (t / qn | 0), t = t % qn);
  }
  return i(-24, -18), i(-18, -12), i(-12, -6), i(-6), e ? Si(t, s) : Wa(t, s);
}
function Ey(a, e) {
  let n = Wa(a, e);
  const t = n.hi & 2147483648;
  t && (n = Si(n.lo, n.hi));
  const s = _i(n.lo, n.hi);
  return t ? "-" + s : s;
}
function _i(a, e) {
  if ({ lo: a, hi: e } = Oy(a, e), e <= 2097151)
    return String(qn * e + a);
  const n = a & 16777215, t = (a >>> 24 | e << 8) & 16777215, s = e >> 16 & 65535;
  let i = n + t * 6777216 + s * 6710656, r = t + s * 8147497, c = s * 2;
  const d = 1e7;
  return i >= d && (r += Math.floor(i / d), i %= d), r >= d && (c += Math.floor(r / d), r %= d), c.toString() + Fo(r) + Fo(i);
}
function Oy(a, e) {
...
function Cy() {
  ...
  if (typeof BigInt == "function" && typeof a.getBigInt64 == "function" && typeof a.getBigUint64 == "function" && typeof a.setBigInt64 == "function" && typeof a.setBigUint64 == "function" && (typeof process != "object" || typeof process.env != "object" || process.env.BUF_BIGINT_DISABLE !== "1")) {
    const s = BigInt("-9223372036854775808"), i = BigInt("9223372036854775807"), r = BigInt("0"), c = BigInt("18446744073709551615");
    return {
      zero: BigInt(0),
      supported: true,
      parse(d) {
      ...
      dec(d, l) {
        return a.setInt32(0, d, true), a.setInt32(4, l, true), a.getBigInt64(0, true);
      },
      uDec(d, l) {
        return a.setInt32(0, d, true), a.setInt32(4, l, true), a.getBigUint64(0, true);
      }
    };
  }
  const n = (s) => L(/^-?[0-9]+$/.test(s), `int64 invalid: ${s}`), t = (s) => L(/^[0-9]+$/.test(s), `uint64 invalid: ${s}`);
  return {
    zero: "0",
    supported: false,
    parse(s) {
    ...
    enc(s) {
      return typeof s != "string" && (s = s.toString()), n(s), xo(s);
    },
    uEnc(s) {
      return typeof s != "string" && (s = s.toString()), t(s), xo(s);
    },
    dec(s, i) {
      return Ey(s, i);
    },
...
var Ny = class {
  ...
  finish() {
    ...
    for (let s = 0; s < this.chunks.length; s++)
      n.set(this.chunks[s], t), t += this.chunks[s].length;
   ...
   */
  int32(e) {
    return An(e), Jo(e, this.buf), this;
  }
  /**
   ...
   */
  sint32(e) {
    return An(e), e = (e << 1 ^ e >> 31) >>> 0, Jo(e, this.buf), this;
  }
  /**
   * Write a `fixed64` value, a signed, fixed-length 64-bit integer.
   */
  sfixed64(e) {
    let n = new Uint8Array(8), t = new DataView(n.buffer), s = Y.enc(e);
    return t.setInt32(0, s.lo, true), t.setInt32(4, s.hi, true), this.raw(n);
  }
  /**
   * Write a `fixed64` value, an unsigned, fixed-length 64 bit integer.
   */
  fixed64(e) {
    let n = new Uint8Array(8), t = new DataView(n.buffer), s = Y.uEnc(e);
    return t.setInt32(0, s.lo, true), t.setInt32(4, s.hi, true), this.raw(n);
  }
  /**
  ...
  int64(e) {
    let n = Y.enc(e);
    return Ia(n.lo, n.hi, this.buf), this;
  }
  /**
   * Write a `sint64` value, a signed, zig-zag-encoded 64-bit varint.
   */
  sint64(e) {
    let n = Y.enc(e), t = n.hi >> 31, s = n.lo << 1 ^ t, i = (n.hi << 1 | n.lo >>> 31) ^ t;
    return Ia(s, i, this.buf), this;
  }
  /**
...
var Py = class {
  constructor(e, n) {
    this.varint64 = wy, this.uint32 = My, this.buf = e, this.len = e.length, this.pos = 0, this.view = new DataView(e.buffer, e.byteOffset, e.byteLength), this.textDecoder = n ?? new TextDecoder();
  }
  /**
  ...
  sint64() {
    ...
    return e = (e >>> 1 | (n & 1) << 31) ^ t, n = n >>> 1 ^ t, Y.dec(e, n);
  }
  /**
  ...
  return {
    ...
    get field() {
      if (!s) {
        ...
        i.name = e.split(".").pop(), i.jsonName = `[${e}]`, s = a.util.newFieldList([i]).list()[0];
      }
      return s;
    },
    runtime: a
...
var ja = {
  ...
  dec(a) {
    ...
    let n = new Uint8Array(e), t = 0, s = 0, i, r = 0;
    for (let c = 0; c < a.length; c++) {
      if (i = ia[a.charCodeAt(c)], i === void 0)
        switch (a[c]) {
          case "=":
            s = 0;
          case `
`:
      ...
      switch (s) {
        case 0:
          ...
          break;
        case 1:
          n[t++] = r << 2 | (i & 48) >> 4, r = i, s = 2;
          break;
        case 2:
          n[t++] = (r & 15) << 4 | (i & 60) >> 2, r = i, s = 3;
          break;
        case 3:
          n[t++] = (r & 3) << 6 | i, s = 0;
          break;
  ...
  enc(a) {
    ...
    for (let i = 0; i < a.length; i++)
      switch (t = a[i], n) {
        case 0:
          e += le[t >> 2], s = (t & 3) << 4, n = 1;
          break;
        case 1:
          e += le[s | t >> 4], s = (t & 15) << 2, n = 2;
          break;
        case 2:
          e += le[s | t >> 6], e += le[t & 63], n = 0;
          break;
      }
    return n && (e += le[s], e += "=", n == 1 && (e += "=")), e;
  }
};
function Uy(a, e, n) {
  Ei(e, a);
  const t = e.runtime.bin.makeReadOptions(n), s = qy(a.getType().runtime.bin.listUnknownFields(a), e.field), [i, r] = bi(e);
  for (const c of s)
...
function Gy(a, e, n, t) {
  Ei(e, a);
  const s = e.runtime.bin.makeReadOptions(t), i = e.runtime.bin.makeWriteOptions(t);
  if (wi(a, e)) {
    const l = a.getType().runtime.bin.listUnknownFields(a).filter((T) => T.no != e.field.no);
  ...
  const d = s.readerFactory(r.finish());
  for (; d.pos < d.len; ) {
    const [l, T] = d.tag(), v = d.skip(T, l);
    a.getType().runtime.bin.onUnknownField(a, l, T, v);
  }
}
function wi(a, e) {
  const n = a.getType();
...
function Oi(a, e) {
  ...
  switch (a.kind) {
    case "enum":
    case "scalar":
      return a.opt || a.req ? e[n] !== void 0 : a.kind == "enum" ? e[n] !== a.T.values[0].no : !Ii(a.T, e[n]);
    case "message":
      return e[n] !== void 0;
    case "map":
...
function Mi(a, e) {
  return $e(e) || !a.fieldWrapper ? e : a.fieldWrapper.wrapField(e);
}
...
function Ly(a) {
  return a ? Object.assign(Object.assign({}, Yo), a) : Yo;
}
function By(a) {
  return a ? Object.assign(Object.assign({}, $o), a) : $o;
}
var xn = Symbol();
var Un = Symbol();
function xy() {
  return {
    ...
    readMessage(a, e, n, t) {
      ...
      t = t ?? new a();
      const s = /* @__PURE__ */ new Map(), i = n.typeRegistry;
        ...
        if (d) {
          if (d.oneof) {
            if (c === null && d.kind == "scalar")
              continue;
            const l = s.get(d.oneof);
            if (l !== void 0)
              throw new Error(`cannot decode message ${a.typeName} from JSON: multiple keys for oneof "${d.oneof.name}" present: "${l}", "${r}"`);
            s.set(d.oneof, r);
          }
          Vo(t, c, d, n, a);
        } else {
          let l = false;
          if ((i == null ? void 0 : i.findExtension) && r.startsWith("[") && r.endsWith("]")) {
            const T = i.findExtension(r.substring(1, r.length - 1));
            if (T && T.extendee.typeName == a.typeName) {
              l = true;
              const [v, S] = bi(T);
              Vo(v, c, T.field, n, T), Gy(t, T, S(), n);
            }
          }
      ...
      try {
        for (s of n.fields.byNumber()) {
          if (!Oi(s, a)) {
            ...
            if (!e.emitDefaultValues || !Jy(s))
              continue;
          }
          const r = s.oneof ? a[s.oneof.localName].value : a[s.localName], c = Wo(s, r, e);
          c !== void 0 && (t[e.useProtoFieldName ? s.name : s.jsonName] = c);
        }
        const i = e.typeRegistry;
        if (i == null ? void 0 : i.findExtensionFor)
          for (const r of n.runtime.bin.listUnknownFields(a)) {
            const c = i.findExtensionFor(n.typeName, r.no);
            if (c && wi(a, c)) {
              const d = Uy(a, c, e), l = Wo(c.field, d, e);
              l !== void 0 && (t[c.field.jsonName] = l);
            }
          }
      } catch (i) {
        const r = s ? `cannot encode field ${n.typeName}.${s.name} to JSON` : `cannot encode message ${n.typeName} to JSON`, c = i instanceof Error ? i.message : String(i);
        throw new Error(r + (c.length > 0 ? `: ${c}` : ""));
      }
      return t;
    },
    readScalar(a, e, n) {
      return un(a, e, n ?? Fe.BIGINT, true);
    },
    writeScalar(a, e, n) {
      if (e !== void 0 && (n || Ii(a, e)))
        return Gn(a, e);
    },
    debug: te
  };
...
function Vo(a, e, n, t, s) {
  let i = n.localName;
  if (n.repeated) {
    if (L(n.kind != "map"), e === null)
      return;
    if (!Array.isArray(e))
      throw new Error(`cannot decode field ${s.typeName}.${n.name} from JSON: ${te(e)}`);
    const r = a[i];
    for (const c of e) {
      if (c === null)
        throw new Error(`cannot decode field ${s.typeName}.${n.name} from JSON: ${te(c)}`);
      switch (n.kind) {
        case "message":
          r.push(n.T.fromJson(c, t));
          break;
        case "enum":
          const d = ba(n.T, c, t.ignoreUnknownFields, true);
          d !== Un && r.push(d);
          break;
        case "scalar":
          try {
            r.push(un(n.T, c, n.L, true));
          } catch (l) {
            let T = `cannot decode field ${s.typeName}.${n.name} from JSON: ${te(c)}`;
            throw l instanceof Error && l.message.length > 0 && (T += `: ${l.message}`), new Error(T);
          }
          break;
      }
    }
    ...
    for (const [c, d] of Object.entries(e)) {
      ...
      try {
        ...
        let v = `cannot decode map key for field ${s.typeName}.${n.name} from JSON: ${te(e)}`;
        throw T instanceof Error && T.message.length > 0 && (v += `: ${T.message}`), new Error(v);
      }
      switch (n.V.kind) {
        case "message":
          r[l] = n.V.T.fromJson(d, t);
          break;
        case "enum":
          const T = ba(n.V.T, d, t.ignoreUnknownFields, true);
          T !== Un && (r[l] = T);
          break;
        case "scalar":
          try {
            r[l] = un(n.V.T, d, Fe.BIGINT, true);
          } catch (v) {
            let S = `cannot decode map value for field ${s.typeName}.${n.name} from JSON: ${te(e)}`;
            throw v instanceof Error && v.message.length > 0 && (S += `: ${v.message}`), new Error(S);
          }
          break;
      }
    }
    ...
    switch (n.oneof && (a = a[n.oneof.localName] = { case: i }, i = "value"), n.kind) {
      case "message":
        ...
        if (e === null && r.typeName != "google.protobuf.Value")
          return;
        let c = a[i];
        $e(c) ? c.fromJson(e, t) : (a[i] = c = r.fromJson(e, t), r.fieldWrapper && !n.oneof && (a[i] = r.fieldWrapper.unwrapField(c)));
        break;
      case "enum":
        const d = ba(n.T, e, t.ignoreUnknownFields, false);
        switch (d) {
          case xn:
            zo(n, a);
            break;
      ...
      case "scalar":
        try {
          ...
          let T = `cannot decode field ${s.typeName}.${n.name} from JSON: ${te(e)}`;
          throw l instanceof Error && l.message.length > 0 && (T += `: ${l.message}`), new Error(T);
        }
        break;
    }
...
function Fy(a, e) {
  ...
  return un(a, e, Fe.BIGINT, true).toString();
}
function un(a, e, n, t) {
  if (e === null)
    return t ? Qe(a, n) : xn;
  switch (a) {
    ...
    case f.UINT32:
      ...
      if (typeof e == "number" ? i = e : typeof e == "string" && e.length > 0 && e.trim().length === e.length && (i = Number(e)), i === void 0)
        break;
      return a == f.UINT32 || a == f.FIXED32 ? Na(i) : An(i), i;
    case f.INT64:
    case f.SFIXED64:
    case f.SINT64:
...
function ba(a, e, n, t) {
  if (e === null)
    return a.typeName == "google.protobuf.NullValue" ? 0 : t ? a.values[0].no : xn;
  switch (typeof e) {
    case "number":
...
function Wo(a, e, n) {
  if (a.kind == "map") {
    ...
    const t = {}, s = Object.entries(e);
    switch (a.V.kind) {
      case "scalar":
        for (const [r, c] of s)
          t[r.toString()] = Gn(a.V.T, c);
        break;
      case "message":
        for (const [r, c] of s)
      ...
      case "enum":
        const i = a.V.T;
        for (const [r, c] of s)
          t[r.toString()] = wa(i, c, n.enumAsInteger);
        break;
    }
    return n.emitDefaultValues || s.length > 0 ? t : void 0;
  }
  if (a.repeated) {
    L(Array.isArray(e));
    const t = [];
    switch (a.kind) {
      ...
      case "enum":
        for (let s = 0; s < e.length; s++)
          t.push(wa(a.T, e[s], n.enumAsInteger));
        break;
      case "message":
        for (let s = 0; s < e.length; s++)
          t.push(e[s].toJson(n));
  ...
  switch (a.kind) {
    case "scalar":
      return Gn(a.T, e);
    case "enum":
      return wa(a.T, e, n.enumAsInteger);
    case "message":
      return Mi(a.T, e).toJson(n);
  }
}
function wa(a, e, n) {
  var t;
  if (L(typeof e == "number"), a.typeName == "google.protobuf.NullValue")
    return null;
  if (n)
    return e;
  const s = a.findNumber(e);
  return (t = s == null ? void 0 : s.name) !== null && t !== void 0 ? t : e;
}
function Gn(a, e) {
  switch (a) {
    case f.INT32:
    ...
    case f.BYTES:
      return L(e instanceof Uint8Array), ja.enc(e);
  }
}
var Xe = Symbol("@bufbuild/protobuf/unknown-fields");
var jo = {
  readUnknownFields: true,
  readerFactory: (a) => new Py(a)
};
var Ho = {
...
function zy(a) {
  return a ? Object.assign(Object.assign({}, jo), a) : jo;
}
function Yy(a) {
  return a ? Object.assign(Object.assign({}, Ho), a) : Ho;
}
function $y() {
  return {
    makeReadOptions: zy,
    ...
    onUnknownField(a, e, n, t) {
      const s = a;
      Array.isArray(s[Xe]) || (s[Xe] = []), s[Xe].push({ no: e, wireType: n, data: t });
    },
    readMessage(a, e, n, t, s) {
      const i = a.getType(), r = s ? e.len : e.pos + n;
      let c, d;
      for (; e.pos < r && ([c, d] = e.tag(), !(s === true && d == B.EndGroup)); ) {
        const l = i.fields.find(c);
        if (!l) {
          const T = e.skip(d, c);
    ...
    writeMessage(a, e, n) {
      const t = a.getType();
      for (const s of t.fields.byNumber()) {
        if (!Oi(s, a)) {
          if (s.req)
            throw new Error(`cannot encode field ${t.typeName}.${s.name} to binary: required field not set`);
          continue;
        }
        const i = s.oneof ? a[s.oneof.localName].value : a[s.localName];
        Xo(s, i, e, n);
      }
...
function Ko(a, e, n, t, s) {
  ...
  switch (n.oneof && (a = a[n.oneof.localName], a.case != r && delete a.value, a.case = r, r = "value"), n.kind) {
    ...
    case "message":
      const l = n.T;
      i ? a[r].push(Ln(e, new l(), s, n)) : $e(a[r]) ? Ln(e, a[r], s, n) : (a[r] = Ln(e, new l(), s, n), l.fieldWrapper && !n.oneof && !n.repeated && (a[r] = l.fieldWrapper.unwrapField(a[r])));
      break;
    case "map":
      let [T, v] = Vy(n, e, s);
      a[r][T] = v;
...
function Ln(a, e, n, t) {
  const s = e.getType().runtime.bin, i = t == null ? void 0 : t.delimited;
      ...
      case 2:
        switch (a.V.kind) {
          ...
          case "enum":
            ...
            break;
          case "message":
            r = Ln(e, new a.V.T(), n, void 0);
            break;
        }
        break;
    }
  }
  if (i === void 0 && (i = Qe(a.K, Fe.BIGINT)), typeof i != "string" && typeof i != "number" && (i = i.toString()), r === void 0)
    switch (a.V.kind) {
      case "scalar":
        r = Qe(a.V.T, Fe.BIGINT);
        break;
      case "enum":
        r = a.V.T.values[0].no;
        break;
...
function jy(a, e, n, t, s) {
  ...
  switch (pn(a, n.K, 1, i), n.V.kind) {
    ...
    case "enum":
      ...
      break;
    case "message":
      L(s !== void 0), a.tag(2, B.LengthDelimited).bytes(s.toBinary(e));
      break;
  }
  a.join();
}
function Qo(a, e, n, t) {
  const s = Mi(n.T, t);
  n.delimited ? a.tag(n.no, B.StartGroup).raw(s.toBinary(e)).tag(n.no, B.EndGroup) : a.tag(n.no, B.LengthDelimited).bytes(s.toBinary(e));
}
function pn(a, e, n, t) {
  L(t !== void 0);
  let [s, i] = Ci(e);
  ...
  return {
        ...
        if (r[s] != null)
          switch (t.kind) {
            case "oneof":
              ...
              let l = r[s].value;
              d && d.kind == "message" && !$e(l, d.T) ? l = new d.T(l) : d && d.kind === "scalar" && d.T === f.BYTES && (l = cn(l)), i[s] = { case: c, value: l };
              break;
            case "scalar":
            case "enum":
              let T = r[s];
              t.T === f.BYTES && (T = t.repeated ? T.map(cn) : cn(T)), i[s] = T;
              break;
            case "map":
              switch (t.V.kind) {
                case "scalar":
                case "enum":
                  if (t.V.T === f.BYTES)
                    for (const [R, I] of Object.entries(r[s]))
                      i[s][R] = cn(I);
                  else
                    Object.assign(i[s], r[s]);
                  break;
                case "message":
                  const S = t.V.T;
                  for (const R of Object.keys(r[s])) {
                    let I = r[s][R];
                    S.fieldWrapper || (I = new S(I)), i[s][R] = I;
                  }
                  break;
              }
              break;
            case "message":
              const v = t.T;
              if (t.repeated)
                i[s] = r[s].map((S) => $e(S, v) ? S : new v(S));
              else {
                const S = r[s];
                v.fieldWrapper ? (
                  /* We can't use BytesValue.typeName as that will create a circular import */
                  v.typeName === "google.protobuf.BytesValue" ? i[s] = cn(S) : i[s] = S
                ) : i[s] = $e(S, v) ? S : new v(S);
              }
              break;
          }
    ...
    equals(a, e, n) {
      return e === n ? true : !e || !n ? false : a.fields.byMember().every((t) => {
        const s = e[t.localName], i = n[t.localName];
        if (t.repeated) {
          if (s.length !== i.length)
            return false;
          switch (t.kind) {
            case "message":
              return s.every((r, c) => t.T.equals(r, i[c]));
            case "scalar":
              return s.every((r, c) => Ge(t.T, r, i[c]));
            case "enum":
              return s.every((r, c) => Ge(f.INT32, r, i[c]));
          }
          throw new Error(`repeated cannot contain ${t.kind}`);
        }
        switch (t.kind) {
          case "message":
            return t.T.equals(s, i);
          case "enum":
            return Ge(f.INT32, s, i);
          case "scalar":
            return Ge(t.T, s, i);
          case "oneof":
            if (s.case !== i.case)
              return false;
            const r = t.findField(s.case);
            if (r === void 0)
              return true;
            switch (r.kind) {
              case "message":
                return r.T.equals(s.value, i.value);
              case "enum":
                return Ge(f.INT32, s.value, i.value);
              case "scalar":
                return Ge(r.T, s.value, i.value);
            }
          ...
          case "map":
            ...
            switch (t.V.kind) {
              case "message":
                const d = t.V.T;
                return c.every((T) => d.equals(s[T], i[T]));
              case "enum":
                return c.every((T) => Ge(f.INT32, s[T], i[T]));
              case "scalar":
                const l = t.V.T;
                return c.every((T) => Ge(l, s[T], i[T]));
            }
            break;
        }
      });
    ...
    clone(a) {
      ...
      for (const s of e.fields.byMember()) {
        ...
        if (s.repeated)
          ...
          s.kind == "oneof" ? r = s.findField(i.case) ? { case: i.case, value: Dn(i.value) } : { case: void 0 } : r = Dn(i);
        t[s.localName] = r;
      }
      for (const s of e.runtime.bin.listUnknownFields(a))
        e.runtime.bin.onUnknownField(t, s.no, s.wireType, s.data);
      return n;
    }
  };
}
...
function Ni(a, e, n) {
  return {
    ...
    json: xy(),
    bin: $y(),
    util: Object.assign(Object.assign({}, Ky()), {
      newFieldList: e,
      initFields: n
    }),
    makeMessageType(t, s, i) {
      return by(this, t, s, i);
    },
    makeEnum: Iy,
    makeEnumType: vi,
    getEnumType: Sy,
    makeExtension(t, s, i) {
      return Dy(this, t, s, i);
    }
  };
}
var Pi = class {
...
var qi = (a) => `${a}$`;
var nh = (a) => eh.has(a) ? qi(a) : a;
var ah = (a) => Zy.has(a) ? qi(a) : a;
var th = class {
  constructor(e) {
    this.kind = "oneof", this.repeated = false, this.packed = false, this.opt = false, this.req = false, this.default = void 0, this.fields = [], this.name = e, this.localName = Xy(e);
  }
  addField(e) {
...
function Ui(a, e) {
  ...
  for (const T of typeof a == "function" ? a() : a) {
    const v = T;
    if (v.localName = Di(T.name, T.oneof !== void 0), v.jsonName = (n = T.jsonName) !== null && n !== void 0 ? n : Qy(T.name), v.repeated = (t = T.repeated) !== null && t !== void 0 ? t : false, T.kind == "scalar" && (v.L = (s = T.L) !== null && s !== void 0 ? s : Fe.BIGINT), v.delimited = (i = T.delimited) !== null && i !== void 0 ? i : false, v.req = (r = T.req) !== null && r !== void 0 ? r : false, v.opt = (c = T.opt) !== null && c !== void 0 ? c : false, T.packed === void 0 && (e ? v.packed = T.kind == "enum" || T.kind == "scalar" && T.T != f.BYTES && T.T != f.STRING : v.packed = false), T.oneof !== void 0) {
      const S = typeof T.oneof == "string" ? T.oneof : T.oneof.name;
      (!l || l.name != S) && (l = new th(S)), v.oneof = l, l.addField(v);
    }
    d.push(v);
  }
  return d;
...
p.util.setEnumType(ne, "google.protobuf.Edition", [
...
var Le = class _Le extends E {
  constructor(e) {
    super(), this.file = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
    return new _Le().fromBinary(e, n);
  }
  static fromJson(e, n) {
    return new _Le().fromJson(e, n);
  }
  static fromJsonString(e, n) {
    return new _Le().fromJsonString(e, n);
  }
  static equals(e, n) {
    return p.util.equals(_Le, e, n);
  }
};
Le.runtime = p;
Le.typeName = "google.protobuf.FileDescriptorSet";
Le.fields = p.util.newFieldList(() => [
  { no: 1, name: "file", kind: "message", T: de, repeated: true }
]);
var de = class _de extends E {
  constructor(e) {
    super(), this.dependency = [], this.publicDependency = [], this.weakDependency = [], this.messageType = [], this.enumType = [], this.service = [], this.extension = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_de, e, n);
  }
};
de.runtime = p;
de.typeName = "google.protobuf.FileDescriptorProto";
de.fields = p.util.newFieldList(() => [
  ...
  { no: 4, name: "message_type", kind: "message", T: se, repeated: true },
  { no: 5, name: "enum_type", kind: "message", T: oe, repeated: true },
  { no: 6, name: "service", kind: "message", T: fe, repeated: true },
  ...
  { no: 14, name: "edition", kind: "enum", T: p.getEnumType(ne), opt: true }
]);
var se = class _se extends E {
  constructor(e) {
    super(), this.field = [], this.extension = [], this.nestedType = [], this.enumType = [], this.extensionRange = [], this.oneofDecl = [], this.reservedRange = [], this.reservedName = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_se, e, n);
  }
};
se.runtime = p;
se.typeName = "google.protobuf.DescriptorProto";
se.fields = p.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, opt: true },
  { no: 2, name: "field", kind: "message", T: ee, repeated: true },
  { no: 6, name: "extension", kind: "message", T: ee, repeated: true },
  { no: 3, name: "nested_type", kind: "message", T: se, repeated: true },
  { no: 4, name: "enum_type", kind: "message", T: oe, repeated: true },
  { no: 5, name: "extension_range", kind: "message", T: ue, repeated: true },
  { no: 8, name: "oneof_decl", kind: "message", T: ke, repeated: true },
  { no: 7, name: "options", kind: "message", T: _e, opt: true },
  { no: 9, name: "reserved_range", kind: "message", T: pe, repeated: true },
  { no: 10, name: "reserved_name", kind: "scalar", T: 9, repeated: true }
]);
var ue = class _ue extends E {
  constructor(e) {
    super(), p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_ue, e, n);
  }
};
ue.runtime = p;
ue.typeName = "google.protobuf.DescriptorProto.ExtensionRange";
ue.fields = p.util.newFieldList(() => [
...
var pe = class _pe extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_pe, e, n);
  }
};
pe.runtime = p;
pe.typeName = "google.protobuf.DescriptorProto.ReservedRange";
...
var ge = class _ge extends E {
  constructor(e) {
    super(), this.uninterpretedOption = [], this.declaration = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_ge, e, n);
  }
};
ge.runtime = p;
ge.typeName = "google.protobuf.ExtensionRangeOptions";
ge.fields = p.util.newFieldList(() => [
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true },
  { no: 2, name: "declaration", kind: "message", T: Te, repeated: true },
  { no: 50, name: "features", kind: "message", T: z, opt: true },
  { no: 3, name: "verification", kind: "enum", T: p.getEnumType(gn), opt: true, default: gn.UNVERIFIED }
]);
var gn;
(function(a) {
  a[a.DECLARATION = 0] = "DECLARATION", a[a.UNVERIFIED = 1] = "UNVERIFIED";
})(gn || (gn = {}));
p.util.setEnumType(gn, "google.protobuf.ExtensionRangeOptions.VerificationState", [
...
var ee = class _ee extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_ee, e, n);
  }
};
ee.runtime = p;
ee.typeName = "google.protobuf.FieldDescriptorProto";
ee.fields = p.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, opt: true },
  { no: 3, name: "number", kind: "scalar", T: 5, opt: true },
  { no: 4, name: "label", kind: "enum", T: p.getEnumType(zn), opt: true },
  { no: 5, name: "type", kind: "enum", T: p.getEnumType(Jn), opt: true },
...
p.util.setEnumType(Jn, "google.protobuf.FieldDescriptorProto.Type", [
...
p.util.setEnumType(zn, "google.protobuf.FieldDescriptorProto.Label", [
...
var oe = class _oe extends E {
  constructor(e) {
    super(), this.value = [], this.reservedRange = [], this.reservedName = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_oe, e, n);
  }
};
oe.runtime = p;
oe.typeName = "google.protobuf.EnumDescriptorProto";
oe.fields = p.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, opt: true },
  { no: 2, name: "value", kind: "message", T: he, repeated: true },
...
var he = class _he extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_he, e, n);
  }
};
he.runtime = p;
he.typeName = "google.protobuf.EnumValueDescriptorProto";
he.fields = p.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, opt: true },
...
var fe = class _fe extends E {
  constructor(e) {
    super(), this.method = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_fe, e, n);
  }
};
fe.runtime = p;
fe.typeName = "google.protobuf.ServiceDescriptorProto";
fe.fields = p.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, opt: true },
  { no: 2, name: "method", kind: "message", T: ve, repeated: true },
  { no: 3, name: "options", kind: "message", T: Oe, opt: true }
]);
var ve = class _ve extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_ve, e, n);
  }
};
ve.runtime = p;
ve.typeName = "google.protobuf.MethodDescriptorProto";
ve.fields = p.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, opt: true },
  { no: 2, name: "input_type", kind: "scalar", T: 9, opt: true },
  { no: 3, name: "output_type", kind: "scalar", T: 9, opt: true },
  { no: 4, name: "options", kind: "message", T: re, opt: true },
...
var Re = class _Re extends E {
  constructor(e) {
    super(), this.uninterpretedOption = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_Re, e, n);
  }
};
Re.runtime = p;
Re.typeName = "google.protobuf.FileOptions";
Re.fields = p.util.newFieldList(() => [
  ...
  { no: 9, name: "optimize_for", kind: "enum", T: p.getEnumType(Tn), opt: true, default: Tn.SPEED },
...
p.util.setEnumType(Tn, "google.protobuf.FileOptions.OptimizeMode", [
  { no: 1, name: "SPEED" },
  { no: 2, name: "CODE_SIZE" },
...
var _e = class __e extends E {
  ...
  static equals(e, n) {
    return p.util.equals(__e, e, n);
  }
};
_e.runtime = p;
_e.typeName = "google.protobuf.MessageOptions";
_e.fields = p.util.newFieldList(() => [
  ...
  { no: 12, name: "features", kind: "message", T: z, opt: true },
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true }
]);
var Se = class _Se extends E {
  constructor(e) {
    super(), this.targets = [], this.editionDefaults = [], this.uninterpretedOption = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
    return new _Se().fromBinary(e, n);
  }
...
Se.fields = p.util.newFieldList(() => [
  { no: 1, name: "ctype", kind: "enum", T: p.getEnumType(kn), opt: true, default: kn.STRING },
  { no: 2, name: "packed", kind: "scalar", T: 8, opt: true },
  { no: 6, name: "jstype", kind: "enum", T: p.getEnumType(yn), opt: true, default: yn.JS_NORMAL },
  ...
  { no: 17, name: "retention", kind: "enum", T: p.getEnumType(Yn), opt: true },
  { no: 19, name: "targets", kind: "enum", T: p.getEnumType($n), repeated: true },
  { no: 20, name: "edition_defaults", kind: "message", T: Ie, repeated: true },
  { no: 21, name: "features", kind: "message", T: z, opt: true },
  { no: 22, name: "feature_support", kind: "message", T: ie, opt: true },
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true }
]);
var kn;
(function(a) {
...
p.util.setEnumType(kn, "google.protobuf.FieldOptions.CType", [
  { no: 0, name: "STRING" },
  { no: 1, name: "CORD" },
...
p.util.setEnumType(yn, "google.protobuf.FieldOptions.JSType", [
  { no: 0, name: "JS_NORMAL" },
  { no: 1, name: "JS_STRING" },
  { no: 2, name: "JS_NUMBER" }
]);
...
p.util.setEnumType(Yn, "google.protobuf.FieldOptions.OptionRetention", [
...
p.util.setEnumType($n, "google.protobuf.FieldOptions.OptionTargetType", [
...
var Ie = class _Ie extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_Ie, e, n);
  }
};
Ie.runtime = p;
Ie.typeName = "google.protobuf.FieldOptions.EditionDefault";
Ie.fields = p.util.newFieldList(() => [
  { no: 3, name: "edition", kind: "enum", T: p.getEnumType(ne), opt: true },
...
ie.runtime = p;
ie.typeName = "google.protobuf.FieldOptions.FeatureSupport";
ie.fields = p.util.newFieldList(() => [
  { no: 1, name: "edition_introduced", kind: "enum", T: p.getEnumType(ne), opt: true },
  { no: 2, name: "edition_deprecated", kind: "enum", T: p.getEnumType(ne), opt: true },
  { no: 3, name: "deprecation_warning", kind: "scalar", T: 9, opt: true },
  { no: 4, name: "edition_removed", kind: "enum", T: p.getEnumType(ne), opt: true }
]);
var be = class _be extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_be, e, n);
  }
};
be.runtime = p;
be.typeName = "google.protobuf.OneofOptions";
be.fields = p.util.newFieldList(() => [
  { no: 1, name: "features", kind: "message", T: z, opt: true },
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true }
]);
var we = class _we extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_we, e, n);
  }
};
we.runtime = p;
we.typeName = "google.protobuf.EnumOptions";
we.fields = p.util.newFieldList(() => [
  { no: 2, name: "allow_alias", kind: "scalar", T: 8, opt: true },
  { no: 3, name: "deprecated", kind: "scalar", T: 8, opt: true, default: false },
  { no: 6, name: "deprecated_legacy_json_field_conflicts", kind: "scalar", T: 8, opt: true },
  { no: 7, name: "features", kind: "message", T: z, opt: true },
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true }
]);
var Ee = class _Ee extends E {
  constructor(e) {
...
Ee.fields = p.util.newFieldList(() => [
  ...
  { no: 2, name: "features", kind: "message", T: z, opt: true },
  { no: 3, name: "debug_redact", kind: "scalar", T: 8, opt: true, default: false },
  { no: 4, name: "feature_support", kind: "message", T: ie, opt: true },
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true }
]);
var Oe = class _Oe extends E {
  constructor(e) {
...
Oe.runtime = p;
Oe.typeName = "google.protobuf.ServiceOptions";
Oe.fields = p.util.newFieldList(() => [
  { no: 34, name: "features", kind: "message", T: z, opt: true },
...
re.runtime = p;
re.typeName = "google.protobuf.MethodOptions";
re.fields = p.util.newFieldList(() => [
  { no: 33, name: "deprecated", kind: "scalar", T: 8, opt: true, default: false },
  { no: 34, name: "idempotency_level", kind: "enum", T: p.getEnumType(hn), opt: true, default: hn.IDEMPOTENCY_UNKNOWN },
  { no: 35, name: "features", kind: "message", T: z, opt: true },
  { no: 999, name: "uninterpreted_option", kind: "message", T: V, repeated: true }
]);
var hn;
(function(a) {
...
p.util.setEnumType(hn, "google.protobuf.MethodOptions.IdempotencyLevel", [
...
var V = class _V extends E {
  constructor(e) {
    super(), this.name = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
    return new _V().fromBinary(e, n);
  }
  static fromJson(e, n) {
    return new _V().fromJson(e, n);
  }
  static fromJsonString(e, n) {
    return new _V().fromJsonString(e, n);
  }
  static equals(e, n) {
    return p.util.equals(_V, e, n);
  }
};
V.runtime = p;
V.typeName = "google.protobuf.UninterpretedOption";
V.fields = p.util.newFieldList(() => [
  { no: 2, name: "name", kind: "message", T: Me, repeated: true },
...
var Me = class _Me extends E {
  ...
  static equals(e, n) {
    return p.util.equals(_Me, e, n);
  }
};
Me.runtime = p;
Me.typeName = "google.protobuf.UninterpretedOption.NamePart";
...
var z = class _z extends E {
  ...
  static fromBinary(e, n) {
    return new _z().fromBinary(e, n);
  }
  static fromJson(e, n) {
    return new _z().fromJson(e, n);
  }
  static fromJsonString(e, n) {
    return new _z().fromJsonString(e, n);
  }
  static equals(e, n) {
    return p.util.equals(_z, e, n);
  }
};
z.runtime = p;
z.typeName = "google.protobuf.FeatureSet";
z.fields = p.util.newFieldList(() => [
  { no: 1, name: "field_presence", kind: "enum", T: p.getEnumType(Vn), opt: true },
  { no: 2, name: "enum_type", kind: "enum", T: p.getEnumType(Wn), opt: true },
  { no: 3, name: "repeated_field_encoding", kind: "enum", T: p.getEnumType(jn), opt: true },
  { no: 4, name: "utf8_validation", kind: "enum", T: p.getEnumType(Hn), opt: true },
  { no: 5, name: "message_encoding", kind: "enum", T: p.getEnumType(Kn), opt: true },
  { no: 6, name: "json_format", kind: "enum", T: p.getEnumType(Xn), opt: true }
]);
var Vn;
(function(a) {
...
p.util.setEnumType(Vn, "google.protobuf.FeatureSet.FieldPresence", [
...
p.util.setEnumType(Wn, "google.protobuf.FeatureSet.EnumType", [
...
p.util.setEnumType(jn, "google.protobuf.FeatureSet.RepeatedFieldEncoding", [
...
p.util.setEnumType(Hn, "google.protobuf.FeatureSet.Utf8Validation", [
...
p.util.setEnumType(Kn, "google.protobuf.FeatureSet.MessageEncoding", [
...
p.util.setEnumType(Xn, "google.protobuf.FeatureSet.JsonFormat", [
...
var Be = class _Be extends E {
  constructor(e) {
    super(), this.defaults = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
    return new _Be().fromBinary(e, n);
  }
...
Be.runtime = p;
Be.typeName = "google.protobuf.FeatureSetDefaults";
Be.fields = p.util.newFieldList(() => [
  { no: 1, name: "defaults", kind: "message", T: Ce, repeated: true },
  { no: 4, name: "minimum_edition", kind: "enum", T: p.getEnumType(ne), opt: true },
  { no: 5, name: "maximum_edition", kind: "enum", T: p.getEnumType(ne), opt: true }
]);
...
Ce.fields = p.util.newFieldList(() => [
  { no: 3, name: "edition", kind: "enum", T: p.getEnumType(ne), opt: true },
  { no: 4, name: "overridable_features", kind: "message", T: z, opt: true },
  { no: 5, name: "fixed_features", kind: "message", T: z, opt: true }
]);
var Ne = class _Ne extends E {
  constructor(e) {
    super(), this.location = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_Ne, e, n);
  }
};
Ne.runtime = p;
Ne.typeName = "google.protobuf.SourceCodeInfo";
Ne.fields = p.util.newFieldList(() => [
  { no: 1, name: "location", kind: "message", T: Pe, repeated: true }
]);
var Pe = class _Pe extends E {
  constructor(e) {
    super(), this.path = [], this.span = [], this.leadingDetachedComments = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
    return new _Pe().fromBinary(e, n);
  }
...
var xe = class _xe extends E {
  constructor(e) {
    super(), this.annotation = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return p.util.equals(_xe, e, n);
  }
};
xe.runtime = p;
xe.typeName = "google.protobuf.GeneratedCodeInfo";
xe.fields = p.util.newFieldList(() => [
  { no: 1, name: "annotation", kind: "message", T: De, repeated: true }
]);
var De = class _De extends E {
  constructor(e) {
    super(), this.path = [], p.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
    return new _De().fromBinary(e, n);
  }
...
De.fields = p.util.newFieldList(() => [
  ...
  { no: 5, name: "semantic", kind: "enum", T: p.getEnumType(Qn), opt: true }
]);
var Qn;
(function(a) {
  a[a.NONE = 0] = "NONE", a[a.SET = 1] = "SET", a[a.ALIAS = 2] = "ALIAS";
})(Qn || (Qn = {}));
p.util.setEnumType(Qn, "google.protobuf.GeneratedCodeInfo.Annotation.Semantic", [
  { no: 0, name: "NONE" },
  { no: 1, name: "SET" },
  { no: 2, name: "ALIAS" }
]);
var _ = class __ extends E {
  constructor(e) {
    super(), this.seconds = Y.zero, this.nanos = 0, o.util.initPartial(e, this);
  }
  fromJson(e, n) {
    if (typeof e != "string")
    ...
    const s = Date.parse(t[1] + "-" + t[2] + "-" + t[3] + "T" + t[4] + ":" + t[5] + ":" + t[6] + (t[8] ? t[8] : "Z"));
    if (Number.isNaN(s))
      throw new Error("cannot decode google.protobuf.Timestamp from JSON: invalid RFC 3339 string");
    if (s < Date.parse("0001-01-01T00:00:00Z") || s > Date.parse("9999-12-31T23:59:59Z"))
      throw new Error("cannot decode message google.protobuf.Timestamp from JSON: must be from 0001-01-01T00:00:00Z to 9999-12-31T23:59:59Z inclusive");
    return this.seconds = Y.parse(s / 1e3), this.nanos = 0, t[7] && (this.nanos = parseInt("1" + t[7] + "0".repeat(9 - t[7].length)) - 1e9), this;
  }
  toJson(e) {
    ...
    if (this.nanos > 0) {
      ...
      s.substring(3) === "000000" ? t = "." + s.substring(0, 3) + "Z" : s.substring(6) === "000" ? t = "." + s.substring(0, 6) + "Z" : t = "." + s + "Z";
    }
  ...
  static now() {
    return __.fromDate(/* @__PURE__ */ new Date());
  }
  static fromDate(e) {
    const n = e.getTime();
    return new __({
      seconds: Y.parse(Math.floor(n / 1e3)),
      nanos: n % 1e3 * 1e6
    });
  }
  static fromBinary(e, n) {
    return new __().fromBinary(e, n);
  }
  static fromJson(e, n) {
    return new __().fromJson(e, n);
  }
  static fromJsonString(e, n) {
    return new __().fromJsonString(e, n);
  }
  static equals(e, n) {
    return o.util.equals(__, e, n);
  }
};
_.runtime = o;
_.typeName = "google.protobuf.Timestamp";
_.fields = o.util.newFieldList(() => [
  {
    no: 1,
    name: "seconds",
    kind: "scalar",
...
var $ = class _$ extends E {
  ...
  fromJson(e, n) {
    ...
    if (s > 315576e6 || s < -315576e6)
      throw new Error(`cannot decode google.protobuf.Duration from JSON: ${o.json.debug(e)}`);
    if (this.seconds = Y.parse(s), typeof t[2] == "string") {
  ...
  static equals(e, n) {
    return o.util.equals(_$, e, n);
  }
};
$.runtime = o;
$.typeName = "google.protobuf.Duration";
$.fields = o.util.newFieldList(() => [
  {
    no: 1,
    name: "seconds",
    kind: "scalar",
...
var W = class _W extends E {
  constructor(e) {
    super(), this.typeUrl = "", this.value = new Uint8Array(0), o.util.initPartial(e, this);
  }
  toJson(e) {
    var n;
    if (this.typeUrl === "")
      return {};
    const t = this.typeUrlToName(this.typeUrl), s = (n = e == null ? void 0 : e.typeRegistry) === null || n === void 0 ? void 0 : n.findMessage(t);
    if (!s)
  ...
  fromJson(e, n) {
    ...
    const i = this.typeUrlToName(s), r = (t = n == null ? void 0 : n.typeRegistry) === null || t === void 0 ? void 0 : t.findMessage(i);
    if (!r)
      throw new Error(`cannot decode message google.protobuf.Any from JSON: ${s} is not in the type registry`);
    let c;
  ...
  static equals(e, n) {
    return o.util.equals(_W, e, n);
  }
};
W.runtime = o;
W.typeName = "google.protobuf.Any";
...
o.util.setEnumType(fn, "google.protobuf.NullValue", [
  { no: 0, name: "NULL_VALUE" }
]);
var u = class _u2 extends E {
  constructor(e) {
    super(), this.fields = {}, o.util.initPartial(e, this);
  }
  toJson(e) {
    const n = {};
  ...
  fromJson(e, n) {
    if (typeof e != "object" || e == null || Array.isArray(e))
      throw new Error("cannot decode google.protobuf.Struct from JSON " + o.json.debug(e));
    for (const [t, s] of Object.entries(e))
      this.fields[t] = X.fromJson(s);
    return this;
  }
  static fromBinary(e, n) {
    return new _u2().fromBinary(e, n);
  }
  static fromJson(e, n) {
    return new _u2().fromJson(e, n);
  }
  static fromJsonString(e, n) {
    return new _u2().fromJsonString(e, n);
  }
  static equals(e, n) {
    return o.util.equals(_u2, e, n);
  }
};
u.runtime = o;
u.typeName = "google.protobuf.Struct";
u.fields = o.util.newFieldList(() => [
...
var X = class _X extends E {
  ...
  fromJson(e, n) {
    switch (typeof e) {
      ...
      case "boolean":
        ...
        break;
      case "object":
        e === null ? this.kind = { case: "nullValue", value: fn.NULL_VALUE } : Array.isArray(e) ? this.kind = { case: "listValue", value: me.fromJson(e) } : this.kind = { case: "structValue", value: u.fromJson(e) };
        break;
      default:
        throw new Error("cannot decode google.protobuf.Value from JSON " + o.json.debug(e));
    }
    return this;
  }
  static fromBinary(e, n) {
  ...
  static equals(e, n) {
    return o.util.equals(_X, e, n);
  }
};
X.runtime = o;
X.typeName = "google.protobuf.Value";
X.fields = o.util.newFieldList(() => [
  { no: 1, name: "null_value", kind: "enum", T: o.getEnumType(fn), oneof: "kind" },
  ...
  { no: 5, name: "struct_value", kind: "message", T: u, oneof: "kind" },
  { no: 6, name: "list_value", kind: "message", T: me, oneof: "kind" }
]);
var me = class _me extends E {
  constructor(e) {
    super(), this.values = [], o.util.initPartial(e, this);
  }
  toJson(e) {
  ...
  fromJson(e, n) {
    if (!Array.isArray(e))
      throw new Error("cannot decode google.protobuf.ListValue from JSON " + o.json.debug(e));
    for (let t of e)
  ...
  static equals(e, n) {
    return o.util.equals(_me, e, n);
  }
};
me.runtime = o;
me.typeName = "google.protobuf.ListValue";
me.fields = o.util.newFieldList(() => [
...
var C = class _C extends Error {
   ...
   */
  constructor(e, n = O.Unknown, t, s, i) {
    super(sh(e, n)), this.name = "ConnectError", Object.setPrototypeOf(this, new.target.prototype), this.rawMessage = e, this.code = n, this.metadata = new Headers(t ?? {}), this.details = s ?? [], this.cause = i;
  }
  /**
   ...
   * ConnectError.
   */
  static from(e, n = O.Unknown) {
    return e instanceof _C ? e : e instanceof Error ? e.name == "AbortError" ? new _C(e.message, O.Canceled) : new _C(e.message, n, void 0, void 0, e) : new _C(String(e), n, void 0, void 0, e);
  }
  static [Symbol.hasInstance](e) {
    return e instanceof Error ? Object.getPrototypeOf(e) === _C.prototype ? true : e.name === "ConnectError" && "code" in e && typeof e.code == "number" && "metadata" in e && "details" in e && Array.isArray(e.details) && "rawMessage" in e && typeof e.rawMessage == "string" && "cause" in e : false;
  }
  findDetails(e) {
    const n = "typeName" in e ? {
      findMessage: (s) => s === e.typeName ? e : void 0
    } : e, t = [];
    for (const s of this.details) {
      if ("getType" in s) {
        n.findMessage(s.getType().typeName) && t.push(s);
        continue;
      }
      const i = n.findMessage(s.type);
      if (i)
        try {
          t.push(i.fromBinary(s.value));
        } catch {
        }
    }
    return t;
...
function oh(a, e, n) {
  try {
    ...
    throw C.from(t, O.DataLoss);
  }
}
function ih(a, e) {
  const n = {};
  for (const [t, s] of Object.entries(a.methods)) {
    const i = e(Object.assign(Object.assign({}, s), {
      localName: t,
      service: a
    }));
    i != null && (n[t] = i);
  ...
  return new ReadableStream({
    ...
    async pull(s) {
      ...
      if (i === void 0) {
        ...
        s.error(new C("premature end of stream", O.DataLoss));
        return;
      }
      const r = n.subarray(5, 5 + i.length);
      n = n.subarray(5 + i.length), s.enqueue({
        flags: i.flags,
        data: r
      });
    }
...
var vn = function(a) {
  return this instanceof vn ? (this.v = a, this) : new vn(a);
};
var mh = function(a, e, n) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var t = n.apply(a, e || []), s, i = [];
  return s = {}, c("next"), c("throw"), c("return", r), s[Symbol.asyncIterator] = function() {
    return this;
  }, s;
  function r(R) {
    return function(I) {
      return Promise.resolve(I).then(R, v);
    };
  }
  function c(R, I) {
    t[R] && (s[R] = function(M) {
      return new Promise(function(N, F) {
        i.push([R, M, N, F]) > 1 || d(R, M);
      });
    }, I && (s[R] = I(s[R])));
  }
  function d(R, I) {
  ...
  function l(R) {
    R.value instanceof vn ? Promise.resolve(R.value.v).then(T, v) : S(i[0][2], R);
  }
  function T(R) {
    d("next", R);
  }
  ...
  function S(R, I) {
    R(I), i.shift(), i.length && d(i[0][0], i[0][1]);
  }
};
var ch = function(a) {
  var e, n;
  ...
  function t(s, i) {
    e[s] = a[s] ? function(r) {
      return (n = !n) ? { value: vn(a[s](r)), done: false } : i ? i(r) : r;
    } : i;
  }
};
function lh() {
  const a = [], e = [];
  let n, t, s, i = new Promise((d, l) => {
    t = d, s = l;
  }), r = false;
  function c() {
  ...
  return {
    ...
    async write(d) {
      ...
      if (l === void 0)
        e.push(d);
      else if (l({ done: false, value: d }), a.length > 0)
        return;
      const T = e.length + 1;
      for (let v = 0; v < T; v++)
        await i;
    ...
    [Symbol.asyncIterator]() {
      return {
        next() {
          ...
          let l;
          const T = new Promise((v) => l = v);
          return a.push(l), T;
        },
        throw(d) {
          return n = d, r = true, e.splice(0, e.length), i.catch(() => {
          }), s(n), c(), Promise.resolve({ done: true, value: void 0 });
        },
        return() {
...
var Ze = function(a) {
  return this instanceof Ze ? (this.v = a, this) : new Ze(a);
};
var uh = function(a) {
  var e, n;
  return e = {}, t("next"), t("throw", function(s) {
  ...
  function t(s, i) {
    e[s] = a[s] ? function(r) {
      return (n = !n) ? { value: Ze(a[s](r)), done: false } : i ? i(r) : r;
    } : i;
  }
};
var ph = function(a, e, n) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var t = n.apply(a, e || []), s, i = [];
  return s = {}, c("next"), c("throw"), c("return", r), s[Symbol.asyncIterator] = function() {
  ...
  function l(R) {
    R.value instanceof Ze ? Promise.resolve(R.value.v).then(T, v) : S(i[0][2], R);
  }
  function T(R) {
    d("next", R);
  }
...
function gh(a, e, n) {
  return async function(t, s) {
    var i, r;
    const c = await a.unary(e, n, s == null ? void 0 : s.signal, s == null ? void 0 : s.timeoutMs, s == null ? void 0 : s.headers, t, s == null ? void 0 : s.contextValues);
    return (i = s == null ? void 0 : s.onHeader) === null || i === void 0 || i.call(s, c.header), (r = s == null ? void 0 : s.onTrailer) === null || r === void 0 || r.call(s, c.trailer), c.message;
  };
}
function Th(a, e, n) {
  return function(t, s) {
    return Li(a.stream(e, n, s == null ? void 0 : s.signal, s == null ? void 0 : s.timeoutMs, s == null ? void 0 : s.headers, dh([t]), s == null ? void 0 : s.contextValues), s);
  };
}
function kh(a, e, n) {
  return async function(t, s) {
    var i, r, c, d, l, T;
    const v = await a.stream(e, n, s == null ? void 0 : s.signal, s == null ? void 0 : s.timeoutMs, s == null ? void 0 : s.headers, t, s == null ? void 0 : s.contextValues);
    (l = s == null ? void 0 : s.onHeader) === null || l === void 0 || l.call(s, v.header);
    let S, R = 0;
    try {
      for (var I = true, M = Gi(v.message), N; N = await M.next(), i = N.done, !i; I = true)
        d = N.value, I = false, S = d, R++;
    } catch (F) {
      r = { error: F };
    } finally {
      try {
        !I && !i && (c = M.return) && await c.call(M);
      } finally {
        if (r)
          throw r.error;
      }
    ...
    if (!S)
      throw new C("protocol error: missing response message", O.Unimplemented);
    if (R > 1)
      throw new C("protocol error: received extra messages for client streaming method", O.Unimplemented);
    return (T = s == null ? void 0 : s.onTrailer) === null || T === void 0 || T.call(s, v.trailer), S;
  };
}
function yh(a, e, n) {
  return function(t, s) {
    return Li(a.stream(e, n, s == null ? void 0 : s.signal, s == null ? void 0 : s.timeoutMs, s == null ? void 0 : s.headers, t, s == null ? void 0 : s.contextValues), s);
  };
}
function Li(a, e) {
  const n = function() {
    return ph(this, arguments, function* () {
      var t, s;
      const i = yield Ze(a);
      (t = e == null ? void 0 : e.onHeader) === null || t === void 0 || t.call(e, i.header), yield Ze(yield* uh(Gi(i.message))), (s = e == null ? void 0 : e.onTrailer) === null || s === void 0 || s.call(e, i.trailer);
    });
  }()[Symbol.asyncIterator]();
  return {
    [Symbol.asyncIterator]: () => ({
...
function hh(...a) {
  const e = new AbortController(), n = a.filter((s) => s !== void 0).concat(e.signal);
  for (const s of n) {
    if (s.aborted) {
      t.apply(s);
      break;
  ...
  function t() {
    e.signal.aborted || e.abort(Bi(this));
    for (const s of n)
      s.removeEventListener("abort", t);
  }
  return e;
}
function fh(a) {
  const e = new AbortController(), n = () => {
    e.abort(new C("the operation timed out", O.DeadlineExceeded));
  };
  let t;
...
`);
  for (const t of n) {
    ...
    const s = t.indexOf(":");
    if (s > 0) {
      const i = t.substring(0, s).trim(), r = t.substring(s + 1).trim();
      e.append(i, r);
    }
  }
  return e;
...
var en = "Grpc-Status";
var xi = "Grpc-Message";
var _h = "Grpc-Status-Details-Bin";
var Sh = "X-User-Agent";
var Ih = "X-Grpc-Web";
var bh = "application/grpc-web+proto";
var wh = "application/grpc-web+json";
var ra = class dn extends E {
  constructor(e) {
    super(), this.code = 0, this.message = "", this.details = [], o.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
...
ra.runtime = o;
ra.typeName = "google.rpc.Status";
ra.fields = o.util.newFieldList(() => [
  {
    no: 1,
    name: "code",
    kind: "scalar",
  ...
  { no: 3, name: "details", kind: "message", T: W, repeated: true }
]);
var Eh = "0";
function Fi(a) {
  var e;
  ...
  if (n != null) {
    ...
    if (s.code == 0)
      return;
    const i = new C(s.message, s.code, a);
    return i.details = s.details.map((r) => ({
  ...
  if (t != null) {
    ...
    return s in O ? new C(decodeURIComponent((e = a.get(xi)) !== null && e !== void 0 ? e : ""), s, a) : new C(`invalid grpc-status: ${t}`, O.Internal, a);
  }
}
function oi(a, e, n) {
  const t = typeof e == "string" ? e : e.typeName, s = typeof n == "string" ? n : n.name;
  return a.toString().replace(/\/?$/, `/${t}/${s}`);
}
function Ji(a, e) {
...
function Oh(a, e) {
  ...
  return {
    [Symbol.asyncIterator]() {
      const t = e[Symbol.asyncIterator](), s = {
        next: () => t.next().then(n)
      };
      return t.throw !== void 0 && (s.throw = (i) => t.throw(i).then(n)), t.return !== void 0 && (s.return = (i) => t.return(i).then(n)), s;
    }
  };
}
function zi(a, e) {
  var n;
  return (n = e == null ? void 0 : e.concat().reverse().reduce(
...
function Pa(a, e, n, t) {
  const s = e ? ii(a.I, t) : ri(a.I, n);
  return { parse: (e ? ii(a.O, t) : ri(a.O, n)).parse, serialize: s.serialize };
}
function ii(a, e) {
  return {
    parse(n) {
      try {
        ...
        throw new C(`parse binary: ${s}`, O.Internal);
      }
    },
    serialize(n) {
      try {
        ...
        const s = t instanceof Error ? t.message : String(t);
        throw new C(`serialize binary: ${s}`, O.Internal);
      }
    }
  };
}
function ri(a, e) {
  var n, t;
  const s = (n = e == null ? void 0 : e.textEncoder) !== null && n !== void 0 ? n : new TextEncoder(), i = (t = e == null ? void 0 : e.textDecoder) !== null && t !== void 0 ? t : new TextDecoder(), r = Mh(e);
  return {
    parse(c) {
      try {
        const d = i.decode(c);
        ...
        throw C.from(d, O.InvalidArgument);
      }
    },
    serialize(c) {
      try {
        ...
        throw C.from(d, O.Internal);
      }
    }
  };
}
function Yi(a) {
  const e = zi(a.next, a.interceptors), [n, t, s] = Vi(a), i = Object.assign(Object.assign({}, a.req), { message: Ji(a.req.method.I, a.req.message), signal: n });
  return e(i).then((r) => (s(), r), t);
}
function $i(a) {
  const e = zi(a.next, a.interceptors), [n, t, s] = Vi(a), i = Object.assign(Object.assign({}, a.req), { message: Oh(a.req.method.I, a.req.message), signal: n });
  let r = false;
  return n.addEventListener("abort", function() {
    var c, d;
    const l = a.req.message[Symbol.asyncIterator]();
    r || (c = l.throw) === null || c === void 0 || c.call(l, this.reason).catch(() => {
    }), (d = l.return) === null || d === void 0 || d.call(l).catch(() => {
    });
    ...
    [Symbol.asyncIterator]() {
      ...
      return {
        next() {
          return d.next().then((l) => (l.done == true && (r = true, s()), l), t);
        }
...
function Vi(a) {
  const { signal: e, cleanup: n } = fh(a.timeoutMs), t = hh(a.signal, e);
  return [
    t.signal,
    function(i) {
      const r = C.from(e.aborted ? Bi(e) : i);
...
var Lh = (
  ...
  function() {
    ...
    return a.prototype.apply = function() {
      ...
      get: function() {
        var e = Gh.JitterFactory(this.options);
        return e(this.delay);
      },
      enumerable: true,
      configurable: true
      ...
      get: function() {
        var e = this.options.startingDelay, n = this.options.timeMultiple, t = this.numOfDelayedAttempts, s = e * Math.pow(n, t);
...
var xh = j && j.__awaiter || function(a, e, n, t) {
  function s(i) {
  ...
  return new (n || (n = Promise))(function(i, r) {
    ...
    function l(T) {
      T.done ? i(T.value) : s(T.value).then(c, d);
    }
    l((t = t.apply(a, e || [])).next());
  });
};
var Fh = j && j.__generator || function(a, e) {
  ...
  function d(l) {
    ...
    for (; n; )
      try {
        if (t = 1, s && (i = l[0] & 2 ? s.return : l[0] ? s.throw || ((i = s.return) && i.call(s), 0) : s.next) && !(i = i.call(s, l[1])).done)
          return i;
...
Qa.SkipFirstDelay = zh;
var at = {};
var Yh = j && j.__extends || function() {
  var a = function(e, n) {
    return a = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, s) {
      t.__proto__ = s;
    } || function(t, s) {
...
Xa.DelayFactory = Hh;
function Kh(a) {
  return a.delayFirstAttempt ? new jh.AlwaysDelay(a) : new Wh.SkipFirstDelay(a);
}
var Da = j && j.__awaiter || function(a, e, n, t) {
  function s(i) {
    return i instanceof n ? i : new n(function(r) {
      r(i);
    });
...
var Aa = j && j.__generator || function(a, e) {
  var n = { label: 0, sent: function() {
    if (i[0] & 1)
      throw i[1];
    return i[1];
...
var Qh = Xa;
function Zh(a, e) {
  return e === void 0 && (e = {}), Da(this, void 0, void 0, function() {
    var n, t;
    return Aa(this, function(s) {
      switch (s.label) {
        case 0:
          return n = Xh.getSanitizedOptions(e), t = new ef(a, n), [4, t.execute()];
        case 1:
          return [2, s.sent()];
      }
    });
    ...
    return a.prototype.execute = function() {
      ...
      return Da(this, void 0, void 0, function() {
        ...
        return Aa(this, function(n) {
          switch (n.label) {
            case 0:
              return e = Qh.DelayFactory(this.options, this.attemptNumber), [4, e.apply()];
            case 1:
              return n.sent(), [
                2
                /*return*/
...
var Ua = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "credentials", kind: "message", T: ji }
  ]
);
var nf = o.makeMessageType(
...
var mf = o.makeMessageType(
  "proto.rpc.webrtc.v1.CallResponseUpdateStage",
  () => [
    { no: 1, name: "candidate", kind: "message", T: bn }
  ]
);
var cf = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "init", kind: "message", T: rf, oneof: "stage" },
    { no: 3, name: "update", kind: "message", T: mf, oneof: "stage" }
  ]
);
var Bn = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "candidate", kind: "message", T: bn, oneof: "update" },
    { no: 3, name: "done", kind: "scalar", T: 8, oneof: "update" },
    { no: 4, name: "error", kind: "message", T: nn, oneof: "update" }
  ]
);
var lf = o.makeMessageType(
  "proto.rpc.webrtc.v1.CallUpdateResponse",
  []
);
var df = o.makeMessageType(
...
var na = o.makeMessageType(
  "proto.rpc.webrtc.v1.WebRTCConfig",
  () => [
    { no: 1, name: "additional_ice_servers", kind: "message", T: df, repeated: true },
    {
      no: 2,
      name: "disable_trickle",
      kind: "scalar",
...
var uf = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "optional_config", kind: "message", T: na },
    { no: 3, name: "deadline", kind: "message", T: _, opt: true }
  ]
);
var pf = o.makeMessageType(
  "proto.rpc.webrtc.v1.AnswerRequestUpdateStage",
  () => [
    { no: 1, name: "candidate", kind: "message", T: bn }
  ]
);
var gf = o.makeMessageType(
...
var Tf = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "status", kind: "message", T: nn }
  ]
);
var kf = o.makeMessageType(
  "proto.rpc.webrtc.v1.AnswerRequestHeartbeatStage",
  []
);
var yf = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "init", kind: "message", T: uf, oneof: "stage" },
    { no: 3, name: "update", kind: "message", T: pf, oneof: "stage" },
    { no: 4, name: "done", kind: "message", T: gf, oneof: "stage" },
    { no: 5, name: "error", kind: "message", T: Tf, oneof: "stage" },
    { no: 6, name: "heartbeat", kind: "message", T: kf, oneof: "stage" }
  ]
);
var hf = o.makeMessageType(
...
var ff = o.makeMessageType(
  "proto.rpc.webrtc.v1.AnswerResponseUpdateStage",
  () => [
    { no: 1, name: "candidate", kind: "message", T: bn }
  ]
);
var vf = o.makeMessageType(
...
var _f = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "init", kind: "message", T: hf, oneof: "stage" },
    { no: 3, name: "update", kind: "message", T: ff, oneof: "stage" },
    { no: 4, name: "done", kind: "message", T: vf, oneof: "stage" },
    { no: 5, name: "error", kind: "message", T: Rf, oneof: "stage" }
  ]
);
var Sf = o.makeMessageType(
  "proto.rpc.webrtc.v1.OptionalWebRTCConfigRequest",
  []
);
var If = o.makeMessageType(
  "proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse",
  () => [
    { no: 1, name: "config", kind: "message", T: na }
  ]
);
var Ki = {
...
var Xi = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
var Ga = (a = "") => {
  const e = a;
  let n = "";
  for (let t = 0, s, i = 0, r = Xi; e.charAt(Math.trunc(i)) || (r = "=", i % 1); n += r.charAt(63 & t >> 8 - i % 1 * 8)) {
...
var Qi = (a = "") => {
  ...
  for (
    ...
    ~i && (s = t % 4 ? s * 64 + i : i, t++ % 4) ? n += String.fromCharCode(255 & s >> (-2 * t & 6)) : 0
  )
    i = Xi.indexOf(i);
  return n;
};
...
var bf = async (a, e, n) => {
  ...
  }, s = new RTCPeerConnection(t);
  let i;
  const r = new Promise((v) => {
    i = v;
  }), c = s.createDataChannel("data", {
    id: 0,
    negotiated: true,
    ordered: true
  });
  c.binaryType = "arraybuffer";
  const d = s.createDataChannel("negotiation", {
    id: 1,
    negotiated: true,
    ordered: true
  });
  ...
  if (d.addEventListener("open", () => {
    ...
    (v) => {
      (async () => {
        const S = new RTCSessionDescription(
          JSON.parse(Qi(v.data))
        );
        if (await s.setRemoteDescription(S), S.type === "offer") {
          await s.setLocalDescription();
          const R = La(
            s.localDescription,
            n
          );
          d.send(Ga(JSON.stringify(R)));
        }
      })().catch(console.error);
    }
    ...
    (async () => {
      ...
      d.send(Ga(JSON.stringify(v)));
    })().catch(console.error);
  }), !a)
    return { pc: s, dc: c };
  const T = await s.createOffer({});
  return await s.setLocalDescription(T), s.addEventListener("icecandidate", (v) => {
    v.candidate === null && i({ pc: s, dc: c });
  }), r;
};
function wf() {
  try {
...
function mi(a, e) {
  ...
  if (n)
    throw e.forEach((t, s) => {
      n.metadata.append(s, t);
    }), n;
  if (!e.has(en) && !a.has(en))
    throw new C("protocol error: missing status", O.Internal);
}
function ci(a, e, n, t) {
  const s = new Headers(n ?? {});
  return s.set(vh, a ? bh : wh), s.set(Ih, "1"), s.set(Sh, "connect-es/1.6.1"), e !== void 0 && s.set(Rh, `${e}m`), s;
}
function Ef(a) {
  switch (a) {
    case 400:
...
function li(a, e) {
  ...
  if (a >= 200 && a < 300)
    return {
      foundStatus: e.has(en),
      headerError: Fi(e)
    };
  throw new C(decodeURIComponent((n = e.get(xi)) !== null && n !== void 0 ? n : `HTTP ${a}`), Ef(a), e);
}
var Ye = function(a) {
  return this instanceof Ye ? (this.v = a, this) : new Ye(a);
};
var Of = function(a, e, n) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var t = n.apply(a, e || []), s, i = [];
  return s = {}, c("next"), c("throw"), c("return", r), s[Symbol.asyncIterator] = function() {
  ...
  function l(R) {
    R.value instanceof Ye ? Promise.resolve(R.value.v).then(T, v) : S(i[0][2], R);
  }
  function T(R) {
    d("next", R);
  }
...
function Mf(a) {
  ...
  return {
    async unary(t, s, i, r, c, d, l) {
      var T;
      const { serialize: v, parse: S } = Pa(s, n, a.jsonOptions, a.binaryOptions);
      return r = r === void 0 ? a.defaultTimeoutMs : r <= 0 ? void 0 : r, await Yi({
        ...
        next: async (R) => {
          var I;
          const N = await ((I = a.fetch) !== null && I !== void 0 ? I : globalThis.fetch)(R.url, Object.assign(Object.assign({}, R.init), { headers: R.header, signal: R.signal, body: ti(0, v(R.message)) })), { headerError: F } = li(N.status, N.headers);
          if (!N.body)
            throw F !== void 0 ? F : "missing response body";
          const k = ai(N.body).getReader();
          let h, g;
          for (; ; ) {
            const y = await k.read();
            if (y.done)
              break;
            const { flags: w, data: b } = y.value;
            if ((w & ni) === ni)
              throw new C("protocol error: received unsupported compressed output", O.Internal);
            if (w === Ea) {
              if (h !== void 0)
                throw "extra trailer";
              h = si(b);
            ...
            if (g !== void 0)
              throw new C("extra message", O.Unimplemented);
            g = S(b);
          }
          if (h === void 0)
            throw F !== void 0 ? F : new C("missing trailer", N.headers.has(en) ? O.Unimplemented : O.Unknown);
          if (mi(h, N.headers), g === void 0)
            throw new C("missing message", h.has(en) ? O.Unimplemented : O.Unknown);
          return {
            stream: false,
            service: t,
            method: s,
    ...
    async stream(t, s, i, r, c, d, l) {
      var T;
      const { serialize: v, parse: S } = Pa(s, n, a.jsonOptions, a.binaryOptions);
      function R(M, N, F, k, h) {
        return Of(this, arguments, function* () {
          const y = ai(M).getReader();
          if (N) {
            if (!(yield Ye(y.read())).done)
              throw "extra data for trailers-only";
            return yield Ye(void 0);
          }
          let w = false;
          for (; ; ) {
            const b = yield Ye(y.read());
            if (b.done)
              break;
            ...
            if ((Z & Ea) === Ea) {
              ...
              w = true;
              const J = si(D);
              mi(J, k), J.forEach((_a, Sa) => F.set(Sa, _a));
              continue;
            }
            if (w)
              throw "extra message";
          ...
          if ("throwIfAborted" in h && h.throwIfAborted(), !w)
            throw "missing trailer";
        });
      }
      async function I(M) {
        if (s.kind != m.ServerStreaming)
          throw "The fetch API does not support streaming request bodies";
        const N = await M[Symbol.asyncIterator]().next();
        if (N.done == true)
          throw "missing request message";
        return ti(0, v(N.value));
      }
      return r = r === void 0 ? a.defaultTimeoutMs : r <= 0 ? void 0 : r, $i({
        interceptors: a.interceptors,
        signal: i,
        timeoutMs: r,
        req: {
        ...
        next: async (M) => {
          var N;
          const k = await ((N = a.fetch) !== null && N !== void 0 ? N : globalThis.fetch)(M.url, Object.assign(Object.assign({}, M.init), { headers: M.header, signal: M.signal, body: await I(M.message) })), { foundStatus: h, headerError: g } = li(k.status, k.headers);
          if (g != null)
            throw g;
          if (!k.body)
            throw "missing response body";
          const y = new Headers();
          return Object.assign(Object.assign({}, M), { header: k.headers, trailer: y, message: R(k.body, h, y, k.headers, M.signal) });
        }
      });
    }
  };
}
var aa = o.makeMessageType(
...
var Oa = o.makeMessageType(
  "proto.rpc.webrtc.v1.Request",
  () => [
    { no: 1, name: "stream", kind: "message", T: tt },
    { no: 2, name: "headers", kind: "message", T: Zi, oneof: "type" },
    { no: 3, name: "message", kind: "message", T: Ba, oneof: "type" },
    { no: 4, name: "rst_stream", kind: "scalar", T: 8, oneof: "type" }
  ]
);
var Zi = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "metadata", kind: "message", T: ca },
    { no: 3, name: "timeout", kind: "message", T: $ }
  ]
);
var Ba = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "packet_message", kind: "message", T: aa },
    {
      no: 3,
      name: "eos",
      kind: "scalar",
...
var Cf = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "stream", kind: "message", T: tt },
    { no: 2, name: "headers", kind: "message", T: Nf, oneof: "type" },
    { no: 3, name: "message", kind: "message", T: Pf, oneof: "type" },
    { no: 4, name: "trailers", kind: "message", T: Df, oneof: "type" }
  ]
);
var Nf = o.makeMessageType(
  "proto.rpc.webrtc.v1.ResponseHeaders",
  () => [
    { no: 1, name: "metadata", kind: "message", T: ca }
  ]
);
var Pf = o.makeMessageType(
  "proto.rpc.webrtc.v1.ResponseMessage",
  () => [
    { no: 1, name: "packet_message", kind: "message", T: aa }
  ]
);
var Df = o.makeMessageType(
...
var er = o.makeMessageType(
  "proto.rpc.webrtc.v1.Strings",
  () => [
    { no: 1, name: "values", kind: "scalar", T: 9, repeated: true }
  ]
);
var ca = o.makeMessageType(
  "proto.rpc.webrtc.v1.Metadata",
  () => [
    { no: 1, name: "md", kind: "map", K: 9, V: { kind: "message", T: er } }
  ]
);
var Ae = class _Ae extends Error {
  constructor(e) {
    super(e);
    __publicField(this, "name", "ConnectionClosedError");
    Object.setPrototypeOf(this, _Ae.prototype);
  }
  static isError(e) {
    return e instanceof _Ae || e instanceof C && e.rawMessage === "closed" ? true : typeof e == "string" ? e === "Response closed without headers" : e instanceof Error ? e.message === "Response closed without headers" : false;
  }
};
var Af = class {
  constructor(e, n) {
    __publicField(this, "ready");
    __publicField(this, "peerConn");
    __publicField(this, "dataChannel");
    __publicField(this, "pResolve");
    __publicField(this, "pReject");
    __publicField(this, "closed", false);
    __publicField(this, "closedReason");
    __publicField(this, "maxDataChannelSize", 65535);
    this.peerConn = e, this.dataChannel = n, this.ready = new Promise((t, s) => {
      this.pResolve = t, this.pReject = s;
      ...
      (t === "failed" || t === "disconnected" || t === "closed") && ((_a = this.pReject) == null ? void 0 : _a.call(this, new Error(`ICE connection failed with state: ${t}`)));
    });
  }
  isClosed() {
    return this.closed;
  ...
  closeWithReason(e) {
    var _a;
    this.closed || (this.closed = true, this.closedReason = e, (_a = this.pReject) == null ? void 0 : _a.call(this, e), this.peerConn.close());
  }
  onChannelOpen() {
    var _a;
    (_a = this.pResolve) == null ? void 0 : _a.call(this, void 0);
  }
  onChannelClose() {
...
var qf = class {
  constructor(e, n) {
    __publicField(this, "grpcStream");
    __publicField(this, "onDone");
    __publicField(this, "closed", false);
    __publicField(this, "packetBuf", []);
    __publicField(this, "packetBufSize", 0);
  ...
  processPacketMessage(e) {
    const { data: n } = e;
    if (n.length + this.packetBufSize > di) {
      this.packetBuf.length = 0, this.packetBufSize = 0, console.error(
        `message size larger than max ${di}; discarding`
      );
      return;
    }
...
var Uf = 16373;
var nr = class extends qf {
  constructor(e, n, t, s, i, r) {
    super(n, t);
    __publicField(this, "channel");
    __publicField(this, "service");
    __publicField(this, "method");
    __publicField(this, "parseMessage");
    __publicField(this, "requestHeaders");
    __publicField(this, "headersReceived", false);
    __publicField(this, "trailersReceived", false);
    this.channel = e, this.service = s, this.method = i;
    const { parse: c } = Pa(
      i,
      true,
      void 0,
    ...
    this.parseMessage = c;
    const d = `/${s.typeName}/${i.name}`;
    this.requestHeaders = new Zi({
      method: d
    });
    const l = Gf(_n(r));
    l && (this.requestHeaders.metadata = l);
  }
  startRequest(e) {
  ...
  writeMessage(e, n) {
    try {
      ...
      for (; t.length > 0; ) {
        ...
        i.data = t.slice(0, s), t = t.slice(s), t.length === 0 && (i.eom = true);
        const r = new Ba({
          hasMessage: !!t,
          packetMessage: i,
          eos: e
...
var xa = (a) => {
  const e = Object.entries((a == null ? void 0 : a.md) ?? {}).flatMap(
    ([n, { values: t }]) => t.map((s) => [n, s])
  );
  return new Headers(e);
};
var Lf = class extends nr {
  constructor() {
    super(...arguments);
    __publicField(this, "awaitingHeadersResult");
    __publicField(this, "gotHeaders", false);
    // trailers will be written to later
    __publicField(this, "respStream", lh());
    __publicField(this, "trailers", new Headers());
    __publicField(this, "respStreamQueue");
  }
  async run(e, n, t, s) {
    const r = {
      req: {
    ...
    return e && (r.signal = e), n !== void 0 && (r.timeoutMs = n), $i(r);
  }
  ...
  onHeaders(e) {
    var _a;
    this.gotHeaders = true, (_a = this.awaitingHeadersResult) == null ? void 0 : _a.success(xa(e.metadata));
  }
  onTrailers(e) {
    var _a, _b, _c2;
    if ((_a = e.metadata) == null ? void 0 : _a.md) {
      for (const n in e.metadata.md)
        if (Object.hasOwn(e.metadata.md, n)) {
          const t = e.metadata.md[n];
          for (const s of (t == null ? void 0 : t.values) ?? [])
            this.trailers.append(n, s);
        }
    }
    if (this.respStream.close(), !e.status || e.status.code === 0) {
      if (this.gotHeaders)
        return;
      (_b = this.awaitingHeadersResult) == null ? void 0 : _b.success(new Headers());
      return;
    }
    this.gotHeaders || ((_c2 = this.awaitingHeadersResult) == null ? void 0 : _c2.failure(e.status.message));
  }
  onMessage(e) {
...
var Bf = class extends nr {
  ...
  async run(e, n, t, s) {
    const r = {
       ...
       * ultimately call this for us.
       */
      next: async (c) => new Promise((d, l) => {
        this.result = { success: d, failure: l }, this.startRequest(), this.sendMessage(c.message.toBinary());
      })
    };
    return e && (r.signal = e), n !== void 0 && (r.timeoutMs = n), Yi(r);
  }
  onHeaders(e) {
    var _a;
    if (this.headers !== void 0) {
      (_a = this.result) == null ? void 0 : _a.failure(
  ...
  onTrailers(e) {
    ...
    if (!e.status || e.status.code === 0) {
      ...
      if (this.message === void 0) {
        (_b = this.result) == null ? void 0 : _b.failure(
          new Error(
      ...
      (_c2 = this.result) == null ? void 0 : _c2.success({
        stream: false,
        header: this.headers,
    ...
    (_d2 = this.result) == null ? void 0 : _d2.failure(e.status.message);
  }
  onMessage(e) {
    var _a;
    if (this.message !== void 0) {
...
var xf = 256;
var Ff = class extends Af {
  constructor(e, n) {
    super(e, n);
    __publicField(this, "streamIDCounter", 0);
  ...
  onChannelMessage(e) {
    const n = Cf.fromBinary(new Uint8Array(e.data)), { stream: t } = n;
    if (t === void 0) {
      console.error("no stream id; discarding");
      return;
    }
    const { id: s } = t, i = this.streams.get(s.toString());
    if (i === void 0) {
      console.error("no stream for id; discarding", "id", s);
      return;
    }
    i.cs.onResponse(n);
  }
  nextStreamID() {
    ...
    return this.streamIDCounter += 1, new tt({
      id: BigInt(e)
    });
  }
  newStream(e, n, t, s, i) {
    ...
    if (Object.keys(this.streams).length > xf)
...
var Ma = "invariant: call uuid unset";
var Jf = class {
  constructor(e, n, t, s, i) {
    __publicField(this, "clientChannel");
    __publicField(this, "callUuid");
    // only send once since exchange may end or ICE may end
    __publicField(this, "sentDoneOrErrorOnce", false);
    __publicField(this, "exchangeDone", false);
    __publicField(this, "iceComplete", false);
    __publicField(this, "haveInitResponse", false);
    __publicField(this, "awaitingRemoteDescription");
    __publicField(this, "remoteDescriptionSet");
    // stats
    __publicField(this, "numCallUpdates", 0);
    __publicField(this, "maxCallUpdateDuration", 0);
    __publicField(this, "totalCallUpdateDuration", 0);
    this.signalingClient = e, this.callOpts = n, this.pc = t, this.dc = s, this.dialOpts = i, this.clientChannel = new Ff(this.pc, this.dc);
  }
  async doExchange() {
    var _a;
    await this.setup();
    const e = La(
      ...
      (_a = this.dialOpts) == null ? void 0 : _a.additionalSdpFields
    ), n = Ga(JSON.stringify(e)), t = new Hi({
      sdp: n
    });
    ...
    const s = this.signalingClient.call(t, this.callOpts), i = this.processCallResponses(s);
  ...
  async setup() {
    ...
    }), !((_a = this.dialOpts) == null ? void 0 : _a.disableTrickleICE)) {
  ...
  handleInitError(e) {
    if (!(this.exchangeDone || this.pc.iceConnectionState === "connected")) {
      if (e instanceof C && e.code === O.Unimplemented) {
  ...
  async handleInitResponse(e, n) {
    ...
    return this.clientChannel.isClosed() ? (await this.sendError("client channel is closed"), false) : (await this.pc.setRemoteDescription(t), (_a = this.awaitingRemoteDescription) == null ? void 0 : _a.success(true), ((_b = this.dialOpts) == null ? void 0 : _b.disableTrickleICE) ? (this.exchangeDone = true, await this.sendDone(), false) : true);
  }
  async handleUpdateResponse(e, n) {
    ...
    const t = zf(n.candidate);
    t.candidate !== void 0 && console.debug(`received remote ICE ${t.candidate}`);
    try {
      await this.pc.addIceCandidate(t);
    } catch (s) {
      throw console.log("error adding ice candidate", s), await this.sendError(JSON.stringify(s)), s;
    }
    return true;
  }
  async onLocalICECandidate(e) {
    ...
    const n = Yf(e.candidate), t = new Bn({
      uuid: this.callUuid,
      update: {
        case: "candidate",
        value: n
...
var Rn = async (a, e) => {
  var _a;
  tr(e);
  const n = ((_a = globalThis.VIAM) == null ? void 0 : _a.GRPC_TRANSPORT_FACTORY) ?? Mf, t = {
    baseUrl: a
  };
  if ((e == null ? void 0 : e.accessToken) !== void 0 && e.accessToken !== "" && !(e.externalAuthAddress !== void 0 && e.externalAuthAddress !== "" && e.externalAuthToEntity !== void 0 && e.externalAuthToEntity !== "")) {
    const s = new Headers(e.extraHeaders);
    return s.set("authorization", `Bearer ${e.accessToken}`), new ar(t, n, s);
  }
  return e === void 0 || e.credentials === void 0 && e.accessToken === void 0 ? n(t) : $f(
    a,
    n,
    e,
    t
...
var Fa = /^.*:\/\//u;
var $f = async (a, e, n, t) => {
  const s = new Headers(n.extraHeaders);
  let i;
  if (n.accessToken === void 0 || n.accessToken === "") {
    const r = new Ua({
      entity: En(n.credentials) && n.credentials.authEntity ? n.credentials.authEntity : a.replace(Fa, "")
    });
    n.credentials && (r.credentials = new ji({
      type: n.credentials.type,
      payload: n.credentials.payload
    }));
    const c = n.externalAuthAddress ?? a, d = e({ baseUrl: c });
    i = (await P(sf, d).authenticate(r)).accessToken;
  } else
    i = n.accessToken;
  ...
  return s.set("authorization", `Bearer ${i}`), new ar(t, e, s);
};
var ar = class {
  constructor(e, n, t) {
  ...
  async unary(e, n, t, s, i, r, c) {
    const d = _n(i);
    for (const [l, T] of this.extraHeaders)
      d.set(l, T);
...
var Vf = async (a, e, n) => {
  const t = { ...n }, s = await Rn(a, t), i = P(
    Ki,
    s
  );
  try {
    return (await i.optionalWebRTCConfig({}, e)).config ?? new na();
  } catch (r) {
    if (r instanceof C && r.code === O.Unimplemented)
      return new na();
    throw r;
  }
};
var Wf = async (a, e, n) => {
  ...
  try {
    (n == null ? void 0 : n.dialTimeout) !== void 0 && setTimeout(() => {
      l || S.terminate(new Error("timed out"));
    }, n.dialTimeout);
    const R = await S.doExchange();
    return (n == null ? void 0 : n.externalAuthAddress) !== void 0 && n.externalAuthAddress !== "" || ((_a = n == null ? void 0 : n.credentials) == null ? void 0 : _a.type), l = true, {
      transport: R,
      peerConnection: c,
      dataChannel: d
    };
...
var jf = async (a, e, n) => {
  ...
  ), r.rtcConfig === void 0 ? r.rtcConfig = { iceServers: s } : r.rtcConfig.iceServers = [
...
var Hf = (a, e) => {
  var _a, _b, _c2, _d2;
  let n = e;
  return n = { ...e }, e.accessToken === void 0 && (En(n.credentials) && !n.credentials.authEntity && (n.credentials.authEntity = n.externalAuthAddress !== void 0 && n.externalAuthAddress !== "" ? n.externalAuthAddress.replace(Fa, "") : a.replace(Fa, "")), n.credentials = (_a = e.webrtcOptions) == null ? void 0 : _a.signalingCredentials, n.accessToken = (_b = e.webrtcOptions) == null ? void 0 : _b.signalingAccessToken), n.externalAuthAddress = (_c2 = e.webrtcOptions) == null ? void 0 : _c2.signalingExternalAuthAddress, n.externalAuthToEntity = (_d2 = e.webrtcOptions) == null ? void 0 : _d2.signalingExternalAuthToEntity, n;
};
var tr = (a) => {
  var _a;
  if (a) {
    ...
    if (((_a = a.webrtcOptions) == null ? void 0 : _a.signalingAccessToken) !== void 0 && a.webrtcOptions.signalingAccessToken.length > 0 && a.webrtcOptions.signalingCredentials !== void 0)
      throw new Error(
...
var mr = o.makeMessageType(
  "viam.common.v1.RectangularPrism",
  () => [
    { no: 1, name: "dims_mm", kind: "message", T: qe }
  ]
);
var Ve = o.makeMessageType(
  "viam.common.v1.Geometry",
  () => [
    { no: 1, name: "center", kind: "message", T: Ue },
    { no: 2, name: "sphere", kind: "message", T: ir, oneof: "geometry_type" },
    { no: 3, name: "box", kind: "message", T: mr, oneof: "geometry_type" },
    { no: 5, name: "capsule", kind: "message", T: rr, oneof: "geometry_type" },
    {
      no: 4,
      name: "label",
      kind: "scalar",
...
var st = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "geometries", kind: "message", T: Ve, repeated: true }
  ]
);
var ot = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "geometries", kind: "message", T: st }
  ]
);
var Je = o.makeMessageType(
...
var ta = o.makeMessageType(
  "viam.common.v1.GeoGeometry",
  () => [
    { no: 1, name: "location", kind: "message", T: Je },
    { no: 2, name: "geometries", kind: "message", T: Ve, repeated: true }
  ]
);
var tn = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "pose_in_observer_frame", kind: "message", T: an },
    { no: 3, name: "physical_object", kind: "message", T: Ve, opt: true }
  ]
);
var cr = o.makeMessageType(
  "viam.common.v1.WorldState",
  () => [
    { no: 1, name: "obstacles", kind: "message", T: st, repeated: true },
    { no: 3, name: "transforms", kind: "message", T: tn, repeated: true }
  ]
);
var Xf = o.makeMessageType(
...
var A = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "command", kind: "message", T: u }
  ]
);
var U = o.makeMessageType(
  "viam.common.v1.DoCommandResponse",
  () => [
    { no: 1, name: "result", kind: "message", T: u }
  ]
);
var dr = o.makeMessageType(
  ...
  () => [
    ...
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var ur = o.makeMessageType(
  "viam.common.v1.GetKinematicsResponse",
  () => [
    { no: 1, name: "format", kind: "enum", T: o.getEnumType(sr) },
    {
      no: 2,
...
var K = o.makeMessageType(
  "viam.common.v1.GetGeometriesResponse",
  () => [
    { no: 1, name: "geometries", kind: "message", T: Ve, repeated: true }
  ]
);
var We = o.makeMessageType(
...
var wn = o.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "caller", kind: "message", T: u },
    {
      no: 7,
      name: "stack",
      kind: "scalar",
    ...
    { no: 8, name: "fields", kind: "message", T: u, repeated: true }
  ]
);
var Qf = o.makeExtension(
  "viam.common.v1.safety_heartbeat_monitored",
  re,
  { no: 84260, kind: "scalar", T: 8, opt: true }
);
var pr = Object.freeze(Object.defineProperty({
  __proto__: null,
  ActuatorStatus: Xf,
  Capsule: rr,
  DoCommandRequest: A,
  ...
  GeoGeometry: ta,
  GeoPoint: Je,
  GeometriesInFrame: st,
  Geometry: Ve,
  GetGeometriesRequest: H,
  GetGeometriesResponse: K,
  GetKinematicsRequest: dr,
  GetKinematicsResponse: ur,
  GetReadingsRequest: We,
  GetReadingsResponse: la,
  KinematicsFileFormat: sr,
  LogEntry: wn,
  Orientation: or,
  PointCloudObject: ot,
  Pose: Ue,
  ...
  Vector3: qe,
  WorldState: cr,
  safety_heartbeat_monitored: Qf
}, Symbol.toStringTag, { value: "Module" }));
var Ja = new Headers({
  "viam-client": `typescript;v0.35.2;${Kf}`
});
var G = async function(e, n, t, s = {}, i = {}) {
  var _a, _b;
  const r = new A({
    name: n,
    command: t
  });
  (_a = s.requestLogger) == null ? void 0 : _a.call(s, r);
  const d = (_b = (await e(r, i)).result) == null ? void 0 : _b.toJson();
  return d === void 0 ? {} : d;
};
var _R = (a, e) => {
  const n = e ?? { headers: {} };
...
var En = (a) => a !== void 0 && "authEntity" in a;
var Zf = async (a, e) => e.type === "access-token" ? Rn(a, {
...
var it = 5e3;
var ae = ((a) => (a.CONNECTING = "connecting", a.CONNECTED = "connected", a.DISCONNECTING = "disconnecting", a.DISCONNECTED = "disconnected", a))(ae || {});
var gr = class {
  constructor() {
  ...
  on(e, n) {
    ...
    t[e] ?? (t[e] = /* @__PURE__ */ new Set()), (_a = t[e]) == null ? void 0 : _a.add(n);
  }
  once(e, n) {
    const t = (s) => {
      n(s), this.off(e, n);
  ...
  has(e, n) {
    var _a;
    return (_a = this.listeners[e]) == null ? void 0 : _a.has(n);
  }
  off(e, n) {
    var _a;
    (_a = this.listeners[e]) == null ? void 0 : _a.delete(n);
  }
  emit(e, n) {
...
var kr = o.makeMessageType(
  "viam.component.arm.v1.GetJointPositionsResponse",
  () => [
    { no: 1, name: "positions", kind: "message", T: sn }
  ]
);
var ct = o.makeMessageType(
...
var yr = o.makeMessageType(
  "viam.component.arm.v1.MoveToPositionResponse",
  []
);
var lt = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "positions", kind: "message", T: sn },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var hr = o.makeMessageType(
  "viam.component.arm.v1.MoveToJointPositionsResponse",
  []
);
var fr = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "positions", kind: "message", T: sn, repeated: true },
    { no: 3, name: "options", kind: "message", T: Sr, opt: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var vr = o.makeMessageType(
  "viam.component.arm.v1.MoveThroughJointPositionsResponse",
  []
);
var dt = o.makeMessageType(
...
var nv = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetEndPositionRequest: rt,
  GetEndPositionResponse: Tr,
  GetJointPositionsRequest: mt,
  GetJointPositionsResponse: kr,
  IsMovingRequest: ut,
  IsMovingResponse: _r,
  JointPositions: sn,
  MoveOptions: Sr,
  MoveThroughJointPositionsRequest: fr,
  MoveThroughJointPositionsResponse: vr,
  MoveToJointPositionsRequest: lt,
  MoveToJointPositionsResponse: hr,
  MoveToPositionRequest: ct,
  MoveToPositionResponse: yr,
  Status: ev,
  StopRequest: dt,
  StopResponse: Rr
}, Symbol.toStringTag, { value: "Module" }));
...
var br = o.makeMessageType(
  "viam.component.base.v1.MoveStraightResponse",
  []
);
var gt = o.makeMessageType(
...
var av = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetPropertiesRequest: da,
  GetPropertiesResponse: Nr,
  IsMovingRequest: ht,
  IsMovingResponse: Cr,
  MoveStraightRequest: pt,
  MoveStraightResponse: br,
  SetPowerRequest: kt,
  SetPowerResponse: Or,
  SetVelocityRequest: yt,
  SetVelocityResponse: Mr,
  SpinRequest: gt,
  SpinResponse: wr,
  StopRequest: Tt,
  StopResponse: Er
...
var Ar = o.makeMessageType(
  "viam.component.board.v1.SetGPIOResponse",
  []
);
var vt = o.makeMessageType(
...
var Mt = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "power_mode", kind: "enum", T: o.getEnumType(Dr) },
    { no: 3, name: "duration", kind: "message", T: $, opt: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var Yr = o.makeMessageType(
...
var sv = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetDigitalInterruptValueRequest: Et,
  GetDigitalInterruptValueResponse: Jr,
  GetGPIORequest: vt,
  GetGPIOResponse: qr,
  PWMFrequencyRequest: St,
  PWMFrequencyResponse: Lr,
  PWMRequest: Rt,
  PWMResponse: Ur,
  PowerMode: Dr,
  ReadAnalogReaderRequest: bt,
  ReadAnalogReaderResponse: xr,
  SetGPIORequest: ft,
  SetGPIOResponse: Ar,
  SetPWMFrequencyRequest: It,
  SetPWMFrequencyResponse: Br,
  SetPWMRequest: _t,
  SetPWMResponse: Gr,
  SetPowerModeRequest: Mt,
  SetPowerModeResponse: Yr,
  Status: tv,
  StreamTicksRequest: Ot,
  StreamTicksResponse: zr,
  WriteAnalogRequest: wt,
  WriteAnalogResponse: Fr
}, Symbol.toStringTag, { value: "Module" }));
var $r = {
...
var Nt = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "position_type", kind: "enum", T: o.getEnumType(Ct), opt: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var Vr = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "position_type", kind: "enum", T: o.getEnumType(Ct) }
  ]
);
var Pt = o.makeMessageType(
...
var ov = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetPositionRequest: Nt,
  GetPositionResponse: Vr,
  GetPropertiesRequest: Dt,
  GetPropertiesResponse: jr,
  PositionType: Ct,
  ResetPositionRequest: Pt,
  ResetPositionResponse: Wr
}, Symbol.toStringTag, { value: "Module" }));
var Hr = {
...
var em = o.makeMessageType(
  "viam.component.gantry.v1.StopResponse",
  []
);
var iv = o.makeMessageType(
  "viam.component.gantry.v1.Status",
  () => [
    { no: 1, name: "positions_mm", kind: "scalar", T: 1, repeated: true },
    { no: 2, name: "lengths_mm", kind: "scalar", T: 1, repeated: true },
    {
      no: 3,
      name: "is_moving",
      kind: "scalar",
...
var wR = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetLengthsRequest: Gt,
  GetLengthsResponse: Zr,
  GetPositionRequest: At,
  GetPositionResponse: Kr,
  HomeRequest: Ut,
  HomeResponse: Qr,
  IsMovingRequest: Bt,
  IsMovingResponse: nm,
  MoveToPositionRequest: qt,
  MoveToPositionResponse: Xr,
  Status: iv,
  StopRequest: Lt,
  StopResponse: em
}, Symbol.toStringTag, { value: "Module" }));
...
var tm = o.makeMessageType(
  "viam.component.gripper.v1.OpenResponse",
  []
);
var Jt = o.makeMessageType(
...
var lm = o.makeMessageType(
  "viam.component.inputcontroller.v1.GetEventsResponse",
  () => [
    { no: 1, name: "events", kind: "message", T: On, repeated: true }
  ]
);
var Vt = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "event", kind: "message", T: On },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var dm = o.makeMessageType(
  "viam.component.inputcontroller.v1.TriggerEventResponse",
  []
);
var On = o.makeMessageType(
...
var um = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "events", kind: "message", T: pm, repeated: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var pm = o.makeMessageType(
...
var gm = o.makeMessageType(
  "viam.component.inputcontroller.v1.StreamEventsResponse",
  () => [
    { no: 1, name: "event", kind: "message", T: On }
  ]
);
var rv = o.makeMessageType(
  "viam.component.inputcontroller.v1.Status",
  () => [
    { no: 1, name: "events", kind: "message", T: On, repeated: true }
  ]
);
var mv = Object.freeze(Object.defineProperty({
  __proto__: null,
  Event: On,
  GetControlsRequest: mm,
  GetControlsResponse: cm,
  GetEventsRequest: $t,
  GetEventsResponse: lm,
  Status: rv,
  StreamEventsRequest: um,
  StreamEventsRequest_Events: pm,
  StreamEventsResponse: gm,
  TriggerEventRequest: Vt,
  TriggerEventResponse: dm
}, Symbol.toStringTag, { value: "Module" }));
var Tm = {
...
var fm = o.makeMessageType(
  "viam.component.motor.v1.SetRPMResponse",
  []
);
var Xt = o.makeMessageType(
...
var _m = o.makeMessageType(
  "viam.component.motor.v1.StopResponse",
  []
);
var es = o.makeMessageType(
...
var MR = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetPositionRequest: Qt,
  GetPositionResponse: Rm,
  GetPropertiesRequest: ns,
  GetPropertiesResponse: Im,
  GoForRequest: jt,
  GoForResponse: ym,
  GoToRequest: Ht,
  GoToResponse: hm,
  ...
  IsMovingResponse: bm,
  IsPoweredRequest: es,
  IsPoweredResponse: Sm,
  ResetZeroPositionRequest: Xt,
  ResetZeroPositionResponse: vm,
  SetPowerRequest: Wt,
  SetPowerResponse: km,
  SetRPMRequest: Kt,
  SetRPMResponse: fm,
...
var Cm = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "orientation", kind: "message", T: or }
  ]
);
var rs = o.makeMessageType(
...
var Nm = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "coordinate", kind: "message", T: Je },
    {
      no: 2,
      name: "altitude_m",
      kind: "scalar",
...
var Am = o.makeMessageType(
  "viam.component.movementsensor.v1.GetLinearAccelerationResponse",
  () => [
    { no: 1, name: "linear_acceleration", kind: "message", T: qe }
  ]
);
var lv = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetAccuracyRequest: cs,
  GetAccuracyResponse: Dm,
  GetAngularVelocityRequest: ss,
  GetAngularVelocityResponse: Om,
  GetCompassHeadingRequest: os,
  GetCompassHeadingResponse: Mm,
  GetLinearAccelerationRequest: ls,
  GetLinearAccelerationResponse: Am,
  GetLinearVelocityRequest: ts,
  GetLinearVelocityResponse: Em,
  GetOrientationRequest: is,
  GetOrientationResponse: Cm,
  GetPositionRequest: rs,
  GetPositionResponse: Nm,
  GetPropertiesRequest: ms,
  GetPropertiesResponse: Pm
}, Symbol.toStringTag, { value: "Module" }));
var qm = {
...
var CR = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetCurrentRequest: us,
  GetCurrentResponse: Gm,
  GetPowerRequest: ps,
  GetPowerResponse: Lm,
  GetVoltageRequest: ds,
  GetVoltageResponse: Um
}, Symbol.toStringTag, { value: "Module" }));
var Bm = {
...
var Jm = o.makeMessageType(
  "viam.component.servo.v1.StopResponse",
  []
);
var dv = o.makeMessageType(
...
var NR = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetPositionRequest: Ts,
  GetPositionResponse: Fm,
  IsMovingRequest: ys,
  IsMovingResponse: zm,
  MoveRequest: gs,
  MoveResponse: xm,
...
var jm = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "frame", kind: "message", T: tn },
    { no: 2, name: "kinematics", kind: "message", T: u }
  ]
);
var Hm = o.makeMessageType(
  "viam.robot.v1.FrameSystemConfigRequest",
  () => [
    { no: 1, name: "supplemental_transforms", kind: "message", T: tn, repeated: true }
  ]
);
var Km = o.makeMessageType(
  "viam.robot.v1.FrameSystemConfigResponse",
  () => [
    { no: 1, name: "frame_system_configs", kind: "message", T: jm, repeated: true }
  ]
);
var hs = o.makeMessageType(
  "viam.robot.v1.TransformPoseRequest",
  () => [
    { no: 1, name: "source", kind: "message", T: an },
    {
      no: 2,
      name: "destination",
      kind: "scalar",
    ...
    { no: 3, name: "supplemental_transforms", kind: "message", T: tn, repeated: true }
  ]
);
var Xm = o.makeMessageType(
  "viam.robot.v1.TransformPoseResponse",
  () => [
    { no: 1, name: "pose", kind: "message", T: an }
  ]
);
var fs = o.makeMessageType(
...
var ac = o.makeMessageType(
  "viam.robot.v1.ResourceRPCSubtypesRequest",
  []
);
var tc = o.makeMessageType(
  "viam.robot.v1.ResourceRPCSubtypesResponse",
  () => [
    { no: 1, name: "resource_rpc_subtypes", kind: "message", T: nc, repeated: true }
  ]
);
var sc = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "arguments", kind: "message", T: u },
    { no: 4, name: "started", kind: "message", T: _ },
    { no: 5, name: "session_id", kind: "scalar", T: 9, opt: true }
  ]
);
var oc = o.makeMessageType(
  "viam.robot.v1.GetOperationsRequest",
  []
);
var ic = o.makeMessageType(
  "viam.robot.v1.GetOperationsResponse",
  () => [
    { no: 1, name: "operations", kind: "message", T: sc, repeated: true }
  ]
);
var rc = o.makeMessageType(
...
var mc = o.makeMessageType(
  "viam.robot.v1.CancelOperationResponse",
  []
);
var cc = o.makeMessageType(
...
var uc = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "peer_connection_info", kind: "message", T: dc, opt: true }
  ]
);
var pc = o.makeMessageType(
  "viam.robot.v1.GetSessionsRequest",
  []
);
var gc = o.makeMessageType(
  "viam.robot.v1.GetSessionsResponse",
  () => [
    { no: 1, name: "sessions", kind: "message", T: uc, repeated: true }
  ]
);
var vs = o.makeMessageType(
...
var Tc = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "query", kind: "message", T: vs },
    { no: 2, name: "results", kind: "message", T: u }
  ]
);
var kc = o.makeMessageType(
...
var yc = o.makeMessageType(
  "viam.robot.v1.GetModelsFromModulesResponse",
  () => [
    { no: 1, name: "models", kind: "message", T: kc, repeated: true }
  ]
);
var hc = o.makeMessageType(
  "viam.robot.v1.DiscoverComponentsRequest",
  () => [
    { no: 1, name: "queries", kind: "message", T: vs, repeated: true }
  ]
);
var fc = o.makeMessageType(
  "viam.robot.v1.DiscoverComponentsResponse",
  () => [
    { no: 1, name: "discovery", kind: "message", T: Tc, repeated: true }
  ]
);
var _s = o.makeMessageType(
  "viam.robot.v1.Status",
  () => [
    { no: 1, name: "name", kind: "message", T: x },
    { no: 2, name: "status", kind: "message", T: u },
    { no: 3, name: "last_reconfigured", kind: "message", T: _ }
  ]
);
var vc = o.makeMessageType(
...
var Rc = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "status", kind: "message", T: _s, repeated: true }
  ]
);
var _c = o.makeMessageType(
  "viam.robot.v1.StreamStatusRequest",
  () => [
    { no: 1, name: "resource_names", kind: "message", T: x, repeated: true },
    { no: 2, name: "every", kind: "message", T: $ }
  ]
);
var Sc = o.makeMessageType(
...
var Ic = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "name", kind: "message", T: x },
    { no: 2, name: "params", kind: "message", T: u }
  ]
);
var bc = o.makeMessageType(
  "viam.robot.v1.StopAllRequest",
  () => [
    { no: 99, name: "extra", kind: "message", T: Ic, repeated: true }
  ]
);
var wc = o.makeMessageType(
...
var Ec = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "heartbeat_window", kind: "message", T: $ }
  ]
);
var Is = o.makeMessageType(
...
var Mc = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "logs", kind: "message", T: wn, repeated: true }
  ]
);
var Cc = o.makeMessageType(
...
var Uc = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "resources", kind: "message", T: Lc, repeated: true },
    { no: 2, name: "config", kind: "message", T: xc },
    { no: 3, name: "state", kind: "enum", T: o.getEnumType(Gc) }
  ]
);
var Gc = o.makeEnum(
...
var Lc = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "name", kind: "message", T: x },
    { no: 2, name: "state", kind: "enum", T: o.getEnumType(Bc) },
    ...
    { no: 6, name: "cloud_metadata", kind: "message", T: bs, opt: true }
  ]
);
var Bc = o.makeEnum(
...
var PR = Object.freeze(Object.defineProperty({
  ...
  BlockForOperationResponse: lc,
  CancelOperationRequest: rc,
  CancelOperationResponse: mc,
  ConfigStatus: xc,
  DiscoverComponentsRequest: hc,
  DiscoverComponentsResponse: fc,
  Discovery: Tc,
  DiscoveryQuery: vs,
  FrameSystemConfig: jm,
  FrameSystemConfigRequest: Hm,
  FrameSystemConfigResponse: Km,
  GetCloudMetadataRequest: Nc,
  GetCloudMetadataResponse: bs,
  GetMachineStatusRequest: qc,
  GetMachineStatusResponse: Uc,
  GetMachineStatusResponse_State: Gc,
  GetModelsFromModulesRequest: Rs,
  GetModelsFromModulesResponse: yc,
  GetOperationsRequest: oc,
  GetOperationsResponse: ic,
  GetSessionsRequest: pc,
  GetSessionsResponse: gc,
  GetStatusRequest: vc,
  GetStatusResponse: Rc,
  GetVersionRequest: Fc,
  GetVersionResponse: Jc,
  LogRequest: Mc,
  LogResponse: Cc,
  ModuleModel: kc,
  Operation: sc,
  PeerConnectionInfo: dc,
  PeerConnectionType: $m,
  ResourceNamesRequest: Zm,
  ResourceNamesResponse: ec,
  ResourceRPCSubtype: nc,
  ResourceRPCSubtypesRequest: ac,
  ResourceRPCSubtypesResponse: tc,
  ResourceStatus: Lc,
  ResourceStatus_State: Bc,
  RestartModuleRequest: ws,
  RestartModuleResponse: Pc,
  SendSessionHeartbeatRequest: Is,
  SendSessionHeartbeatResponse: Oc,
  Session: uc,
  ShutdownRequest: Dc,
  ShutdownResponse: Ac,
  StartSessionRequest: Ss,
  StartSessionResponse: Ec,
  Status: _s,
  StopAllRequest: bc,
  StopAllResponse: wc,
  StopExtraParameters: Ic,
  StreamStatusRequest: _c,
  StreamStatusResponse: Sc,
  TransformPCDRequest: fs,
  TransformPCDResponse: Qm,
  TransformPoseRequest: hs,
  TransformPoseResponse: Xm,
  TunnelRequest: Vm,
  TunnelResponse: Wm
}, Symbol.toStringTag, { value: "Module" }));
var Es = {
...
var zc = o.makeMessageType(
  "viam.app.v1.RobotConfig",
  () => [
    { no: 1, name: "cloud", kind: "message", T: Vc },
    { no: 2, name: "remotes", kind: "message", T: cl, repeated: true },
    { no: 3, name: "components", kind: "message", T: Ms, repeated: true },
    { no: 4, name: "processes", kind: "message", T: Wc, repeated: true },
    { no: 5, name: "services", kind: "message", T: jc, repeated: true },
    { no: 6, name: "network", kind: "message", T: Hc, opt: true },
    { no: 7, name: "auth", kind: "message", T: Xc, opt: true },
    { no: 8, name: "debug", kind: "scalar", T: 8, opt: true },
    { no: 9, name: "modules", kind: "message", T: pl, repeated: true },
    { no: 10, name: "disable_partial_start", kind: "scalar", T: 8, opt: true },
    { no: 11, name: "packages", kind: "message", T: gl, repeated: true },
    { no: 12, name: "overwrite_fragment_status", kind: "message", T: ua, repeated: true },
    {
      no: 13,
    ...
    { no: 14, name: "log", kind: "message", T: Yc, repeated: true },
    {
      no: 15,
      name: "revision",
      kind: "scalar",
    ...
    { no: 16, name: "maintenance", kind: "message", T: Tl, opt: true },
    {
      no: 17,
...
var Vc = o.makeMessageType(
  ...
  () => [
    ...
    { no: 9, name: "location_secrets", kind: "message", T: $c, repeated: true },
    {
      no: 10,
      name: "primary_org_id",
      kind: "scalar",
...
var Ms = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "frame", kind: "message", T: Cs },
    { no: 6, name: "depends_on", kind: "scalar", T: 9, repeated: true },
    { no: 7, name: "service_configs", kind: "message", T: pa, repeated: true },
    { no: 8, name: "attributes", kind: "message", T: u },
    {
      no: 9,
      name: "api",
      kind: "scalar",
    ...
    { no: 10, name: "log_configuration", kind: "message", T: Ns }
  ]
);
var pa = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "attributes", kind: "message", T: u }
  ]
);
var Wc = o.makeMessageType(
  ...
  () => [
    ...
    { no: 8, name: "stop_timeout", kind: "message", T: $ },
...
var jc = o.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "attributes", kind: "message", T: u },
    { no: 5, name: "depends_on", kind: "scalar", T: 9, repeated: true },
    {
      no: 6,
      name: "model",
      kind: "scalar",
    ...
    { no: 10, name: "service_configs", kind: "message", T: pa, repeated: true },
    { no: 11, name: "log_configuration", kind: "message", T: Ns }
  ]
);
var Hc = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "sessions", kind: "message", T: Kc }
  ]
);
var Kc = o.makeMessageType(
  "viam.app.v1.SessionsConfig",
  () => [
    { no: 1, name: "heartbeat_window", kind: "message", T: $ }
  ]
);
var Xc = o.makeMessageType(
  "viam.app.v1.AuthConfig",
  () => [
    { no: 1, name: "handlers", kind: "message", T: el, repeated: true },
    { no: 2, name: "tls_auth_entities", kind: "scalar", T: 9, repeated: true },
    { no: 3, name: "external_auth_config", kind: "message", T: Zc, opt: true }
  ]
);
var Qc = o.makeMessageType(
  "viam.app.v1.JWKSFile",
  () => [
    { no: 1, name: "json", kind: "message", T: u }
  ]
);
var Zc = o.makeMessageType(
  "viam.app.v1.ExternalAuthConfig",
  () => [
    { no: 1, name: "jwks", kind: "message", T: Qc }
  ]
);
var el = o.makeMessageType(
  "viam.app.v1.AuthHandlerConfig",
  () => [
    { no: 1, name: "type", kind: "enum", T: o.getEnumType(Os) },
    { no: 5, name: "config", kind: "message", T: u }
  ]
);
var Cs = o.makeMessageType(
  "viam.app.v1.Frame",
  () => [
    ...
    { no: 2, name: "translation", kind: "message", T: nl },
    { no: 3, name: "orientation", kind: "message", T: al },
    { no: 4, name: "geometry", kind: "message", T: Ve }
  ]
);
var Ns = o.makeMessageType(
...
var al = o.makeMessageType(
  "viam.app.v1.Orientation",
  () => [
    { no: 1, name: "no_orientation", kind: "message", T: tl, oneof: "type" },
    { no: 2, name: "vector_radians", kind: "message", T: sl, oneof: "type" },
    { no: 3, name: "vector_degrees", kind: "message", T: ol, oneof: "type" },
    { no: 4, name: "euler_angles", kind: "message", T: il, oneof: "type" },
    { no: 5, name: "axis_angles", kind: "message", T: rl, oneof: "type" },
    { no: 6, name: "quaternion", kind: "message", T: ml, oneof: "type" }
  ]
);
var tl = o.makeMessageType(
  "viam.app.v1.Orientation.NoOrientation",
  [],
  { localName: "Orientation_NoOrientation" }
);
var sl = o.makeMessageType(
...
var cl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "frame", kind: "message", T: Cs },
    { no: 4, name: "auth", kind: "message", T: ll },
    {
      no: 5,
      name: "managed_by",
      kind: "scalar",
    ...
    { no: 7, name: "connection_check_interval", kind: "message", T: $ },
    { no: 8, name: "reconnect_interval", kind: "message", T: $ },
    { no: 9, name: "service_configs", kind: "message", T: pa, repeated: true },
    {
      no: 10,
      name: "secret",
      kind: "scalar",
...
var ul = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "ips", kind: "scalar", T: 9, repeated: true },
    {
      no: 4,
      name: "version",
      kind: "scalar",
    ...
    { no: 6, name: "platform", kind: "scalar", T: 9, opt: true },
    { no: 7, name: "platform_tags", kind: "scalar", T: 9, repeated: true }
  ]
);
var uv = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "agent_info", kind: "message", T: ul, opt: true }
  ]
);
var pv = o.makeMessageType(
  "viam.app.v1.ConfigResponse",
  () => [
    { no: 1, name: "config", kind: "message", T: zc }
  ]
);
var gv = o.makeMessageType(
...
var kv = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "logs", kind: "message", T: wn, repeated: true }
  ]
);
var yv = o.makeMessageType(
  "viam.app.v1.LogResponse",
  []
);
var hv = o.makeMessageType(
...
var fv = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "restart_check_interval", kind: "message", T: $ }
  ]
);
var pl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "status", kind: "message", T: ua },
    { no: 8, name: "first_run_timeout", kind: "message", T: $ }
  ]
);
var gl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "status", kind: "message", T: ua }
  ]
);
var Tl = o.makeMessageType(
...
var DR = Object.freeze(Object.defineProperty({
  __proto__: null,
  AgentInfo: ul,
  AppValidationStatus: ua,
  AuthConfig: Xc,
  AuthHandlerConfig: el,
  CertificateRequest: gv,
  CertificateResponse: Tv,
  CloudConfig: Vc,
  ComponentConfig: Ms,
  ConfigRequest: uv,
  ConfigResponse: pv,
  CredentialsType: Os,
  ExternalAuthConfig: Zc,
  Frame: Cs,
  JWKSFile: Qc,
  LocationSecret: $c,
  LogConfiguration: Ns,
  ...
  LogRequest: kv,
  LogResponse: yv,
  MaintenanceConfig: Tl,
  ModuleConfig: pl,
  NeedsRestartRequest: hv,
  NeedsRestartResponse: fv,
  NetworkConfig: Hc,
  Orientation: al,
  Orientation_AxisAngles: rl,
  Orientation_EulerAngles: il,
  Orientation_NoOrientation: tl,
  Orientation_OrientationVectorDegrees: ol,
  Orientation_OrientationVectorRadians: sl,
  Orientation_Quaternion: ml,
  PackageConfig: gl,
  ProcessConfig: Wc,
  RemoteAuth: ll,
  RemoteAuth_Credentials: dl,
  RemoteConfig: cl,
  ResourceLevelServiceConfig: pa,
  RobotConfig: zc,
  ServiceConfig: jc,
  SessionsConfig: Kc,
  Translation: nl
...
var kl = o.makeMessageType(
  "viam.service.discovery.v1.DiscoverResourcesResponse",
  () => [
    { no: 1, name: "discoveries", kind: "message", T: Ms, repeated: true }
  ]
);
var AR = Object.freeze(Object.defineProperty({
  __proto__: null,
  DiscoverResourcesRequest: Ps,
  DiscoverResourcesResponse: kl
}, Symbol.toStringTag, { value: "Module" }));
var yl = {
...
var Ds = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "destination", kind: "message", T: an },
    { no: 3, name: "component_name", kind: "message", T: x },
    { no: 4, name: "world_state", kind: "message", T: cr, opt: true },
    { no: 5, name: "constraints", kind: "message", T: El, opt: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var fl = o.makeMessageType(
...
var As = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "motion_configuration", kind: "message", T: qs, opt: true },
    { no: 6, name: "obstacles", kind: "message", T: Ve, repeated: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var vl = o.makeMessageType(
...
var qs = o.makeMessageType(
  "viam.service.motion.v1.MotionConfiguration",
  () => [
    { no: 1, name: "obstacle_detectors", kind: "message", T: Rl, repeated: true },
...
var Us = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "destination", kind: "message", T: Je },
    ...
    { no: 6, name: "obstacles", kind: "message", T: ta, repeated: true },
    { no: 7, name: "motion_configuration", kind: "message", T: qs, opt: true },
    { no: 8, name: "bounding_regions", kind: "message", T: ta, repeated: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var _l = o.makeMessageType(
...
var Gs = o.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "supplemental_transforms", kind: "message", T: tn, repeated: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var Sl = o.makeMessageType(
...
var bl = o.makeMessageType(
  "viam.service.motion.v1.ListPlanStatusesResponse",
  () => [
    { no: 1, name: "plan_statuses_with_ids", kind: "message", T: Pl, repeated: true }
  ]
);
var xs = o.makeMessageType(
...
var wl = o.makeMessageType(
  "viam.service.motion.v1.GetPlanResponse",
  () => [
    { no: 1, name: "current_plan_with_status", kind: "message", T: za },
    { no: 2, name: "replan_history", kind: "message", T: za, repeated: true }
  ]
);
var El = o.makeMessageType(
  "viam.service.motion.v1.Constraints",
  () => [
    { no: 1, name: "linear_constraint", kind: "message", T: Ol, repeated: true },
    { no: 2, name: "orientation_constraint", kind: "message", T: Ml, repeated: true },
    { no: 3, name: "collision_specification", kind: "message", T: Cl, repeated: true }
  ]
);
var Ol = o.makeMessageType(
...
var Cl = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "allows", kind: "message", T: Nl, repeated: true }
  ]
);
var Nl = o.makeMessageType(
...
var za = o.makeMessageType(
  "viam.service.motion.v1.PlanWithStatus",
  () => [
    { no: 1, name: "plan", kind: "message", T: Dl },
    { no: 2, name: "status", kind: "message", T: sa },
    { no: 3, name: "status_history", kind: "message", T: sa, repeated: true }
  ]
);
var Pl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "status", kind: "message", T: sa }
  ]
);
var sa = o.makeMessageType(
  "viam.service.motion.v1.PlanStatus",
  () => [
    { no: 1, name: "state", kind: "enum", T: o.getEnumType(hl) },
...
var Dl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "steps", kind: "message", T: Al, repeated: true }
  ]
);
var Al = o.makeMessageType(
  "viam.service.motion.v1.PlanStep",
  () => [
    { no: 1, name: "step", kind: "map", K: 9, V: { kind: "message", T: ql } }
  ]
);
var ql = o.makeMessageType(
  "viam.service.motion.v1.ComponentState",
  () => [
    { no: 1, name: "pose", kind: "message", T: Ue }
  ]
);
var vv = Object.freeze(Object.defineProperty({
  __proto__: null,
  CollisionSpecification: Cl,
  CollisionSpecification_AllowedFrameCollisions: Nl,
  ComponentState: ql,
  Constraints: El,
  GetPlanRequest: xs,
  GetPlanResponse: wl,
  ...
  GetPoseResponse: Sl,
  LinearConstraint: Ol,
  ListPlanStatusesRequest: Bs,
  ListPlanStatusesResponse: bl,
  MotionConfiguration: qs,
  MoveOnGlobeRequest: Us,
  MoveOnGlobeResponse: _l,
  MoveOnMapRequest: As,
  MoveOnMapResponse: vl,
  MoveRequest: Ds,
  MoveResponse: fl,
  ObstacleDetector: Rl,
  OrientationConstraint: Ml,
  Plan: Dl,
  PlanState: hl,
  PlanStatus: sa,
  PlanStatusWithID: Pl,
...
var Ll = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "mode", kind: "enum", T: o.getEnumType(Fs) }
  ]
);
var zs = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "mode", kind: "enum", T: o.getEnumType(Fs) },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var Bl = o.makeMessageType(
...
var xl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "location", kind: "message", T: Je }
  ]
);
var Ys = o.makeMessageType(
...
var Jl = o.makeMessageType(
  "viam.service.navigation.v1.GetWaypointsResponse",
  () => [
    { no: 1, name: "waypoints", kind: "message", T: xl, repeated: true }
  ]
);
var Vs = o.makeMessageType(
...
var $l = o.makeMessageType(
  "viam.service.navigation.v1.GetObstaclesResponse",
  () => [
    { no: 1, name: "obstacles", kind: "message", T: ta, repeated: true }
  ]
);
var Vl = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "geopoints", kind: "message", T: Je, repeated: true }
  ]
);
var Hs = o.makeMessageType(
...
var Wl = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "paths", kind: "message", T: Vl, repeated: true }
  ]
);
var Ks = o.makeMessageType(
...
var jl = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "map_type", kind: "enum", T: o.getEnumType(Gl) }
  ]
);
var Rv = Object.freeze(Object.defineProperty({
  __proto__: null,
  AddWaypointRequest: Vs,
  AddWaypointResponse: zl,
  GetLocationRequest: Ys,
  GetLocationResponse: Fl,
  GetModeRequest: Js,
  GetModeResponse: Ll,
  GetObstaclesRequest: js,
  GetObstaclesResponse: $l,
  GetPathsRequest: Hs,
  GetPathsResponse: Wl,
  GetPropertiesRequest: Ks,
  GetPropertiesResponse: jl,
  GetWaypointsRequest: $s,
  GetWaypointsResponse: Jl,
  MapType: Gl,
  Mode: Fs,
  Path: Vl,
  RemoveWaypointRequest: Ws,
  RemoveWaypointResponse: Yl,
  SetModeRequest: zs,
  SetModeResponse: Bl,
  Waypoint: xl
}, Symbol.toStringTag, { value: "Module" }));
...
var nd = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "mapping_mode", kind: "enum", T: o.getEnumType(Kl) },
    { no: 3, name: "internal_state_file_type", kind: "scalar", T: 9, opt: true },
    { no: 4, name: "sensor_info", kind: "message", T: ad, repeated: true }
  ]
);
var ad = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "type", kind: "enum", T: o.getEnumType(Xl) }
  ]
);
var _v = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetInternalStateRequest: Zs,
  GetInternalStateResponse: ed,
  GetPointCloudMapRequest: Qs,
  GetPointCloudMapResponse: Zl,
  GetPositionRequest: Xs,
  GetPositionResponse: Ql,
  GetPropertiesRequest: eo,
  GetPropertiesResponse: nd,
  MappingMode: Kl,
  SensorInfo: ad,
  SensorType: Xl
}, Symbol.toStringTag, { value: "Module" }));
...
var rd = o.makeMessageType(
  "viam.component.camera.v1.GetImagesResponse",
  () => [
    { no: 1, name: "images", kind: "message", T: ao, repeated: true },
    { no: 84260, name: "response_metadata", kind: "message", T: lr }
  ]
);
var ao = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "format", kind: "enum", T: o.getEnumType(sd) },
    {
      no: 3,
      name: "image",
      kind: "scalar",
...
var ld = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "intrinsic_parameters", kind: "message", T: pd },
    { no: 3, name: "distortion_parameters", kind: "message", T: gd },
    { no: 4, name: "mime_types", kind: "scalar", T: 9, repeated: true },
    { no: 5, name: "frame_rate", kind: "scalar", T: 2, opt: true }
  ]
);
var Sv = o.makeMessageType(
  "viam.component.camera.v1.Webcams",
  () => [
    { no: 1, name: "webcams", kind: "message", T: dd, repeated: true }
  ]
);
var dd = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "properties", kind: "message", T: ud, repeated: true },
    {
      no: 4,
      name: "name",
      kind: "scalar",
...
var qR = Object.freeze(Object.defineProperty({
  __proto__: null,
  DistortionParameters: gd,
  Format: sd,
  GetImageRequest: no,
  GetImageResponse: od,
  GetImagesRequest: id,
  GetImagesResponse: rd,
  GetPointCloudRequest: so,
  GetPointCloudResponse: md,
  GetPropertiesRequest: cd,
  GetPropertiesResponse: ld,
  Image: ao,
  IntrinsicParameters: pd,
  Property: ud,
  RenderFrameRequest: to,
  Webcam: dd,
  Webcams: Sv
}, Symbol.toStringTag, { value: "Module" }));
var oo = o.makeMessageType(
...
var Td = o.makeMessageType(
  "viam.service.vision.v1.GetDetectionsResponse",
  () => [
    { no: 1, name: "detections", kind: "message", T: ga, repeated: true }
  ]
);
var io = o.makeMessageType(
...
var yd = o.makeMessageType(
  "viam.service.vision.v1.GetClassificationsResponse",
  () => [
    { no: 1, name: "classifications", kind: "message", T: Ta, repeated: true }
  ]
);
var mo = o.makeMessageType(
...
var fd = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "objects", kind: "message", T: ot, repeated: true }
  ]
);
var lo = o.makeMessageType(
...
var vd = o.makeMessageType(
  "viam.service.vision.v1.CaptureAllFromCameraResponse",
  () => [
    { no: 1, name: "image", kind: "message", T: ao },
    { no: 2, name: "detections", kind: "message", T: ga, repeated: true },
    { no: 3, name: "classifications", kind: "message", T: Ta, repeated: true },
    { no: 4, name: "objects", kind: "message", T: ot, repeated: true },
    { no: 99, name: "extra", kind: "message", T: u }
  ]
);
var Rd = o.makeMessageType(
...
var Iv = Object.freeze(Object.defineProperty({
  __proto__: null,
  CaptureAllFromCameraRequest: uo,
  CaptureAllFromCameraResponse: vd,
  Classification: Ta,
  Detection: ga,
  GetClassificationsFromCameraRequest: mo,
  GetClassificationsFromCameraResponse: hd,
  GetClassificationsRequest: ro,
  GetClassificationsResponse: yd,
  GetDetectionsFromCameraRequest: io,
  GetDetectionsFromCameraResponse: kd,
  GetDetectionsRequest: oo,
  GetDetectionsResponse: Td,
  GetObjectPointCloudsRequest: co,
  GetObjectPointCloudsResponse: fd,
  GetPropertiesRequest: lo,
...
var wv = class {
  ...
  heartbeat() {
    ...
    if (globalThis.Worker !== void 0) {
      const t = window.URL.createObjectURL(bv);
...
var Ev = class {
  ...
  async getSessionMetadata() {
    try {
      ...
      throw e instanceof C && e.code === O.InvalidArgument && e.message === "SESSION_EXPIRED" && this.sessionManager.reset(), e;
    }
  }
  async unary(e, n, t, s, i, r, c) {
    const d = await this.getSessionMetadata(), l = _n(i);
    for (const [T, v] of d)
      l.set(T, v);
...
var Mv = class {
  constructor(e) {
    ...
    __publicField(this, "sessionsSupported");
    __publicField(this, "heartbeatIntervalMs");
    __publicField(this, "starting");
    // Note: maybe support non-worker for foreground presence.
    __publicField(this, "backgroundHeartbeat", true);
    this.deferredTransport = e, this.transport = new Ev(this.deferredTransport, this);
  }
  get client() {
    const e = this.deferredTransport();
    return Ha(Es, e);
  ...
  async heartbeat() {
    ...
    const n = async () => {
      ...
      try {
        ...
        if (s instanceof C && s.code === O.Unimplemented) {
          console.error("sessions unsupported; will not try again"), this.sessionsSupported = false;
          return;
        }
        if (s instanceof Ae || s instanceof C && s.rawMessage === "closed") {
          this.reset();
          return;
        }
      }
    ...
    if (this.backgroundHeartbeat && globalThis.Worker !== void 0) {
      const t = window.URL.createObjectURL(Ov);
      e = new Worker(t), URL.revokeObjectURL(t), e.addEventListener("message", () => {
        n().catch(console.error);
      });
    }
  ...
  async getSessionMetadata() {
    ...
    return this.sessionsSupported !== void 0 ? this.getSessionMetadataInner() : (this.starting = new Promise((e, n) => {
      (async () => {
        ...
        let s;
        try {
          s = await this.client.startSession(t);
        } catch (r) {
          if (r instanceof C && r.code === O.Unimplemented) {
            console.error("sessions unsupported; will not try again"), this.sessionsSupported = false;
            return;
        ...
        const { heartbeatWindow: i } = s;
        if (!i)
          throw new Error(
            "expected heartbeat window in response to start session"
          );
        this.sessionsSupported = true, this.currentSessionID = s.id, this.heartbeatIntervalMs = (Number(i.seconds) * 1e3 + i.nanos / 1e6) / 5, e(), this.heartbeat().catch(console.error);
      })().then(e).catch(n).finally(() => {
...
var _q = class _q extends gr {
  constructor(e, n, t, s) {
    super();
    __publicField(this, "serviceHost");
    __publicField(this, "webrtcOptions");
    __publicField(this, "directOptions");
    __publicField(this, "sessionOptions");
    __publicField(this, "gRPCConnectionManager");
    __publicField(this, "sessionManager");
    __publicField(this, "peerConn");
    __publicField(this, "transport");
    __publicField(this, "connecting");
    __publicField(this, "connectResolve");
    __publicField(this, "savedCreds");
    __publicField(this, "closed");
    __publicField(this, "robotServiceClient");
    __publicField(this, "armServiceClient");
    __publicField(this, "baseServiceClient");
    __publicField(this, "boardServiceClient");
    __publicField(this, "encoderServiceClient");
    __publicField(this, "gantryServiceClient");
    __publicField(this, "genericServiceClient");
    __publicField(this, "gripperServiceClient");
    __publicField(this, "movementSensorServiceClient");
    __publicField(this, "powerSensorServiceClient");
    __publicField(this, "inputControllerServiceClient");
    __publicField(this, "motorServiceClient");
    __publicField(this, "navigationServiceClient");
    __publicField(this, "discoveryServiceClient");
    __publicField(this, "motionServiceClient");
    __publicField(this, "visionServiceClient");
    __publicField(this, "servoServiceClient");
    __publicField(this, "slamServiceClient");
    this.serviceHost = e, this.webrtcOptions = n, this.directOptions = s, this.sessionOptions = t, this.gRPCConnectionManager = new wv(
      () => {
        if (!this.transport)
          throw new Error(_q.notConnectedYetStr);
        return this.transport;
      },
      () => {
        this.onDisconnect();
      }
    ), this.sessionManager = new Mv(() => {
      if (!this.transport)
        throw new Error(_q.notConnectedYetStr);
      return this.transport;
    });
  ...
  onDisconnect(e) {
    ...
    const n = {
      retry: (t, s) => (console.debug(
        `Failed to connect, attempt ${s} with backoff`,
        t
      ), true)
    };
    this.reconnectMaxWait !== void 0 && (n.maxDelay = this.reconnectMaxWait), this.reconnectMaxAttempts !== void 0 && (n.numOfAttempts = this.reconnectMaxAttempts), qa(async () => this.connect(), n).then(() => {
  ...
  get noReconnect() {
    var _a, _b;
    return ((_a = this.webrtcOptions) == null ? void 0 : _a.noReconnect) ?? ((_b = this.directOptions) == null ? void 0 : _b.noReconnect);
  }
  get reconnectMaxAttempts() {
    var _a, _b;
    return ((_a = this.webrtcOptions) == null ? void 0 : _a.reconnectMaxAttempts) ?? ((_b = this.directOptions) == null ? void 0 : _b.reconnectMaxAttempts);
  }
  get reconnectMaxWait() {
    var _a, _b;
    return ((_a = this.webrtcOptions) == null ? void 0 : _a.reconnectMaxWait) ?? ((_b = this.directOptions) == null ? void 0 : _b.reconnectMaxWait);
  }
  get sessionId() {
  ...
  createServiceClient(e) {
    var _a;
    const n = ((_a = this.sessionOptions) == null ? void 0 : _a.disabled) ? this.transport : this.sessionManager.transport;
    if (!n)
      throw new Error(_q.notConnectedYetStr);
    return P(e, n);
  }
  ...
  isConnected() {
    var _a;
    return ((_a = this.peerConn) == null ? void 0 : _a.iceConnectionState) === "connected";
  }
  ...
  async connect({
    ...
    this.connecting = new Promise((s) => {
      this.connectResolve = s;
    }), this.peerConn && (this.peerConn.close(), this.peerConn = void 0), this.sessionManager.reset();
    try {
      const s = {
        webrtcOptions: {
          disableTrickleICE: false,
          rtcConfig: (_a = this.webrtcOptions) == null ? void 0 : _a.rtcConfig
        },
        dialTimeout: t ?? it,
        extraHeaders: Ja
      };
      if (e && (En(e) ? s.credentials = e : s.accessToken = e.payload), n !== void 0 && s.webrtcOptions && (s.webrtcOptions.additionalSdpFields = { "x-priority": n }), this.savedCreds = e, (_b = this.webrtcOptions) == null ? void 0 : _b.enabled) {
        s.webrtcOptions && (s.webrtcOptions.signalingCredentials = s.credentials);
        const r = await Wf(
        ...
        this.peerConn = r.peerConnection, this.peerConn.addEventListener("iceconnectionstatechange", () => {
          var _a2, _b2;
          ((_a2 = this.peerConn) == null ? void 0 : _a2.iceConnectionState) === "connected" ? this.emit(ae.CONNECTED, {}) : ((_b2 = this.peerConn) == null ? void 0 : _b2.iceConnectionState) === "closed" && this.onDisconnect();
          ...
          const l = d.id.replaceAll("+", ":");
          Object.defineProperty(d, "id", {
            value: l
          }), this.emit("track", c);
        });
      } else
        this.transport = await Rn(this.serviceHost, s), await this.gRPCConnectionManager.start();
      const i = ((_c2 = this.sessionOptions) == null ? void 0 : _c2.disabled) ? this.transport : this.sessionManager.transport;
      this.robotServiceClient = P(
        Es,
        i
      ), this.armServiceClient = P(Ir, i), this.baseServiceClient = P(
        Pr,
        i
      ), this.boardServiceClient = P(
        $r,
        i
      ), this.encoderServiceClient = P(
        Hr,
        i
      ), this.gantryServiceClient = P(
        am,
        i
      ), this.genericServiceClient = P(
        xt,
        i
      ), this.gripperServiceClient = P(
        rm,
        i
      ), this.movementSensorServiceClient = P(
        qm,
        i
      ), this.powerSensorServiceClient = P(
        Bm,
        i
      ), this.inputControllerServiceClient = P(
        Tm,
        i
      ), this.motorServiceClient = P(
        wm,
        i
      ), this.navigationServiceClient = P(
        Hl,
        i
      ), this.motionServiceClient = P(
        Ul,
        i
      ), this.visionServiceClient = P(
        _d,
        i
      ), this.servoServiceClient = P(
        Ym,
        i
      ), this.slamServiceClient = P(
        td,
        i
      ), this.discoveryServiceClient = P(
        yl,
        i
      ), this.emit(ae.CONNECTED, {});
    } catch (s) {
      throw this.emit(ae.DISCONNECTED, {}), s;
    } finally {
      (_d2 = this.connectResolve) == null ? void 0 : _d2.call(this), this.connectResolve = void 0, this.connecting = void 0;
    }
  }
  // SESSIONS
  async getSessions() {
  ...
  async transformPose(e, n, t) {
    ...
    }), r = (await this.robotService.transformPose(s)).pose;
    if (!r)
...
__publicField(_q, "notConnectedYetStr", "not connected yet");
var q = _q;
var ui = (a) => !!(a > 0 && Number.isInteger(a));
var Cv = (a) => a.includes("local");
var pi = async (a) => {
  if (console.debug("dialing via gRPC..."), !Cv(a.host))
    throw new Error(
  ...
  const t = new q(a.host, void 0, n, e);
  return await t.connect({
    creds: a.credentials,
    dialTimeout: a.dialTimeout ?? it
  }), console.debug("connected via gRPC"), t;
};
var gi = async (a) => {
  console.debug("dialing via WebRTC...");
  const e = a.serviceHost ?? a.host, { signalingAddress: n } = a, s = { iceServers: a.iceServers ?? [] }, i = {
    enabled: true,
    host: a.host,
    signalingAddress: n,
    rtcConfig: s,
  ...
  const e = {
    retry: (n, t) => {
      ...
      return console.debug(
        ...
        n
      ), !((_a2 = a.reconnectAbortSignal) == null ? void 0 : _a2.abort);
    }
  };
  if (a.reconnectMaxWait !== void 0 && (e.maxDelay = a.reconnectMaxWait), a.reconnectMaxAttempts !== void 0 && (e.numOfAttempts = a.reconnectMaxAttempts), Nv(a) && !((_a = a.reconnectAbortSignal) == null ? void 0 : _a.abort))
    try {
      return a.noReconnect ? await gi(a) : await qa(async () => gi(a), e);
    } catch {
      console.debug("Failed to connect via WebRTC");
    }
  if (!((_b = a.reconnectAbortSignal) == null ? void 0 : _b.abort))
    try {
      return a.noReconnect ? await pi(a) : await qa(async () => pi(a), e);
    } catch {
...
var Dv = (a) => {
  if (a.credentials && En(a.credentials))
    try {
  ...
  if (a.reconnectMaxAttempts !== void 0 && !ui(a.reconnectMaxAttempts))
    throw new Error(
      `Value of max reconnect attempts (${a.reconnectMaxAttempts}) should be a positive integer`
    );
  if (a.reconnectMaxWait !== void 0 && !ui(a.reconnectMaxWait))
    throw new Error(
...
var Sd = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "model_type", kind: "enum", T: o.getEnumType(je) },
...
var Od = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "metadata", kind: "message", T: go }
  ]
);
var Md = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "status", kind: "enum", T: o.getEnumType(po) }
  ]
);
var Cd = o.makeMessageType(
  "viam.app.mltraining.v1.ListTrainingJobsResponse",
  () => [
    { no: 1, name: "jobs", kind: "message", T: go, repeated: true }
  ]
);
var go = o.makeMessageType(
  ...
  () => [
    ...
    { no: 15, name: "model_type", kind: "enum", T: o.getEnumType(je) },
    { no: 17, name: "model_framework", kind: "enum", T: o.getEnumType(on) },
    {
      no: 18,
      name: "is_custom_job",
      kind: "scalar",
    ...
    { no: 2, name: "status", kind: "enum", T: o.getEnumType(po) },
    { no: 8, name: "error_status", kind: "message", T: nn },
...
var Gd = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "logs", kind: "message", T: qd, repeated: true },
    {
      no: 2,
...
var UR = Object.freeze(Object.defineProperty({
  __proto__: null,
  CancelTrainingJobRequest: Nd,
  CancelTrainingJobResponse: Pd,
  DeleteCompletedTrainingJobRequest: Dd,
  DeleteCompletedTrainingJobResponse: Ad,
  GetTrainingJobLogsRequest: Ud,
  GetTrainingJobLogsResponse: Gd,
  GetTrainingJobRequest: Ed,
  GetTrainingJobResponse: Od,
  ListTrainingJobsRequest: Md,
  ListTrainingJobsResponse: Cd,
  ModelFramework: on,
  ModelType: je,
  SubmitCustomTrainingJobRequest: bd,
  SubmitCustomTrainingJobResponse: wd,
  SubmitTrainingJobRequest: Sd,
  SubmitTrainingJobResponse: Id,
  TrainingJobLogEntry: qd,
  TrainingJobMetadata: go,
  TrainingStatus: po
}, Symbol.toStringTag, { value: "Module" }));
var ka = o.makeEnum(
...
var mn = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "robot_config", kind: "message", T: u },
    { no: 6, name: "last_access", kind: "message", T: _ },
    { no: 7, name: "user_supplied_info", kind: "message", T: u },
    {
      no: 8,
      name: "main_part",
      kind: "scalar",
    ...
    { no: 14, name: "secrets", kind: "message", T: ko, repeated: true },
    { no: 15, name: "last_updated", kind: "message", T: _ }
  ]
);
var $d = o.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "old", kind: "message", T: mn },
    { no: 5, name: "edited_by", kind: "message", T: To }
  ]
);
var To = o.makeMessageType(
  "viam.app.v1.AuthenticatorInfo",
  () => [
    { no: 1, name: "type", kind: "enum", T: o.getEnumType(Ld) },
    {
      no: 2,
      name: "value",
      kind: "scalar",
...
var jd = o.makeMessageType(
  "viam.app.v1.ListOrganizationsResponse",
  () => [
    { no: 1, name: "organizations", kind: "message", T: Cn, repeated: true }
  ]
);
var Nn = o.makeMessageType(
...
var Kd = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "organization", kind: "message", T: Cn }
  ]
);
var Xd = o.makeMessageType(
...
var au = o.makeMessageType(
  "viam.app.v1.UpdateOrganizationResponse",
  () => [
    { no: 1, name: "organization", kind: "message", T: Cn }
  ]
);
var tu = o.makeMessageType(
...
var su = o.makeMessageType(
  "viam.app.v1.DeleteOrganizationResponse",
  []
);
var ou = o.makeMessageType(
...
var iu = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "members", kind: "message", T: Wd, repeated: true },
    { no: 3, name: "invites", kind: "message", T: Nn, repeated: true }
  ]
);
var ru = o.makeMessageType(
...
var mu = o.makeMessageType(
  "viam.app.v1.CreateOrganizationInviteResponse",
  () => [
    { no: 1, name: "invite", kind: "message", T: Nn }
  ]
);
var cu = o.makeMessageType(
...
var uu = o.makeMessageType(
  "viam.app.v1.DeleteOrganizationInviteResponse",
  []
);
var pu = o.makeMessageType(
...
var ku = o.makeMessageType(
  "viam.app.v1.DeleteOrganizationMemberResponse",
  []
);
var ha = o.makeMessageType(
...
var yu = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "billing_address", kind: "message", T: ha }
  ]
);
var hu = o.makeMessageType(
  "viam.app.v1.EnableBillingServiceResponse",
  []
);
var fu = o.makeMessageType(
...
var _u = o.makeMessageType(
  "viam.app.v1.GetBillingServiceConfigResponse",
  () => [
    { no: 1, name: "billing_address", kind: "message", T: ha },
    {
      no: 2,
      name: "support_email",
      kind: "scalar",
...
var fa = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "secrets", kind: "message", T: ko, repeated: true }
  ]
);
var Nu = o.makeMessageType(
...
var Pn = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "auth", kind: "message", T: fa },
    { no: 6, name: "organizations", kind: "message", T: Cu, repeated: true },
    { no: 3, name: "created_on", kind: "message", T: _ },
    {
      no: 7,
      name: "robot_count",
    ...
    { no: 8, name: "config", kind: "message", T: Nu }
  ]
);
var ko = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "created_on", kind: "message", T: _ },
    { no: 4, name: "state", kind: "enum", T: o.getEnumType(yo) }
  ]
);
var yo = o.makeEnum(
...
var Du = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "location", kind: "message", T: Pn }
  ]
);
var Au = o.makeMessageType(
...
var Fu = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "organization_identities", kind: "message", T: Mu, repeated: true }
  ]
);
var Ju = o.makeMessageType(
...
var Wu = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "locations", kind: "message", T: Pn, repeated: true }
  ]
);
var ju = o.makeMessageType(
...
var Hu = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "auth", kind: "message", T: fa }
  ]
);
var Ku = o.makeMessageType(
...
var tp = o.makeMessageType(
  "viam.app.v1.GetRoverRentalRobotsResponse",
  () => [
    { no: 1, name: "robots", kind: "message", T: ap, repeated: true }
  ]
);
var sp = o.makeMessageType(
  "viam.app.v1.GetRobotResponse",
  () => [
    { no: 1, name: "robot", kind: "message", T: ya }
  ]
);
var op = o.makeMessageType(
...
var ip = o.makeMessageType(
  "viam.app.v1.GetRobotPartsResponse",
  () => [
    { no: 1, name: "parts", kind: "message", T: mn, repeated: true }
  ]
);
var rp = o.makeMessageType(
...
var mp = o.makeMessageType(
  "viam.app.v1.GetRobotPartResponse",
  () => [
    { no: 1, name: "part", kind: "message", T: mn },
    {
      no: 2,
      name: "config_json",
      kind: "scalar",
...
var up = o.makeMessageType(
  "viam.app.v1.TailRobotPartLogsResponse",
  () => [
    { no: 1, name: "logs", kind: "message", T: wn, repeated: true }
  ]
);
var pp = o.makeMessageType(
...
var gp = o.makeMessageType(
  "viam.app.v1.GetRobotPartHistoryResponse",
  () => [
    { no: 1, name: "history", kind: "message", T: $d, repeated: true }
  ]
);
var Tp = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "robot_config", kind: "message", T: u }
  ]
);
var kp = o.makeMessageType(
  "viam.app.v1.UpdateRobotPartResponse",
  () => [
    { no: 1, name: "part", kind: "message", T: mn }
  ]
);
var yp = o.makeMessageType(
...
var _p = o.makeMessageType(
  "viam.app.v1.GetRobotAPIKeysResponse",
  () => [
    { no: 1, name: "api_keys", kind: "message", T: Io, repeated: true }
  ]
);
var Sp = o.makeMessageType(
...
var He = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "fragment", kind: "message", T: u },
    {
      no: 4,
    ...
    { no: 12, name: "visibility", kind: "enum", T: o.getEnumType(Mn) },
...
var Ip = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "old", kind: "message", T: He },
    { no: 4, name: "edited_by", kind: "message", T: To },
    {
      no: 5,
      name: "revision",
      kind: "scalar",
    ...
    { no: 6, name: "config", kind: "message", T: u }
  ]
);
var bp = o.makeMessageType(
...
var Ep = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "error_type", kind: "enum", T: o.getEnumType(Bd) },
    {
      no: 2,
      name: "fragment_id",
      kind: "scalar",
...
var Op = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "resolved_config", kind: "message", T: u },
    { no: 3, name: "error", kind: "message", T: Ep }
  ]
);
var Mp = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "fragment_visibility", kind: "enum", T: o.getEnumType(Mn), repeated: true }
  ]
);
var Cp = o.makeMessageType(
  "viam.app.v1.ListFragmentsResponse",
  () => [
    { no: 1, name: "fragments", kind: "message", T: He, repeated: true },
    { no: 2, name: "fragment_usages", kind: "message", T: ho, repeated: true }
  ]
);
var Np = o.makeMessageType(
...
var Pp = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "fragment", kind: "message", T: He },
    { no: 2, name: "fragment_usage", kind: "message", T: ho },
    { no: 3, name: "revisions", kind: "message", T: bp, repeated: true },
    { no: 4, name: "tags", kind: "message", T: wp, repeated: true }
  ]
);
var Dp = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "config", kind: "message", T: u },
    {
      no: 3,
      name: "organization_id",
      kind: "scalar",
    ...
    { no: 4, name: "visibility", kind: "enum", T: o.getEnumType(Mn), opt: true }
  ]
);
var Ap = o.makeMessageType(
...
var qp = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "config", kind: "message", T: u },
    { no: 4, name: "public", kind: "scalar", T: 8, opt: true },
    { no: 5, name: "visibility", kind: "enum", T: o.getEnumType(Mn), opt: true }
  ]
);
var Up = o.makeMessageType(
...
var xp = o.makeMessageType(
  "viam.app.v1.GetFragmentHistoryResponse",
  () => [
    { no: 1, name: "history", kind: "message", T: Ip, repeated: true },
    {
      no: 2,
      name: "next_page_token",
      kind: "scalar",
...
var zp = o.makeMessageType(
  "viam.app.v1.ListMachineFragmentsResponse",
  () => [
    { no: 1, name: "fragments", kind: "message", T: He, repeated: true },
    { no: 2, name: "resolved_fragments", kind: "message", T: Op, repeated: true }
  ]
);
var Yp = o.makeMessageType(
  "viam.app.v1.ListRobotsResponse",
  () => [
    { no: 1, name: "robots", kind: "message", T: ya, repeated: true }
  ]
);
var $p = o.makeMessageType(
...
var eg = o.makeMessageType(
  "viam.app.v1.MarkPartForRestartResponse",
  []
);
var ng = o.makeMessageType(
...
var ag = o.makeMessageType(
  "viam.app.v1.CreateRobotPartSecretResponse",
  () => [
    { no: 1, name: "part", kind: "message", T: mn }
  ]
);
var tg = o.makeMessageType(
...
var sg = o.makeMessageType(
  "viam.app.v1.DeleteRobotPartSecretResponse",
  []
);
var Q = o.makeMessageType(
...
var lg = o.makeMessageType(
  "viam.app.v1.ChangeRoleResponse",
  []
);
var dg = o.makeMessageType(
...
var gg = o.makeMessageType(
  "viam.app.v1.CheckPermissionsResponse",
  () => [
    { no: 1, name: "authorized_permissions", kind: "message", T: fo, repeated: true }
  ]
);
var Tg = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "files", kind: "message", T: _o, repeated: true },
    { no: 3, name: "models", kind: "message", T: Ke, repeated: true },
    {
      no: 4,
      name: "entrypoint",
      kind: "scalar",
...
var kg = o.makeMessageType(
  "viam.app.v1.ModuleMetadata",
  () => [
    { no: 1, name: "models", kind: "message", T: Ke, repeated: true },
    { no: 2, name: "versions", kind: "message", T: Tg, repeated: true },
    {
      no: 3,
      name: "entrypoint",
      kind: "scalar",
...
var yg = o.makeMessageType(
  "viam.app.v1.MLModelMetadata",
  () => [
    { no: 1, name: "versions", kind: "scalar", T: 9, repeated: true },
    { no: 2, name: "model_type", kind: "enum", T: o.getEnumType(je) },
    { no: 3, name: "model_framework", kind: "enum", T: o.getEnumType(on) }
  ]
);
var hg = o.makeMessageType(
...
var fg = o.makeMessageType(
  "viam.app.v1.MLTrainingMetadata",
  () => [
    { no: 5, name: "versions", kind: "message", T: hg, repeated: true },
    { no: 2, name: "model_type", kind: "enum", T: o.getEnumType(je) },
    { no: 3, name: "model_framework", kind: "enum", T: o.getEnumType(on) },
    {
      no: 4,
...
var vo = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "type", kind: "enum", T: o.getEnumType(ka) },
    { no: 6, name: "visibility", kind: "enum", T: o.getEnumType(rn) },
    {
      no: 7,
      name: "url",
      kind: "scalar",
    ...
    { no: 11, name: "module_metadata", kind: "message", T: kg, oneof: "metadata" },
    { no: 12, name: "ml_model_metadata", kind: "message", T: yg, oneof: "metadata" },
    { no: 18, name: "ml_training_metadata", kind: "message", T: fg, oneof: "metadata" },
    { no: 15, name: "created_at", kind: "message", T: _ },
    { no: 16, name: "updated_at", kind: "message", T: _ }
  ]
);
var vg = o.makeMessageType(
...
var Rg = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "item", kind: "message", T: vo }
  ]
);
var _g = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "type", kind: "enum", T: o.getEnumType(ka) }
  ]
);
var Sg = o.makeMessageType(
...
var Ig = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "type", kind: "enum", T: o.getEnumType(ka) },
    {
      no: 3,
      name: "description",
      kind: "scalar",
    ...
    { no: 4, name: "visibility", kind: "enum", T: o.getEnumType(rn) },
    { no: 5, name: "url", kind: "scalar", T: 9, opt: true },
    { no: 6, name: "module_update_metadata", kind: "message", T: Ug, oneof: "metadata" },
    { no: 7, name: "ml_model_update_metadata", kind: "message", T: Gg, oneof: "metadata" },
    { no: 8, name: "ml_training_update_metadata", kind: "message", T: Lg, oneof: "metadata" }
  ]
);
var bg = o.makeMessageType(
  "viam.app.v1.UpdateRegistryItemResponse",
  []
);
var wg = o.makeMessageType(
  "viam.app.v1.ListRegistryItemsRequest",
  () => [
    { no: 1, name: "organization_id", kind: "scalar", T: 9, opt: true },
    { no: 2, name: "types", kind: "enum", T: o.getEnumType(ka), repeated: true },
    { no: 3, name: "visibilities", kind: "enum", T: o.getEnumType(rn), repeated: true },
    { no: 4, name: "platforms", kind: "scalar", T: 9, repeated: true },
    { no: 5, name: "statuses", kind: "enum", T: o.getEnumType(xd), repeated: true },
...
var Eg = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "items", kind: "message", T: vo, repeated: true }
  ]
);
var Og = o.makeMessageType(
...
var Ag = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "visibility", kind: "enum", T: o.getEnumType(rn) },
    {
      no: 3,
      name: "url",
      kind: "scalar",
    ...
    { no: 5, name: "models", kind: "message", T: Ke, repeated: true },
    {
      no: 6,
      name: "entrypoint",
      kind: "scalar",
...
var Gg = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "model_type", kind: "enum", T: o.getEnumType(je) },
    { no: 2, name: "model_framework", kind: "enum", T: o.getEnumType(on) }
  ]
);
var Lg = o.makeMessageType(
...
var xg = o.makeMessageType(
  "viam.app.v1.UploadModuleFileRequest",
  () => [
    { no: 1, name: "module_file_info", kind: "message", T: Bg, oneof: "module_file" },
...
var zg = o.makeMessageType(
  "viam.app.v1.GetModuleResponse",
  () => [
    { no: 1, name: "module", kind: "message", T: Ro }
  ]
);
var Ro = o.makeMessageType(
  "viam.app.v1.Module",
  () => [
    ...
    { no: 3, name: "visibility", kind: "enum", T: o.getEnumType(rn) },
    { no: 4, name: "versions", kind: "message", T: Yg, repeated: true },
    {
      no: 5,
      name: "url",
      kind: "scalar",
    ...
    { no: 7, name: "models", kind: "message", T: Ke, repeated: true },
    {
      no: 8,
      name: "total_robot_usage",
      kind: "scalar",
...
var Vg = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "modules", kind: "message", T: Ro, repeated: true }
  ]
);
var Wg = o.makeMessageType(
...
var Kg = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "orgs", kind: "message", T: So, repeated: true }
  ]
);
var Xg = o.makeMessageType(
...
var Qg = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "organizations", kind: "message", T: So, repeated: true }
  ]
);
var Zg = o.makeMessageType(
...
var Io = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "api_key", kind: "message", T: Rp },
    { no: 2, name: "authorizations", kind: "message", T: oT, repeated: true }
  ]
);
var iT = o.makeMessageType(
...
var vT = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "oauth_config", kind: "message", T: va }
  ]
);
var RT = o.makeMessageType(
...
var IT = o.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "oauth_config", kind: "message", T: va }
  ]
);
var bT = o.makeMessageType(
...
var va = o.makeMessageType(
  "viam.app.v1.OAuthConfig",
  () => [
    { no: 1, name: "client_authentication", kind: "enum", T: o.getEnumType(Fd) },
    { no: 2, name: "pkce", kind: "enum", T: o.getEnumType(Jd) },
    { no: 3, name: "url_validation", kind: "enum", T: o.getEnumType(zd) },
    ...
    { no: 7, name: "enabled_grants", kind: "enum", T: o.getEnumType(Yd), repeated: true }
  ]
);
var GR = Object.freeze(Object.defineProperty({
  __proto__: null,
  APIKey: Rp,
  APIKeyWithAuthorizations: Io,
  AddRoleRequest: og,
  AddRoleResponse: ig,
  AuthenticationType: Ld,
  AuthenticatorInfo: To,
  Authorization: Q,
  AuthorizationDetails: oT,
  AuthorizedPermissions: fo,
  BillingAddress: ha,
  ChangeRoleRequest: cg,
  ChangeRoleResponse: lg,
  CheckPermissionsRequest: pg,
  CheckPermissionsResponse: gg,
  ClientAuthentication: Fd,
  CreateFragmentRequest: Dp,
  CreateFragmentResponse: Ap,
  CreateKeyFromExistingKeyAuthorizationsRequest: lT,
  CreateKeyFromExistingKeyAuthorizationsResponse: dT,
  CreateKeyRequest: Zg,
  CreateKeyResponse: eT,
  CreateLocationRequest: Pu,
  CreateLocationResponse: Du,
  CreateLocationSecretRequest: ju,
  CreateLocationSecretResponse: Hu,
  CreateModuleRequest: Pg,
  CreateModuleResponse: Dg,
  CreateOAuthAppRequest: vT,
  CreateOAuthAppResponse: RT,
  CreateOrganizationInviteRequest: ru,
  CreateOrganizationInviteResponse: mu,
  CreateOrganizationRequest: Hd,
  CreateOrganizationResponse: Kd,
  CreateRegistryItemRequest: _g,
  CreateRegistryItemResponse: Sg,
  CreateRobotPartSecretRequest: ng,
  CreateRobotPartSecretResponse: ag,
  DeleteFragmentRequest: Gp,
  DeleteFragmentResponse: Lp,
  DeleteKeyRequest: nT,
  DeleteKeyResponse: aT,
  DeleteLocationRequest: Lu,
  DeleteLocationResponse: Bu,
  DeleteLocationSecretRequest: Ku,
  DeleteLocationSecretResponse: Xu,
  DeleteOAuthAppRequest: wT,
  DeleteOAuthAppResponse: ET,
  DeleteOrganizationInviteRequest: du,
  DeleteOrganizationInviteResponse: uu,
  DeleteOrganizationMemberRequest: Tu,
  DeleteOrganizationMemberResponse: ku,
  DeleteOrganizationRequest: tu,
  DeleteOrganizationResponse: su,
  DeleteRegistryItemRequest: Og,
  DeleteRegistryItemResponse: Mg,
  DeleteRobotPartRequest: fp,
  DeleteRobotPartResponse: Sp,
  DeleteRobotPartSecretRequest: tg,
  DeleteRobotPartSecretResponse: sg,
  DeleteRobotRequest: Hp,
  DeleteRobotResponse: Kp,
  DisableAuthServiceRequest: hT,
  DisableAuthServiceResponse: fT,
  DisableBillingServiceRequest: Su,
  DisableBillingServiceResponse: Iu,
  EnableAuthServiceRequest: kT,
  EnableAuthServiceResponse: yT,
  EnableBillingServiceRequest: yu,
  EnableBillingServiceResponse: hu,
  EnabledGrant: Yd,
  Fragment: He,
  FragmentError: Ep,
  FragmentErrorType: Bd,
  FragmentHistoryEntry: Ip,
  FragmentRevision: bp,
  FragmentTag: wp,
  FragmentUsage: ho,
  FragmentVisibility: Mn,
  GetBillingServiceConfigRequest: Ru,
  GetBillingServiceConfigResponse: _u,
  GetFragmentHistoryRequest: Bp,
  GetFragmentHistoryResponse: xp,
  GetFragmentRequest: Np,
  GetFragmentResponse: Pp,
  GetLocationRequest: Au,
  GetLocationResponse: qu,
  GetModuleRequest: Jg,
  GetModuleResponse: zg,
  GetOrganizationNamespaceAvailabilityRequest: Zd,
  GetOrganizationNamespaceAvailabilityResponse: eu,
  GetOrganizationRequest: Xd,
  GetOrganizationResponse: Qd,
  GetOrganizationsWithAccessToLocationRequest: xu,
  GetOrganizationsWithAccessToLocationResponse: Fu,
  GetRegistryItemRequest: vg,
  GetRegistryItemResponse: Rg,
  GetRobotAPIKeysRequest: vp,
  GetRobotAPIKeysResponse: _p,
  GetRobotPartHistoryRequest: pp,
  GetRobotPartHistoryResponse: gp,
  GetRobotPartLogsRequest: cp,
  GetRobotPartLogsResponse: lp,
  GetRobotPartRequest: rp,
  GetRobotPartResponse: mp,
  GetRobotPartsRequest: op,
  GetRobotPartsResponse: ip,
  GetRobotRequest: ep,
  GetRobotResponse: sp,
  GetRoverRentalRobotsRequest: np,
  GetRoverRentalRobotsResponse: tp,
  GetUserIDByEmailRequest: Wg,
  GetUserIDByEmailResponse: jg,
  ListAuthorizationsRequest: dg,
  ListAuthorizationsResponse: ug,
  ListFragmentsRequest: Mp,
  ListFragmentsResponse: Cp,
  ListKeysRequest: iT,
  ListKeysResponse: rT,
  ListLocationsRequest: Ju,
  ListLocationsResponse: Wu,
  ListMachineFragmentsRequest: Jp,
  ListMachineFragmentsResponse: zp,
  ListModulesRequest: $g,
  ListModulesResponse: Vg,
  ListOAuthAppsRequest: OT,
  ListOAuthAppsResponse: MT,
  ListOrganizationMembersRequest: ou,
  ListOrganizationMembersResponse: iu,
  ListOrganizationsByUserRequest: Hg,
  ListOrganizationsByUserResponse: Kg,
  ListOrganizationsRequest: Vd,
  ListOrganizationsResponse: jd,
  ListRegistryItemsRequest: wg,
  ListRegistryItemsResponse: Eg,
  ListRobotsRequest: Fp,
  ListRobotsResponse: Yp,
  Location: Pn,
  LocationAuth: fa,
  LocationAuthRequest: Qu,
  LocationAuthResponse: Zu,
  LocationOrganization: Cu,
  MLModelMetadata: yg,
  MLTrainingMetadata: fg,
  MLTrainingVersion: hg,
  MarkPartAsMainRequest: Xp,
  MarkPartAsMainResponse: Qp,
  MarkPartForRestartRequest: Zp,
  MarkPartForRestartResponse: eg,
  Model: Ke,
  Module: Ro,
  ModuleFileInfo: Bg,
  ModuleMetadata: kg,
  ModuleVersion: Tg,
  NewRobotPartRequest: yp,
  NewRobotPartResponse: hp,
  NewRobotRequest: $p,
  NewRobotResponse: Vp,
  OAuthConfig: va,
  OrgDetails: So,
  Organization: Cn,
  OrganizationGetLogoRequest: gT,
  OrganizationGetLogoResponse: TT,
  OrganizationGetSupportEmailRequest: Eu,
  OrganizationGetSupportEmailResponse: Ou,
  OrganizationIdentity: Mu,
  OrganizationInvite: Nn,
  OrganizationMember: Wd,
  OrganizationSetLogoRequest: uT,
  OrganizationSetLogoResponse: pT,
  OrganizationSetSupportEmailRequest: bu,
  OrganizationSetSupportEmailResponse: wu,
  PKCE: Jd,
  ReadOAuthAppRequest: _T,
  ReadOAuthAppResponse: ST,
  RegistryItem: vo,
  RegistryItemStatus: xd,
  RemoveRoleRequest: rg,
  RemoveRoleResponse: mg,
  RenameKeyRequest: tT,
  RenameKeyResponse: sT,
  ResendOrganizationInviteRequest: pu,
  ResendOrganizationInviteResponse: gu,
  ResolvedFragment: Op,
  Robot: ya,
  RobotPart: mn,
  RobotPartHistoryEntry: $d,
  RotateKeyRequest: mT,
  RotateKeyResponse: cT,
  RoverRentalRobot: ap,
  SearchOrganizationsRequest: Xg,
  SearchOrganizationsResponse: Qg,
  ShareLocationRequest: zu,
  ShareLocationResponse: Yu,
  SharedSecret: ko,
  SharedSecret_State: yo,
  StorageConfig: Nu,
  TailRobotPartLogsRequest: dp,
  TailRobotPartLogsResponse: up,
  TransferRegistryItemRequest: Cg,
  TransferRegistryItemResponse: Ng,
  URLValidation: zd,
  UnshareLocationRequest: $u,
  UnshareLocationResponse: Vu,
  UpdateBillingServiceRequest: fu,
  UpdateBillingServiceResponse: vu,
  UpdateFragmentRequest: qp,
  UpdateFragmentResponse: Up,
  UpdateLocationRequest: Uu,
  UpdateLocationResponse: Gu,
  UpdateMLModelMetadata: Gg,
  UpdateMLTrainingMetadata: Lg,
  UpdateModuleMetadata: Ug,
  UpdateModuleRequest: Ag,
  UpdateModuleResponse: qg,
  UpdateOAuthAppRequest: IT,
  UpdateOAuthAppResponse: bT,
  UpdateOrganizationInviteAuthorizationsRequest: cu,
  UpdateOrganizationInviteAuthorizationsResponse: lu,
  UpdateOrganizationRequest: nu,
  UpdateOrganizationResponse: au,
  UpdateRegistryItemRequest: Ig,
  UpdateRegistryItemResponse: bg,
  UpdateRobotPartRequest: Tp,
  UpdateRobotPartResponse: kp,
  UpdateRobotRequest: Wp,
  UpdateRobotResponse: jp,
  UploadModuleFileRequest: xg,
  UploadModuleFileResponse: Fg,
  Uploads: _o,
  VersionHistory: Yg,
  Visibility: rn
}, Symbol.toStringTag, { value: "Module" }));
...
var qv = class {
   ...
   */
  async updateOrganization(e, n, t, s, i) {
   ...
   */
  async createOrganizationInvite(e, n, t, s = true) {
   ...
   * @returns The organization invite
   */
  async updateOrganizationInviteAuthorizations(e, n, t, s) {
    return (await this.client.updateOrganizationInviteAuthorizations({
      organizationId: e,
      email: n,
      addAuthorizations: t,
      removeAuthorizations: s
    })).invite;
  }
  /**
   ...
   *   logs
   */
  async getRobotPartLogs(e, n, t, s = "") {
   ...
   */
  async tailRobotPartLogs(e, n, t, s = true) {
   ...
   */
  async updateFragment(e, n, t, s, i) {
   ...
   */
  async updateRegistryItem(e, n, t, s) {
   ...
   */
  async listRegistryItems(e, n, t, s, i, r, c) {
    const d = {
      organizationId: e,
      types: n,
      visibilities: t,
   ...
   */
  async updateModule(e, n, t, s, i, r) {
...
var UT = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "resource_type", kind: "enum", T: o.getEnumType(NT) },
    {
      no: 2,
      name: "cost",
      kind: "scalar",
...
var GT = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "source_type", kind: "enum", T: o.getEnumType(PT) },
    { no: 2, name: "resource_usage_costs", kind: "message", T: LT },
    {
      no: 3,
      name: "tier_name",
      kind: "scalar",
...
var LT = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "usage_costs", kind: "message", T: UT, repeated: true },
    {
      no: 2,
      name: "discount",
      kind: "scalar",
...
var BT = o.makeMessageType(
  ...
  () => [
    ...
    { no: 14, name: "resource_usage_costs_by_source", kind: "message", T: GT, repeated: true },
    {
      no: 15,
      name: "subtotal",
      kind: "scalar",
...
var FT = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "type", kind: "enum", T: o.getEnumType(CT) },
    {
      no: 2,
      name: "billing_email",
      kind: "scalar",
    ...
    { no: 3, name: "method", kind: "message", T: AT, opt: true },
...
var zT = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "invoices", kind: "message", T: DT, repeated: true }
  ]
);
var YT = o.makeMessageType(
...
var LR = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetCurrentMonthUsageRequest: qT,
  GetCurrentMonthUsageResponse: BT,
  GetInvoicePdfRequest: YT,
  GetInvoicePdfResponse: $T,
  GetInvoicesSummaryRequest: JT,
  GetInvoicesSummaryResponse: zT,
  GetOrgBillingInformationRequest: xT,
  GetOrgBillingInformationResponse: FT,
  InvoiceSummary: DT,
  PaymentMethodCard: AT,
  PaymentMethodType: CT,
  ResourceUsageCosts: LT,
  ResourceUsageCostsBySource: GT,
  SendPaymentRequiredEmailRequest: VT,
  SendPaymentRequiredEmailResponse: WT,
  SourceType: PT,
  UsageCost: UT,
  UsageCostType: NT
}, Symbol.toStringTag, { value: "Module" }));
...
var Gv = class {
  ...
  async getCurrentMonthUsage(e) {
    ...
    return n.start = (_a = n.startDate) == null ? void 0 : _a.toDate(), n.end = (_b = n.endDate) == null ? void 0 : _b.toDate(), n;
  }
...
var Lv = (a) => {
  const e = a.reduce((s, i) => s + i.length, 0), n = new Uint8Array(e);
  let t = 0;
  for (const s of a)
...
(function(a) {
  Object.defineProperty(a, "__esModule", { value: true }), function(e) {
    ...
    var s = (
      ...
      function() {
        function k(h) {
          this._time = typeof h != "string" ? new Uint8Array(h || R(Date.now())) : R(+new Date(h));
        }
        return k.prototype.buffer = function() {
          return this._time;
        }, k.prototype.fromString = function(h) {
          this._time = R(+new Date(h));
    ...
    function r(k, h) {
      ...
      switch (h.constructor) {
        case String:
          return g + 4 + F(h) + 1;
        case Number:
          return Math.floor(h) === h && h <= 2147483647 && h >= -2147483647 ? g + 4 : g + 8;
        case Boolean:
          return g + 1;
        case Array:
        case Object:
    ...
    function c(k) {
      var h = new Uint8Array(i(k));
      return d(k, h), h;
    }
    e.serialize = c;
    function d(k, h, g) {
      if (g === void 0 && (g = 0), g += T(h.length, h, g), k.constructor === Array)
        for (var y = 0, w = k.length; y < w; y++)
          g = v(y.toString(), k[y], h, g);
      else
        for (var b in k)
          g = v(b, k[b], h, g);
      return h[g++] = 0, g;
    ...
    function l(k, h, g) {
      var y = M(k), w = y.length;
      return h.set(y, g), h[g + w++] = 0, w;
    }
    function T(k, h, g) {
      return h[g++] = k & 255, h[g++] = k >>> 8 & 255, h[g++] = k >>> 16 & 255, h[g++] = k >>> 24 & 255, 4;
    }
    function v(k, h, g, y) {
      if (h == null)
        return g[y++] = 10, y += l(k, g, y), y;
      switch (h.constructor) {
        case String:
          g[y++] = 2, y += l(k, g, y);
          var w = l(h, g, y + 4);
          return y += T(w, g, y), y + w;
        case Number:
          if (Math.floor(h) === h)
            h <= 2147483647 && h >= -2147483647 ? (g[y++] = 16, y += l(k, g, y), y += T(h, g, y)) : (g[y++] = 18, y += l(k, g, y), g.set(R(h), y), y += 8);
          else {
            g[y++] = 1, y += l(k, g, y);
            var b = new Float64Array([h]), Z = new Uint8Array(b.buffer);
            g.set(Z, y), y += 8;
          }
          return y;
        case Boolean:
          return g[y++] = 8, y += l(k, g, y), g[y++] = h ? 1 : 0, y;
        case Array:
        case Object:
          g[y++] = h.constructor === Array ? 4 : 3, y += l(k, g, y);
          var D = d(h, g, y);
          return T(D - y, g, y), D;
        case Int8Array:
        case Uint8Array:
          return g[y++] = 5, y += l(k, g, y), y += T(h.byteLength, g, y), g[y++] = 0, g.set(h, y), y += h.byteLength, y;
        case Date:
          return g[y++] = 9, y += l(k, g, y), g.set(R(h.getTime()), y), y += 8, y;
        case s:
          return g[y++] = 9, y += l(k, g, y), g.set(h.buffer(), y), y += 8, y;
        case n:
          return g[y++] = 5, y += l(k, g, y), y += T(16, g, y), g[y++] = 4, g.set(h.buffer(), y), y += 16, y;
        case t:
          return g[y++] = 7, y += l(k, g, y), g.set(h.buffer(), y), y += 12, y;
        case RegExp:
          return g[y++] = 11, y += l(k, g, y), y += l(h.source, g, y), h.global && (g[y++] = 115), h.ignoreCase && (g[y++] = 105), h.multiline && (g[y++] = 109), g[y++] = 0, y;
        default:
          return y;
      }
    }
    function S(k, h, g, y) {
      if (h === void 0 && (h = false), g === void 0 && (g = 0), y === void 0 && (y = false), !(k.length < 5)) {
        var w = k[g++] | k[g++] << 8 | k[g++] << 16 | k[g++] << 24;
        if (!(w < 5 || w > k.length) && k[k.length - 1] === 0) {
          for (var b = y ? [] : {}; ; ) {
            var Z = k[g++];
            if (Z === 0)
              break;
            ...
            if (D >= k.length - 1)
              return;
            var J = N(k.subarray(g, D));
            switch (y && (J = parseInt(J)), g = ++D, Z) {
              case 1:
                b[J] = new Float64Array(k.slice(g, g += 8).buffer)[0];
                break;
              case 2:
                w = k[g++] | k[g++] << 8 | k[g++] << 16 | k[g++] << 24, b[J] = N(k.subarray(g, g += w - 1)), g++;
                break;
              case 3:
                w = k[g] | k[g + 1] << 8 | k[g + 2] << 16 | k[g + 3] << 24, b[J] = S(k, h, g, false), g += w;
                break;
              case 4:
                w = k[g] | k[g + 1] << 8 | k[g + 2] << 16 | k[g + 3] << 24, b[J] = S(k, h, g, true), g += w;
                break;
              case 5:
                if (w = k[g++] | k[g++] << 8 | k[g++] << 16 | k[g++] << 24, k[g++] === 4) {
                  if (w !== 16)
                    return;
                  b[J] = new n(k.subarray(g, g += w));
                } else
                  b[J] = k.slice(g, g += w);
                break;
              case 6:
                ...
                break;
              case 7:
                b[J] = new t(k.subarray(g, g += 12));
                break;
              case 8:
                b[J] = k[g++] === 1;
                break;
              case 9:
                b[J] = h ? new s(k.subarray(g, g += 8)) : new Date(I(k.subarray(g, g += 8)));
                break;
              case 10:
                b[J] = null;
                break;
              case 11:
                ...
                if (D >= k.length)
                  return;
                var _a = N(k.subarray(g, D));
                for (g = D; D < k.length && k[D++] !== 0; )
                  ;
                if (D >= k.length)
                  return;
                var Sa = N(k.subarray(g, D));
                g = D, b[J] = new RegExp(_a, Sa);
                break;
              case 16:
                b[J] = k[g++] | k[g++] << 8 | k[g++] << 16 | k[g++] << 24;
                break;
              case 18:
                b[J] = I(k.subarray(g, g += 8));
                break;
              default:
                return;
            }
    ...
    function R(k) {
      ...
      if (Math.floor(k) === k) {
        var g = 4294967296, y = k % g | 0, w = k / g | 0;
        k < 0 && (y = ~(-k % g) | 0, w = ~(-k / g) | 0, y = y + 1 & 4294967295, y || w++);
        var b = 0;
        h[b++] = y & 255, h[b++] = y >>> 8 & 255, h[b++] = y >>> 16 & 255, h[b++] = y >>> 24 & 255, h[b++] = w & 255, h[b++] = w >>> 8 & 255, h[b++] = w >>> 16 & 255, h[b] = w >>> 24 & 255;
      } else {
    ...
    function I(k, h) {
      h === void 0 && (h = 0);
      var g = 4294967296, y = k[h++] | k[h++] << 8 | k[h++] << 16 | k[h++] << 24, w = k[h++] | k[h++] << 8 | k[h++] << 16 | k[h] << 24;
      return w * g + (y >= 0 ? y : g + y);
    }
    function M(k) {
      k = k.replace(/\r\n/g, `
`);
      for (var h = [], g = 0, y = 0, w = k.length; y < w; y++) {
        var b = k.charCodeAt(y);
        b < 128 ? h[g++] = b : b < 2048 ? (h[g++] = b >>> 6 | 192, h[g++] = b & 63 | 128) : (h[g++] = b >>> 12 | 224, h[g++] = b >>> 6 & 63 | 128, h[g++] = b & 63 | 128);
      }
      return new Uint8Array(h);
    }
    function N(k) {
      for (var h = "", g = k.length, y = 0, w, b, Z; y < g; )
        w = k[y], w < 128 ? (h += String.fromCharCode(w), y++) : w > 191 && w < 224 ? (b = k[y + 1], h += String.fromCharCode((w & 31) << 6 | b & 63), y += 2) : (b = k[y + 1], Z = k[y + 2], h += String.fromCharCode((w & 15) << 12 | (b & 63) << 6 | Z & 63), y += 3);
      return h;
    }
    function F(k) {
...
var bo = o.makeMessageType(
  "viam.app.data.v1.DataRequest",
  () => [
    { no: 1, name: "filter", kind: "message", T: ze },
    {
      no: 2,
      name: "limit",
      kind: "scalar",
    ...
    { no: 4, name: "sort_order", kind: "enum", T: o.getEnumType(KT) }
  ]
);
var ze = o.makeMessageType(
  ...
  () => [
    ...
    { no: 13, name: "interval", kind: "message", T: Sn },
    { no: 14, name: "tags_filter", kind: "message", T: wo },
...
var wo = o.makeMessageType(
  "viam.app.data.v1.TagsFilter",
  () => [
    { no: 1, name: "type", kind: "enum", T: o.getEnumType(XT) },
    { no: 2, name: "tags", kind: "scalar", T: 9, repeated: true }
  ]
);
var Ra = o.makeMessageType(
  ...
  () => [
    ...
    { no: 11, name: "method_parameters", kind: "map", K: 9, V: { kind: "message", T: W } },
...
var QT = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "data_request", kind: "message", T: bo },
    {
      no: 2,
      name: "count_only",
      kind: "scalar",
...
var ZT = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "metadata", kind: "message", T: Ra, repeated: true },
    { no: 2, name: "data", kind: "message", T: ek, repeated: true },
    {
      no: 3,
      name: "count",
      kind: "scalar",
...
var ek = o.makeMessageType(
  "viam.app.data.v1.TabularData",
  () => [
    { no: 1, name: "data", kind: "message", T: u },
    {
      no: 2,
      name: "metadata_index",
      kind: "scalar",
...
var sk = o.makeMessageType(
  "viam.app.data.v1.TabularDataByMQLResponse",
  () => [
    { no: 2, name: "raw_data", kind: "scalar", T: 12, repeated: true }
  ]
);
var ok = o.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "interval", kind: "message", T: Sn }
  ]
);
var ik = o.makeMessageType(
  ...
  () => [
    ...
    { no: 11, name: "method_parameters", kind: "message", T: u },
    { no: 12, name: "tags", kind: "scalar", T: 9, repeated: true },
    { no: 13, name: "payload", kind: "message", T: u }
  ]
);
var rk = o.makeMessageType(
...
var mk = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "payload", kind: "message", T: u }
  ]
);
var Eo = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "metadata", kind: "message", T: Tk }
  ]
);
var ck = o.makeMessageType(
...
var lk = o.makeMessageType(
  "viam.app.data.v1.BinaryDataByFilterResponse",
  () => [
    { no: 1, name: "data", kind: "message", T: Eo, repeated: true },
    {
      no: 2,
      name: "count",
      kind: "scalar",
...
var dk = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "binary_ids", kind: "message", T: ce, repeated: true }
  ]
);
var uk = o.makeMessageType(
...
var Oo = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "bboxes", kind: "message", T: pk, repeated: true },
    { no: 2, name: "classifications", kind: "message", T: gk, repeated: true }
  ]
);
var Tk = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "capture_metadata", kind: "message", T: Ra },
    { no: 3, name: "time_requested", kind: "message", T: _ },
    { no: 4, name: "time_received", kind: "message", T: _ },
    {
      no: 5,
    ...
    { no: 8, name: "annotations", kind: "message", T: Oo },
    { no: 9, name: "dataset_ids", kind: "scalar", T: 9, repeated: true }
  ]
);
var kk = o.makeMessageType(
...
var vk = o.makeMessageType(
  "viam.app.data.v1.DeleteBinaryDataByIDsRequest",
  () => [
    { no: 2, name: "binary_ids", kind: "message", T: ce, repeated: true }
  ]
);
var Rk = o.makeMessageType(
...
var Pk = o.makeMessageType(
  ...
  () => [
    { no: 7, name: "binary_id", kind: "message", T: ce },
    {
      no: 2,
      name: "label",
      kind: "scalar",
...
var Ak = o.makeMessageType(
  ...
  () => [
    { no: 3, name: "binary_id", kind: "message", T: ce },
    {
      no: 2,
      name: "bbox_id",
      kind: "scalar",
...
var Uk = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "binary_id", kind: "message", T: ce },
    {
      no: 2,
      name: "bbox_id",
      kind: "scalar",
...
var Yk = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "binary_ids", kind: "message", T: ce, repeated: true },
    {
      no: 2,
      name: "dataset_id",
      kind: "scalar",
...
var BR = Object.freeze(Object.defineProperty({
  __proto__: null,
  AddBinaryDataToDatasetByIDsRequest: Yk,
  AddBinaryDataToDatasetByIDsResponse: $k,
  AddBoundingBoxToImageByIDRequest: Pk,
  AddBoundingBoxToImageByIDResponse: Dk,
  AddTagsToBinaryDataByFilterRequest: Ik,
  AddTagsToBinaryDataByFilterResponse: bk,
  AddTagsToBinaryDataByIDsRequest: _k,
  AddTagsToBinaryDataByIDsResponse: Sk,
  Annotations: Oo,
  BinaryData: Eo,
  BinaryDataByFilterRequest: ck,
  BinaryDataByFilterResponse: lk,
  BinaryDataByIDsRequest: dk,
  BinaryDataByIDsResponse: uk,
  BinaryID: ce,
  BinaryMetadata: Tk,
  BoundingBox: pk,
  BoundingBoxLabelsByFilterRequest: Lk,
  BoundingBoxLabelsByFilterResponse: Bk,
  CaptureInterval: Sn,
  CaptureMetadata: Ra,
  Classification: gk,
  ConfigureDatabaseUserRequest: xk,
  ConfigureDatabaseUserResponse: Fk,
  DataRequest: bo,
  DeleteBinaryDataByFilterRequest: hk,
  DeleteBinaryDataByFilterResponse: fk,
  DeleteBinaryDataByIDsRequest: vk,
  DeleteBinaryDataByIDsResponse: Rk,
  DeleteTabularDataRequest: kk,
  DeleteTabularDataResponse: yk,
  ExportTabularDataRequest: ok,
  ExportTabularDataResponse: ik,
  Filter: ze,
  GetDatabaseConnectionRequest: Jk,
  GetDatabaseConnectionResponse: zk,
  GetLatestTabularDataRequest: rk,
  GetLatestTabularDataResponse: mk,
  Order: KT,
  RemoveBinaryDataFromDatasetByIDsRequest: Vk,
  RemoveBinaryDataFromDatasetByIDsResponse: Wk,
  RemoveBoundingBoxFromImageByIDRequest: Ak,
  RemoveBoundingBoxFromImageByIDResponse: qk,
  RemoveTagsFromBinaryDataByFilterRequest: Ok,
  RemoveTagsFromBinaryDataByFilterResponse: Mk,
  RemoveTagsFromBinaryDataByIDsRequest: wk,
  RemoveTagsFromBinaryDataByIDsResponse: Ek,
  TabularData: ek,
  TabularDataByFilterRequest: QT,
  TabularDataByFilterResponse: ZT,
  TabularDataByMQLRequest: tk,
  TabularDataByMQLResponse: sk,
  TabularDataBySQLRequest: nk,
  TabularDataBySQLResponse: ak,
  TagsByFilterRequest: Ck,
  TagsByFilterResponse: Nk,
  TagsFilter: wo,
  TagsFilterType: XT,
  UpdateBoundingBoxRequest: Uk,
  UpdateBoundingBoxResponse: Gk
}, Symbol.toStringTag, { value: "Module" }));
var xv = {
...
var Vv = o.makeMessageType(
  "viam.app.dataset.v1.RenameDatasetResponse",
  []
);
var Wv = o.makeMessageType(
...
var jv = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "datasets", kind: "message", T: jk, repeated: true }
  ]
);
var Hv = o.makeMessageType(
...
var $a = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "metadata", kind: "message", T: In },
    { no: 2, name: "sensor_contents", kind: "message", T: Va, repeated: true }
  ]
);
var Zv = o.makeMessageType(
...
var eR = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "metadata", kind: "message", T: In, oneof: "upload_packet" },
    { no: 2, name: "file_contents", kind: "message", T: sR, oneof: "upload_packet" }
  ]
);
var nR = o.makeMessageType(
...
var aR = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "metadata", kind: "message", T: oR, oneof: "upload_packet" },
...
var Mo = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "mime_type", kind: "enum", T: o.getEnumType(Qv) },
    { no: 4, name: "annotations", kind: "message", T: Oo }
  ]
);
var Va = o.makeMessageType(
  "viam.app.datasync.v1.SensorData",
  () => [
    { no: 1, name: "metadata", kind: "message", T: Mo },
    { no: 2, name: "struct", kind: "message", T: u, oneof: "data" },
...
var In = o.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "type", kind: "enum", T: o.getEnumType(Ya) },
    {
      no: 7,
      name: "file_name",
      kind: "scalar",
    ...
    { no: 8, name: "method_parameters", kind: "map", K: 9, V: { kind: "message", T: W } },
    {
      no: 9,
      name: "file_extension",
      kind: "scalar",
...
var oR = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "upload_metadata", kind: "message", T: In },
    { no: 2, name: "sensor_metadata", kind: "message", T: Mo }
  ]
);
var iR = {
...
var rR = class {
  constructor(e) {
    __publicField(this, "dataClient");
    __publicField(this, "datasetClient");
    __publicField(this, "dataSyncClient");
    this.dataClient = P(xv, e), this.datasetClient = P(Xv, e), this.dataSyncClient = P(iR, e);
  }
  /**
   ...
   */
  async exportTabularData(e, n, t, s, i, r) {
    const c = new Sn();
    ...
    const d = {
      ...
      methodName: s,
      interval: c
    }, l = this.dataClient.exportTabularData(d), T = [];
    for await (const v of l)
      T.push({
        ...
        timeCaptured: v.timeCaptured.toDate(),
        ...
        robotId: v.robotId,
        partName: v.partName,
        methodParameters: v.methodParameters.toJson(),
        // eslint-disable-line @typescript-eslint/no-non-null-assertion
        tags: v.tags,
        payload: v.payload.toJson()
        // eslint-disable-line @typescript-eslint/no-non-null-assertion
      });
    return T;
  }
  ...
  async tabularDataBySQL(e, n) {
    return (await this.dataClient.tabularDataBySQL({
      organizationId: e,
      sqlQuery: n
    })).rawData.map((s) => Ca.deserialize(s));
  }
  /**
   ...
   * @returns An array of data objects
   */
  async tabularDataByMQL(e, n) {
    const t = n[0] instanceof Uint8Array ? n : n.map((i) => Ca.serialize(i));
    return (await this.dataClient.tabularDataByMQL({
      organizationId: e,
      mqlBinary: t
    })).rawData.map((i) => Ca.deserialize(i));
  }
  /**
   ...
   */
  async tabularDataByFilter(e, n, t, s = "", i = false, r = false) {
    const d = {
      dataRequest: {
        filter: e,
    ...
    }, l = await this.dataClient.tabularDataByFilter(d), T = l.metadata.length, v = [];
    return v.push(
      ...l.data.map((S) => {
        var _a, _b, _c2;
        const R = S.metadataIndex, I = T !== 0 && R >= T ? new Ra() : l.metadata[R];
        return {
          data: (_a = S.data) == null ? void 0 : _a.toJson(),
          metadata: I,
          timeRequested: (_b = S.timeRequested) == null ? void 0 : _b.toDate(),
          timeReceived: (_c2 = S.timeRequested) == null ? void 0 : _c2.toDate()
        };
      })
    ), {
      data: v,
   ...
   *   last-returned page ID.
   */
  async binaryDataByFilter(e, n, t, s = "", i = true, r = false, c = false) {
    const l = {
      dataRequest: {
        filter: e,
        limit: n === void 0 ? void 0 : BigInt(n),
    ...
    }, T = await this.dataClient.binaryDataByFilter(l);
    return {
      data: T.data,
      count: T.count,
      last: T.last
  ...
  async deleteBinaryDataByIds(e) {
    return (await this.dataClient.deleteBinaryDataByIDs({
      binaryIds: e
    })).deletedCount;
  }
  /**
   ...
   */
  async addBoundingBoxToImageById(e, n, t, s, i, r) {
  ...
  async listDatasetsByOrganizationID(e) {
    return (await this.datasetClient.listDatasetsByOrganizationID({
      ...
      var _a;
      return {
        created: (_a = t.timeCreated) == null ? void 0 : _a.toDate(),
        ...t
      };
    });
  }
   ...
   */
  async tabularDataCaptureUpload(e, n, t, s, i, r, c) {
    ...
    const d = new In({
      ...
      componentName: s,
      methodName: i,
      type: Ya.TABULAR_SENSOR,
      tags: c
    }), l = [];
    for (const [S, R] of e.entries()) {
      const I = new Mo(), M = r[S];
      M && (I.timeRequested = _.fromDate(M[0]), I.timeReceived = _.fromDate(M[1])), l.push(
        new Va({
          metadata: I,
          data: {
            case: "struct",
   ...
   * @returns The file ID of the uploaded data
   */
  async binaryDataCaptureUpload(e, n, t, s, i, r, c, d) {
    const l = new In({
      partId: n,
      componentType: t,
      componentName: s,
      methodName: i,
      type: Ya.BINARY_SENSOR,
      tags: d,
      fileExtension: r
    }), T = new Va({
      metadata: {
    ...
    return (await this.dataSyncClient.dataCaptureUpload(v)).fileId;
  }
  ...
  createFilter(e) {
    ...
    if (e.startTime ?? e.endTime) {
      const s = new Sn();
      e.startTime && (s.start = _.fromDate(e.startTime)), e.endTime && (s.end = _.fromDate(e.endTime)), n.interval = s;
    }
    const t = new wo();
   ...
   */
  async getLatestTabularData(e, n, t, s) {
    ...
    return !i.payload || !i.timeCaptured || !i.timeSynced ? null : [
      i.timeCaptured.toDate(),
      i.timeSynced.toDate(),
      i.payload.toJson()
    ];
  }
...
var cR = class {
  ...
  async submitTrainingJob(e, n, t, s, i, r) {
  ...
  async submitCustomTrainingJob(e, n, t, s, i, r) {
    return (await this.client.submitCustomTrainingJob({
      organizationId: e,
      datasetId: n,
      registryItemId: t,
      registryItemVersion: s,
      modelName: i,
      modelVersion: r
    })).id;
  }
...
var Kk = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "provisioning_info", kind: "message", T: ty },
    {
      no: 2,
    ...
    { no: 4, name: "latest_connection_attempt", kind: "message", T: Co },
...
var Zk = o.makeMessageType(
  ...
  () => [
    { no: 1, name: "cloud", kind: "message", T: sy }
  ]
);
var ey = o.makeMessageType(
  "viam.provisioning.v1.SetSmartMachineCredentialsResponse",
  []
);
var ny = o.makeMessageType(
  "viam.provisioning.v1.GetNetworkListRequest",
  []
);
var ay = o.makeMessageType(
  "viam.provisioning.v1.GetNetworkListResponse",
  () => [
    { no: 1, name: "networks", kind: "message", T: Co, repeated: true }
  ]
);
var ty = o.makeMessageType(
...
var xR = Object.freeze(Object.defineProperty({
  __proto__: null,
  CloudConfig: sy,
  GetNetworkListRequest: ny,
  GetNetworkListResponse: ay,
  GetSmartMachineStatusRequest: Hk,
  GetSmartMachineStatusResponse: Kk,
  NetworkInfo: Co,
  ProvisioningInfo: ty,
  SetNetworkCredentialsRequest: Xk,
  SetNetworkCredentialsResponse: Qk,
  SetSmartMachineCredentialsRequest: Zk,
  SetSmartMachineCredentialsResponse: ey
}, Symbol.toStringTag, { value: "Module" }));
var lR = {
...
var uR = class {
  constructor(e, n) {
    ...
    __publicField(this, "mlTrainingClient");
    __publicField(this, "provisioningClient");
    __publicField(this, "billingClient");
    this.transport = e, this.credentials = n, this.dataClient = new rR(this.transport), this.appClient = new qv(this.transport), this.mlTrainingClient = new cR(this.transport), this.provisioningClient = new dR(this.transport), this.billingClient = new Gv(this.transport);
  }
  async connectToMachine({
    ...
    if (!En(i)) {
      if (s === void 0) {
        const c = (_a = t.split(".viam.")[0]) == null ? void 0 : _a.split(".");
        c !== void 0 && (s = c.at(-1));
      }
      s !== void 0 && (i = {
        type: "robot-location-secret",
        payload: (_d2 = (_c2 = (_b = await this.appClient.getLocation(s)) == null ? void 0 : _b.auth) == null ? void 0 : _c2.secrets.find(
          // eslint-disable-next-line camelcase
          (d) => d.state === yo.ENABLED
        )) == null ? void 0 : _d2.secret,
        authEntity: t
      });
    }
    return Pv({
...
var { JointPositions: JR } = nv;
var zR = class {
  constructor(e, n, t = {}) {
    __publicField(this, "client");
    __publicField(this, "name");
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(Ir), this.name = n, this.options = t;
  }
  async getEndPosition(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
  ...
  async moveToPosition(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.moveToPosition(s, t);
  }
  async moveToJointPositions(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.moveToJointPositions(i, t);
  }
  ...
  async stop(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), await this.client.stop(t, n);
  }
  async isMoving(e = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, n), (await this.client.isMoving(n, e)).isMoving;
  }
...
var { GetPropertiesResponse: YR } = av;
var $R = class {
  constructor(e, n, t = {}) {
    __publicField(this, "client");
    __publicField(this, "name");
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(Pr), this.name = n, this.options = t;
  }
  async moveStraight(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new pt({
      name: this.name,
      mmPerSec: n,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.moveStraight(i, s);
  }
  async spin(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new gt({
      name: this.name,
      angleDeg: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.spin(i, s);
  }
  async setPower(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new kt({
      name: this.name,
      linear: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.setPower(i, s);
  }
  async setVelocity(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new yt({
      name: this.name,
      linear: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.setVelocity(i, s);
  }
  async stop(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new Tt({
  ...
  async getProperties(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), this.client.getProperties(t, n);
  }
};
var { ReadAnalogReaderResponse: VR, PowerMode: WR } = sv;
var jR = class {
  constructor(e, n, t = {}) {
    __publicField(this, "client");
    __publicField(this, "name");
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient($r), this.name = n, this.options = t;
  }
  async setGPIO(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new ft({
      name: this.name,
      pin: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.setGPIO(i, s);
  }
  async getGPIO(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), (await this.client.getGPIO(s, t)).high;
  }
  async getPWM(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), (await this.client.pWM(s, t)).dutyCyclePct;
  }
  async setPWM(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new _t({
      name: this.name,
      pin: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.setPWM(i, s);
  }
  async getPWMFrequency(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s);
    const i = await this.client.pWMFrequency(s, t);
    return Number(i.frequencyHz);
  }
  async setPWMFrequency(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new It({
      name: this.name,
      pin: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.setPWMFrequency(i, s);
  }
  async readAnalogReader(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), this.client.readAnalogReader(s, t);
  }
  async writeAnalog(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new wt({
      name: this.name,
      pin: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.writeAnalog(i, s);
  }
  ...
  async streamTicks(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new Ot({
      name: this.name,
      pinNames: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i);
    const r = this.client.streamTicks(i, s);
  ...
  async setPowerMode(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new Mt({
      name: this.name,
      powerMode: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.setPowerMode(i, s);
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var KR = class {
  ...
  async push(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), await this.client.push(t, n);
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var gR = o.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "extensions", kind: "message", T: W, repeated: true }
  ]
);
var TR = {
...
var XR = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(TR), this.name = n, this.options = t;
  }
  async getImage(e = "", n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), (await this.client.getImage(s, t)).image;
  }
  async renderFrame(e = "", n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s);
    const i = await this.client.renderFrame(s, t);
  ...
  async getPointCloud(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getPointCloud(t, n)).pointCloud;
  }
  async getProperties(e = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, n), this.client.getProperties(n, e);
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var QR = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(yl), this.name = n, this.options = t;
  }
  async discoverResources(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.discoverResources(t, n)).discoveries;
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var e1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(Hr), this.name = n, this.options = t;
  }
  async resetPosition(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), await this.client.resetPosition(t, n);
  }
  async getProperties(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new Dt({
  ...
  async getPosition(e = yR.UNSPECIFIED, n = {}, t = this.callOptions) {
    var _a, _b;
    const s = new Nt({
      name: this.name,
      positionType: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s);
    const i = await this.client.getPosition(s, t);
...
var n1 = class {
  ...
  async getPosition(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getPosition(t, n)).positionsMm;
  }
  async moveToPosition(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new qt({
      name: this.name,
      positionsMm: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.moveToPosition(i, s);
  }
  async home(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.home(t, n)).homed;
  }
  async getLengths(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getLengths(t, n)).lengthsMm;
  }
  async stop(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new Lt({
...
var a1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(wm), this.name = n, this.options = t;
  }
  async setPower(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.setPower(s, t);
  }
  async goFor(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new jt({
      name: this.name,
      rpm: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.goFor(i, s);
  }
  async goTo(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new Ht({
      name: this.name,
      rpm: e,
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), await this.client.goTo(i, s);
  }
  async setRPM(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.setRPM(s, t);
  }
  async resetZeroPosition(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.resetZeroPosition(s, t);
  }
  async stop(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new Zt({
  ...
  async getProperties(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), {
  ...
  async getPosition(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getPosition(t, n)).position;
  }
  async isPowered(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
    const s = await this.client.isPowered(t, n);
    return [s.isOn, s.powerPct];
  }
  async isMoving(e = this.callOptions) {
    var _a, _b;
    const n = new as({
...
var t1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(qm), this.name = n, this.options = t;
  }
  ...
  async getCompassHeading(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getCompassHeading(t, n)).value;
  }
  ...
  async getPosition(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), this.client.getPosition(t, n);
  }
  async getProperties(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new ms({
  ...
  async getAccuracy(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), this.client.getAccuracy(t, n);
  }
  ...
  async getReadings(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
    const s = await this.client.getReadings(t, n), i = {};
    for (const r of Object.keys(s.readings)) {
      const c = s.readings[r];
      c && (i[r] = c.toJson());
    }
    return i;
  }
...
var {
  GetAccuracyResponse: s1,
  GetPositionResponse: o1,
  GetPropertiesResponse: i1
} = lv;
var r1 = class {
  constructor(e, n, t = {}) {
    __publicField(this, "client");
  ...
  async getVoltage(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
    const s = await this.client.getVoltage(t, n);
    return [s.volts, s.isAc];
  }
  async getCurrent(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
    const s = await this.client.getCurrent(t, n);
    return [s.amperes, s.isAc];
  }
  async getPower(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getPower(t, n)).watts;
  }
  async getReadings(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new We({
...
var c1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(iy), this.name = n, this.options = t;
  }
  async getReadings(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new We({
...
var cy = o.makeMessageType(
  "proto.stream.v1.AddStreamResponse",
  []
);
var Do = o.makeMessageType(
...
var dy = o.makeMessageType(
  "proto.stream.v1.GetStreamOptionsResponse",
  () => [
    { no: 1, name: "resolutions", kind: "message", T: Ao, repeated: true }
  ]
);
var oa = o.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "resolution", kind: "message", T: Ao }
  ]
);
var uy = o.makeMessageType(
  "proto.stream.v1.SetStreamOptionsResponse",
  []
);
var l1 = Object.freeze(Object.defineProperty({
  __proto__: null,
  AddStreamRequest: Po,
  AddStreamResponse: cy,
  GetStreamOptionsRequest: qo,
  GetStreamOptionsResponse: dy,
  ListStreamsRequest: ry,
  ListStreamsResponse: my,
  RemoveStreamRequest: Do,
  RemoveStreamResponse: ly,
  Resolution: Ao,
  SetStreamOptionsRequest: oa,
  SetStreamOptionsResponse: uy
}, Symbol.toStringTag, { value: "Module" }));
var hR = {
...
var ln = (a) => a.replaceAll(":", "+");
var d1 = class extends gr {
  constructor(e, n = {}) {
    super();
    __publicField(this, "client");
    __publicField(this, "options");
    __publicField(this, "streams");
    __publicField(this, "STREAM_TIMEOUT", 5e3);
    /**
     ...
     */
    __publicField(this, "getStream", async (e) => {
      const n = new Promise((t, s) => {
        const i = (r) => {
          const [c] = r.streams;
          c ? c.id === e && (this.off("track", i), t(c)) : (this.off("track", i), s(new Error("Received track event with no streams")));
        };
    ...
    this.client = e.createServiceClient(hR), this.options = n, this.streams = /* @__PURE__ */ new Set(), e.on("track", (t) => {
      this.emit("track", t);
    }), e.on(ae.CONNECTED, () => {
  ...
  async add(e) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, n);
    try {
      await this.client.addStream(n), this.streams.add(e);
    } catch {
      n.name = e, (_d2 = (_c2 = this.options).requestLogger) == null ? void 0 : _d2.call(_c2, n), await this.client.addStream(n), this.streams.add(e);
    }
  }
  async remove(e) {
    var _a, _b, _c2, _d2;
    ...
    try {
      ...
      n.name = e, (_d2 = (_c2 = this.options).requestLogger) == null ? void 0 : _d2.call(_c2, n), await this.client.removeStream(n), this.streams.delete(e);
    }
  }
  /**
  ...
  async getOptions(e) {
    const n = async (i) => {
      var _a, _b;
      const r = new qo({ name: i });
      (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, r);
      try {
    ...
    let s = await n(t);
    return s.length > 0 || (s = await n(e)), s;
  }
  /**
  ...
  async setOptions(e, n, t) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s);
    try {
      await this.client.setStreamOptions(s);
    } catch {
      s.name = e, (_d2 = (_c2 = this.options).requestLogger) == null ? void 0 : _d2.call(_c2, s), await this.client.setStreamOptions(s);
    }
  }
  /**
  ...
  async resetOptions(e) {
    ...
    try {
      ...
      n.name = e, (_d2 = (_c2 = this.options).requestLogger) == null ? void 0 : _d2.call(_c2, n), await this.client.setStreamOptions(n);
    }
  }
};
var Uo = o.makeMessageType(
...
var u1 = Object.freeze(Object.defineProperty({
  __proto__: null,
  GetNumberOfPositionsRequest: Lo,
  GetNumberOfPositionsResponse: Ty,
  GetPositionRequest: Go,
  GetPositionResponse: gy,
  SetPositionRequest: Uo,
  SetPositionResponse: py
}, Symbol.toStringTag, { value: "Module" }));
var fR = {
...
var p1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(fR), this.name = n, this.options = t;
  }
  async setPosition(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.setPosition(s, t);
  }
  async getPosition(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new Go({
  ...
  async getNumberOfPositions(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getNumberOfPositions(t, n)).numberOfPositions;
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var g1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(xt), this.name = n, this.options = t;
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var k1 = class {
  ...
  async open(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), await this.client.open(t, n);
  }
  async grab(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), await this.client.grab(t, n);
  }
  async stop(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new zt({
...
var y1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(Tm), this.name = n, this.options = t;
  }
  async getEvents(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getEvents(t, n)).events;
  }
  async triggerEvent(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.triggerEvent(s, t);
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var { Event: h1 } = mv;
var {
  CollisionSpecification: f1,
  Constraints: v1,
  GetPlanResponse: R1,
  LinearConstraint: _1,
  ListPlanStatusesResponse: S1,
  MotionConfiguration: I1,
  ObstacleDetector: b1,
  OrientationConstraint: w1,
  PlanState: E1
} = vv;
var O1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(Ul), this.name = n, this.options = t;
  }
  async move(e, n, t, s, i = {}, r = this.callOptions) {
    var _a, _b;
    const c = new Ds({
      name: this.name,
      destination: e,
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, c), (await this.client.move(c, r)).success;
  }
  async moveOnMap(e, n, t, s, i, r = {}, c = this.callOptions) {
    var _a, _b;
    const d = new As({
      name: this.name,
      destination: e,
      componentName: n,
      slamServiceName: t,
      motionConfiguration: s,
      obstacles: i,
      extra: u.fromJson(r)
    });
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, d), (await this.client.moveOnMap(d, c)).executionId;
  }
  async moveOnGlobe(e, n, t, s, i, r, c, d = {}, l = this.callOptions) {
    var _a, _b;
    const T = new Us({
      name: this.name,
      destination: e,
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, T), (await this.client.moveOnGlobe(T, l)).executionId;
  }
  async stopPlan(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.stopPlan(s, t), null;
  }
  async getPlan(e, n, t, s = {}, i = this.callOptions) {
    var _a, _b;
    const r = new xs({
      name: this.name,
      componentName: e,
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, r), this.client.getPlan(r, i);
  }
  async listPlanStatuses(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), this.client.listPlanStatuses(s, t);
  }
  async getPose(e, n, t, s = {}, i = this.callOptions) {
    var _a, _b;
    const r = new Gs({
      name: this.name,
      componentName: e,
...
var C1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(vR), this.name = n, this.options = t;
  }
  async sync(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), await this.client.sync(t, n);
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
var $1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(Hl), this.name = n, this.options = t;
  }
  async getMode(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getMode(t, n)).mode;
  }
  async setMode(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.setMode(s, t);
  }
  async getLocation(e = {}, n = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
    const s = await this.client.getLocation(t, n);
    if (!s.location)
  ...
  async getWayPoints(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getWaypoints(t, n)).waypoints;
  }
  async addWayPoint(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.addWaypoint(s, t);
  }
  async removeWayPoint(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.removeWaypoint(s, t);
  }
  async getObstacles(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getObstacles(t, n)).obstacles;
  }
  async getPaths(e = {}, n = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getPaths(t, n)).paths;
  }
  async getProperties(e = this.callOptions) {
    var _a, _b;
    const n = new Ks({
...
var {
  GetLocationResponse: V1,
  GetPropertiesResponse: W1,
  Mode: j1,
  Path: H1,
  Waypoint: K1
} = Rv;
var X1 = class {
  ...
  async move(e, n = {}, t = this.callOptions) {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), await this.client.move(s, t);
  }
  async getPosition(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new Ts({
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t), (await this.client.getPosition(t, n)).positionDeg;
  }
  async stop(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new ks({
...
var Q1 = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    __publicField(this, "getPointCloudMap", async (e, n = this.callOptions) => {
      var _a, _b;
      const t = new Qs({
        name: this.name,
        returnEditedMap: e
      ...
      (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
      const s = [], i = this.client.getPointCloudMap(t, n);
      for await (const r of i)
        s.push(r.pointCloudPcdChunk);
      return ki(s);
    });
    __publicField(this, "getInternalState", async (e = this.callOptions) => {
      var _a, _b;
      const n = new Zs({
        name: this.name
      });
      (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, n);
      const t = [], s = this.client.getInternalState(n, e);
  ...
  async getPosition(e = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, n), this.client.getPosition(n, e);
  }
  async getProperties(e = this.callOptions) {
    var _a, _b;
    const n = new eo({
...
var {
  GetPositionResponse: Z1,
  GetPropertiesResponse: e_
} = _v;
var n_ = class {
  constructor(e, n, t = {}) {
    __publicField(this, "client");
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(_d), this.name = n, this.options = t;
  }
  async getDetectionsFromCamera(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), (await this.client.getDetectionsFromCamera(
      s,
      t
    )).detections;
  }
  async getDetections(e, n, t, s, i = {}, r = this.callOptions) {
    var _a, _b;
    const c = new oo({
      name: this.name,
      image: e,
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, c), (await this.client.getDetections(c, r)).detections;
  }
  async getClassificationsFromCamera(e, n, t = {}, s = this.callOptions) {
    var _a, _b;
    const i = new mo({
      name: this.name,
      cameraName: e,
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, i), (await this.client.getClassificationsFromCamera(
      i,
      s
    )).classifications;
  }
  async getClassifications(e, n, t, s, i, r = {}, c = this.callOptions) {
    var _a, _b;
    const d = new ro({
      name: this.name,
      image: e,
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, d), (await this.client.getClassifications(d, c)).classifications;
  }
  async getObjectPointClouds(e, n = {}, t = this.callOptions) {
    ...
    return (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, s), (await this.client.getObjectPointClouds(s, t)).objects;
  }
  async getProperties(e = {}, n = this.callOptions) {
    var _a, _b;
    const t = new lo({
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, t);
    const s = await this.client.getProperties(t, n);
    return {
      classificationsSupported: s.classificationsSupported,
      detectionsSupported: s.detectionsSupported,
      objectPointCloudsSupported: s.objectPointCloudsSupported
    };
  }
  async captureAllFromCamera(e, {
    ...
    (_b = (_a = this.options).requestLogger) == null ? void 0 : _b.call(_a, d);
    const l = await this.client.captureAllFromCamera(
      d,
      c
    );
    return {
      image: l.image,
      classifications: l.classifications,
      detections: l.detections,
      objectPointClouds: l.objects
    };
  }
  async doCommand(e, n = this.callOptions) {
    return G(
...
var { Classification: a_, Detection: t_ } = Iv;
var { PointCloudObject: s_ } = pr;
var yy = {
...
var o_ = Object.freeze(Object.defineProperty({
  __proto__: null,
  GenericService: yy
}, Symbol.toStringTag, { value: "Module" }));
var i_ = class {
  constructor(e, n, t = {}) {
    ...
    __publicField(this, "options");
    __publicField(this, "callOptions", { headers: {} });
    this.client = e.createServiceClient(yy), this.name = n, this.options = t;
  }
  async doCommand(e, n = this.callOptions) {
    return G(
      this.client.doCommand,
...
export {
  VR as AnalogValue,
  zR as ArmClient,
  JR as ArmJointPositions,
  $R as BaseClient,
  YR as BaseProperties,
  jR as BoardClient,
  KR as ButtonClient,
  XR as CameraClient,
  N1 as Capsule,
  a_ as Classification,
  q as Client,
  sy as CloudConfig,
  O as Code,
  f1 as CollisionSpecification,
  C as ConnectError,
  Ae as ConnectionClosedError,
  v1 as Constraints,
  C1 as DataManagerClient,
  t_ as Detection,
  QR as DiscoveryClient,
  $ as Duration,
  e1 as EncoderClient,
  yR as EncoderPositionType,
  ZR as EncoderProperties,
  n1 as GantryClient,
  g1 as GenericComponentClient,
  i_ as GenericServiceClient,
  P1 as GeoGeometry,
  D1 as GeoPoint,
  A1 as GeometriesInFrame,
  q1 as Geometry,
  k1 as GripperClient,
  y1 as InputControllerClient,
  h1 as InputControllerEvent,
  _1 as LinearConstraint,
  S1 as ListPlanStatusesResponse,
  ae as MachineConnectionEvent,
  je as ModelType,
  O1 as MotionClient,
  I1 as MotionConfiguration,
  a1 as MotorClient,
  s1 as MovementSensorAccuracy,
  t1 as MovementSensorClient,
  o1 as MovementSensorPosition,
  i1 as MovementSensorProperties,
  $1 as NavigationClient,
  V1 as NavigationPosition,
  W1 as NavigationProperties,
  b1 as ObstacleDetector,
  U1 as Orientation,
  w1 as OrientationConstraint,
  H1 as Path,
  s_ as PointCloudObject,
  G1 as Pose,
  L1 as PoseInFrame,
  WR as PowerMode,
  r1 as PowerSensorClient,
  B1 as RectangularPrism,
  x1 as ResourceName,
  q as RobotClient,
  c1 as SensorClient,
  X1 as ServoClient,
  Q1 as SlamClient,
  Z1 as SlamPosition,
  e_ as SlamProperties,
  F1 as Sphere,
  d1 as StreamClient,
  u as Struct,
  p1 as SwitchClient,
  _ as Timestamp,
  po as TrainingStatus,
  J1 as Transform,
  z1 as Vector3,
  n_ as VisionClient,
  K1 as Waypoint,
  ...
  qR as cameraApi,
  pr as commonApi,
  Pv as createRobotClient,
  FR as createViamClient,
  BR as dataApi,
  M1 as dataManagerApi,
  bR as deleteMetadata,
  SR as disableDebugLogging,
  AR as discoveryApi,
  G as doCommandFromClient,
  _R as enableDebugLogging,
  ov as encoderApi,
  wR as gantryApi,
  ER as genericComponentApi,
  o_ as genericServiceApi,
  OR as gripperApi,
  mv as inputControllerApi,
  RR as isValidGeoPoint,
  UR as mlTrainingApi,
  vv as motionApi,
  MR as motorApi,
  lv as movementSensorApi,
  Rv as navigationApi,
  CR as powerSensorApi,
  xR as provisioningApi,
  PR as robotApi,
  m1 as sensorApi,
  NR as servoApi,
  _v as slamApi,
...
//# sourceMappingURL=@viamrobotics_sdk.js.map
