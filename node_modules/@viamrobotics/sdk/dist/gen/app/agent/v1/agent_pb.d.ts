...
export declare class DeviceAgentConfigRequest extends Message<DeviceAgentConfigRequest> {
   ...
   *
   * @generated from field: map<string, string> subsystem_versions = 3;
   */
...
export declare class DeviceAgentConfigResponse extends Message<DeviceAgentConfigResponse> {
   ...
   *
   * @generated from field: map<string, viam.app.agent.v1.DeviceSubsystemConfig> subsystem_configs = 1;
   */
...
export declare class DeviceSubsystemConfig extends Message<DeviceSubsystemConfig> {
   ...
   *
   * @generated from field: viam.app.agent.v1.SubsystemUpdateInfo update_info = 1;
   */
  updateInfo?: SubsystemUpdateInfo;
...
/**
 * @generated from message viam.app.agent.v1.SubsystemUpdateInfo
 */
export declare class SubsystemUpdateInfo extends Message<SubsystemUpdateInfo> {
  /**
  ...
  constructor(data?: PartialMessage<SubsystemUpdateInfo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "viam.app.agent.v1.SubsystemUpdateInfo";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SubsystemUpdateInfo;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SubsystemUpdateInfo;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SubsystemUpdateInfo;

  static equals(a: SubsystemUpdateInfo | PlainMessage<SubsystemUpdateInfo> | undefined, b: SubsystemUpdateInfo | PlainMessage<SubsystemUpdateInfo> | undefined): boolean;
}
